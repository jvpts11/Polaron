// Polaron region core (spec 17) -- THE ONE implementation of flavored regions, compiled twice.
//
...
void  __polaron_region_track(void* block, void* ptr, void* dtor) POLARON_ABI(__polaron_region_track);
