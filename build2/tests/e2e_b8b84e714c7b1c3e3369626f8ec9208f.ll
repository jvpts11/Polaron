; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_bool.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_bool.pol"
...
@.str = private unnamed_addr constant [11 x i8] c"p=%d q=%d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  store ptr @__polaron_closure, ptr %isPos, align 8
  %isPos1 = load ptr, ptr %isPos, align 8
  %code = load ptr, ptr %isPos1, align 8
  %16 = getelementptr ptr, ptr %isPos1, i32 1
  %env = load ptr, ptr %16, align 8
  %17 = call i32 %code(ptr %env, i32 5)
  %isPos2 = load ptr, ptr %isPos, align 8
  %code3 = load ptr, ptr %isPos2, align 8
  %18 = getelementptr ptr, ptr %isPos2, i32 1
  %env4 = load ptr, ptr %18, align 8
  %19 = call i32 %code3(ptr %env4, i32 0)
