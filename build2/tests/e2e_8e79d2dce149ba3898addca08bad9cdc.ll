; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/math_extra_stdlib.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/math_extra_stdlib.pol"
...
@.str = private unnamed_addr constant [56 x i8] c"clamp=%d lerp=%d hypot=%d cbrt=%d log2=%d atan2x100=%d\0A\00", align 1
@.str.1 = private unnamed_addr constant [29 x i8] c"rangeOk=%d dOk=%d boolOk=%d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call double @llvm.minnum.f64(double 1.500000e+01, double 1.000000e+01)
  %17 = call double @llvm.maxnum.f64(double 0.000000e+00, double %16)
  %18 = call i32 @llvm.fptosi.sat.i32.f64(double %17)
  %19 = call i32 @llvm.fptosi.sat.i32.f64(double 2.500000e+01)
  %20 = call double @hypot(double 3.000000e+00, double 4.000000e+00)
  %21 = call i32 @llvm.fptosi.sat.i32.f64(double %20)
  %22 = call double @cbrt(double 2.700000e+01)
  ...
  %26 = call double @atan2(double 1.000000e+00, double 1.000000e+00)
  %27 = fmul double %26, 1.000000e+02
  %28 = call i32 @llvm.fptosi.sat.i32.f64(double %27)
  %29 = call i32 (ptr, ...) @printf(ptr @.str, i32 %18, i32 %19, i32 %21, i32 %23, i32 %25, i32 %28)
  %Random.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Random, ptr null, i64 1) to i64))
  call void @Random.Random(ptr %Random.obj, i64 7)
  store ptr %Random.obj, ptr %r, align 8
  %r1 = load ptr, ptr %r, align 8
  %30 = call i32 @Random.nextRange(ptr %r1, i32 10, i32 20)
  store i32 %30, ptr %a, align 4
  %r2 = load ptr, ptr %r, align 8
  %31 = call double @Random.nextDouble(ptr %r2)
  store double %31, ptr %d, align 8
  %r3 = load ptr, ptr %r, align 8
  %32 = call i32 @Random.nextBool(ptr %r3)
  store i32 %32, ptr %bv, align 4
  %a4 = load i32, ptr %a, align 4
  %33 = icmp sge i32 %a4, 10
...
sc.end:                                           ; preds = %sc.rhs, %argv.end
  ...
  %d6 = load double, ptr %d, align 8
  %38 = fcmp oge double %d6, 0.000000e+00
  %39 = zext i1 %38 to i32
  %sc.a7 = icmp ne i32 %39, 0
  br i1 %sc.a7, label %sc.rhs8, label %sc.end9

sc.rhs8:                                          ; preds = %sc.end
  %d10 = load double, ptr %d, align 8
  %40 = fcmp olt double %d10, 1.000000e+00
  %41 = zext i1 %40 to i32
  %sc.b11 = icmp ne i32 %41, 0
  br label %sc.end9

sc.end9:                                          ; preds = %sc.rhs8, %sc.end
  %sc12 = phi i1 [ false, %sc.end ], [ %sc.b11, %sc.rhs8 ]
  %42 = zext i1 %sc12 to i32
  %bv13 = load i32, ptr %bv, align 4
  %43 = icmp eq i32 %bv13, 1
  %44 = zext i1 %43 to i32
  %sc.a14 = icmp ne i32 %44, 0
  br i1 %sc.a14, label %sc.end16, label %sc.rhs15

sc.rhs15:                                         ; preds = %sc.end9
  %bv17 = load i32, ptr %bv, align 4
  %45 = icmp eq i32 %bv17, 0
  %46 = zext i1 %45 to i32
  %sc.b18 = icmp ne i32 %46, 0
  br label %sc.end16

sc.end16:                                         ; preds = %sc.rhs15, %sc.end9
  %sc19 = phi i1 [ true, %sc.end9 ], [ %sc.b18, %sc.rhs15 ]
  %47 = zext i1 %sc19 to i32
  %48 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %37, i32 %42, i32 %47)
  ret i32 0
}
