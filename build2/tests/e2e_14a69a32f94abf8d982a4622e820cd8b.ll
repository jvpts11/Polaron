; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/file_lines.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/file_lines.pol"
...
@.strdata.5 = private constant [22 x i8] c"file_lines_sample.txt\00"
@.strobj.6 = private global %String { i64 21, ptr @.strdata.5, i64 0 }
@.strdata.7 = private constant [22 x i8] c"file_lines_sample.txt\00"
@.strobj.8 = private global %String { i64 21, ptr @.strdata.7, i64 0 }
@.strdata.9 = private constant [6 x i8] c"delta\00"
@.strobj.10 = private global %String { i64 5, ptr @.strdata.9, i64 0 }
@.strdata.11 = private constant [22 x i8] c"file_lines_sample.txt\00"
@.strobj.12 = private global %String { i64 21, ptr @.strdata.11, i64 0 }
@.str = private unnamed_addr constant [23 x i8] c"n=%d first=%s last=%s\0A\00", align 1
@.strdata.13 = private constant [22 x i8] c"file_lines_sample.txt\00"
@.strobj.14 = private global %String { i64 21, ptr @.strdata.13, i64 0 }
...
@.strdata.3863 = private constant [2 x i8] c"\0A\00"
@.strobj.3864 = private global %String { i64 1, ptr @.strdata.3863, i64 0 }
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @"ArrayList$String.add"(ptr %out1, ptr @.strobj)
  %out2 = load ptr, ptr %out, align 8
  call void @"ArrayList$String.add"(ptr %out2, ptr @.strobj.2)
  %out3 = load ptr, ptr %out, align 8
  call void @"ArrayList$String.add"(ptr %out3, ptr @.strobj.4)
  %out4 = load ptr, ptr %out, align 8
  call void @Files.writeLines(ptr @.strobj.6, ptr %out4)
  call void @Files.appendLine(ptr @.strobj.8, ptr @.strobj.10)
  %16 = call ptr @Files.readLines(ptr @.strobj.12)
  store ptr %16, ptr %back, align 8
  %back5 = load ptr, ptr %back, align 8
  %17 = call i32 @"ArrayList$String.size"(ptr %back5)
  %back6 = load ptr, ptr %back, align 8
  %18 = call ptr @"ArrayList$String.get"(ptr %back6, i32 0)
  %str.data = getelementptr inbounds %String, ptr %18, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %back7 = load ptr, ptr %back, align 8
  %19 = call ptr @"ArrayList$String.get"(ptr %back7, i32 3)
  %str.data8 = getelementptr inbounds %String, ptr %19, i32 0, i32 1
  %data9 = load ptr, ptr %str.data8, align 8
  %20 = call i32 (ptr, ...) @printf(ptr @.str, i32 %17, ptr %data, ptr %data9)
  call void @__polaron_str_free(ptr %18)
  call void @__polaron_str_free(ptr %19)
  %data10 = load ptr, ptr getelementptr inbounds (%String, ptr @.strobj.14, i32 0, i32 1), align 8
  %21 = call i32 @__polaron_file_delete(ptr %data10)
  ret i32 0
}
...
define internal ptr @Files.readLines(ptr %0) {
entry:
...
sc.rhs:                                           ; preds = %entry
  %lines3 = load ptr, ptr %lines, align 8
  %lines4 = load ptr, ptr %lines, align 8
  %9 = call i32 @"ArrayList$String.size"(ptr %lines4)
  %10 = sub i32 %9, 1
  %11 = call ptr @"ArrayList$String.get"(ptr %lines3, i32 %10)
...
if.then:                                          ; preds = %sc.end
  ...
  %lines6 = load ptr, ptr %lines, align 8
  %16 = call i32 @"ArrayList$String.size"(ptr %lines6)
  %17 = sub i32 %16, 1
  call void @"ArrayList$String.removeAt"(ptr %lines5, i32 %17)
  br label %if.end

if.end:                                           ; preds = %if.then, %sc.end
  %lines7 = load ptr, ptr %lines, align 8
  ret ptr %lines7
}

define internal void @Files.writeLines(ptr %0, ptr %1) {
entry:
  %i = alloca i32, align 4
  ...
  %8 = getelementptr inbounds %"class.ArrayList$String", ptr %"ArrayList$String.copy", i32 0, i32 1
  store ptr %arr.copy, ptr %8, align 8, !tbaa !0
  store ptr %"ArrayList$String.copy", ptr %lines, align 8
...
for.cond:                                         ; preds = %for.update, %entry
  ...
  %lines2 = load ptr, ptr %lines, align 8
  %9 = call i32 @"ArrayList$String.size"(ptr %lines2)
...
for.body:                                         ; preds = %for.cond
  ...
  %12 = call ptr @"ArrayList$String.get"(ptr %lines4, i32 %i5)
  %13 = call ptr @StringBuilder.append(ptr %sb3, ptr %12)
  call void @__polaron_str_free(ptr %12)
  %sb6 = load ptr, ptr %sb, align 8
  %14 = call ptr @StringBuilder.appendChar(ptr %sb6, i32 10)
  br label %for.update
...
for.end:                                          ; preds = %for.cond
  ...
  %17 = call ptr @StringBuilder.toString(ptr %sb8)
  %str.data = getelementptr inbounds %String, ptr %path7, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %str.data9 = getelementptr inbounds %String, ptr %17, i32 0, i32 1
  %data10 = load ptr, ptr %str.data9, align 8
  %str.len = getelementptr inbounds %String, ptr %17, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %18 = call i32 @__polaron_file_write_all(ptr %data, ptr %data10, i64 %len, i32 0)
  call void @__polaron_str_free(ptr %17)
  ret void
}

define internal void @Files.appendLine(ptr %0, ptr %1) {
entry:
  ...
  %len = load i64, ptr %str.len, align 8
  %len3 = load i64, ptr @.strobj.3866, align 8
  %2 = add i64 %len, %len3
  %3 = add i64 %2, 1
  %cat.buf = call ptr @__polaron_malloc(i64 %3)
  %str.data = getelementptr inbounds %String, ptr %line2, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %4 = call ptr @memcpy(ptr %cat.buf, ptr %data, i64 %len)
  %data4 = load ptr, ptr getelementptr inbounds (%String, ptr @.strobj.3866, i32 0, i32 1), align 8
  %5 = getelementptr i8, ptr %cat.buf, i64 %len
  %6 = call ptr @memcpy(ptr %5, ptr %data4, i64 %len3)
  ...
  %str.data5 = getelementptr inbounds %String, ptr %path1, i32 0, i32 1
  ...
  %str.len9 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 0
  %len10 = load i64, ptr %str.len9, align 8
  %11 = call i32 @__polaron_file_write_all(ptr %data6, ptr %data8, i64 %len10, i32 1)
  call void @__polaron_str_free(ptr %newstr)
  ret void
}
