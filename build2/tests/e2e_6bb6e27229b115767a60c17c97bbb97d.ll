; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/collection_iterator.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/collection_iterator.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%"class.Iterable$int" = type { ptr }
...
@.str = private unnamed_addr constant [19 x i8] c"total=%d count=%d\0A\00", align 1
...
define internal i32 @Main.drain(ptr %0) {
entry:
  %total = alloca i32, align 4
  %it = alloca ptr, align 8
  %seq = alloca ptr, align 8
  store ptr %0, ptr %seq, align 8
  %seq1 = load ptr, ptr %seq, align 8
  %vtbl.addr = getelementptr inbounds %"class.Iterable$int", ptr %seq1, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %slot = getelementptr [348 x ptr], ptr %vtbl, i64 0, i64 8
  %fn = load ptr, ptr %slot, align 8
  %1 = call ptr %fn(ptr %seq1)
  store ptr %1, ptr %it, align 8
  store i32 0, ptr %total, align 4
  br label %while.cond

while.cond:                                       ; preds = %dv.join, %entry
  %it2 = load ptr, ptr %it, align 8
  %vtbl.addr3 = getelementptr inbounds %"class.Iterator$int", ptr %it2, i32 0, i32 0
  %vtbl4 = load ptr, ptr %vtbl.addr3, align 8, !tbaa !0
  %slot5 = getelementptr [348 x ptr], ptr %vtbl4, i64 0, i64 6
  %fn6 = load ptr, ptr %slot5, align 8
  %2 = call i32 %fn6(ptr %it2)
  %3 = icmp ne i32 %2, 0
  br i1 %3, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %total7 = load i32, ptr %total, align 4
  %it8 = load ptr, ptr %it, align 8
  %vtbl.addr9 = getelementptr inbounds %"class.Iterator$int", ptr %it8, i32 0, i32 0
  %vtbl10 = load ptr, ptr %vtbl.addr9, align 8, !tbaa !0
  %slot11 = getelementptr [348 x ptr], ptr %vtbl10, i64 0, i64 7
  %fn12 = load ptr, ptr %slot11, align 8
  %dv.is = icmp eq ptr %fn12, @Xorshift.next
...
dv.join:                                          ; preds = %dv.miss14, %dv.hit13, %dv.hit
  %dv.r = phi i32 [ %5, %dv.hit ], [ %6, %dv.hit13 ], [ %7, %dv.miss14 ]
  %4 = add i32 %total7, %dv.r
  store i32 %4, ptr %total, align 4
  br label %while.cond

dv.hit:                                           ; preds = %while.body
  %5 = call i32 @Xorshift.next(ptr %it8)
  br label %dv.join

dv.miss:                                          ; preds = %while.body
  %dv.is15 = icmp eq ptr %fn12, @"ArrayListIterator$int.next"
  br i1 %dv.is15, label %dv.hit13, label %dv.miss14

dv.hit13:                                         ; preds = %dv.miss
  %6 = call i32 @"ArrayListIterator$int.next"(ptr %it8)
  br label %dv.join

dv.miss14:                                        ; preds = %dv.miss
  %7 = call i32 %fn12(ptr %it8)
  br label %dv.join
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @"ArrayList$int.add"(ptr %nums1, i32 11)
  %nums2 = load ptr, ptr %nums, align 8
  call void @"ArrayList$int.add"(ptr %nums2, i32 22)
  %nums3 = load ptr, ptr %nums, align 8
  call void @"ArrayList$int.add"(ptr %nums3, i32 33)
  %nums4 = load ptr, ptr %nums, align 8
  %16 = call i32 @Main.drain(ptr %nums4)
  store i32 %16, ptr %total, align 4
  %total5 = load i32, ptr %total, align 4
  %nums6 = load ptr, ptr %nums, align 8
  %17 = call i32 @"ArrayList$int.size"(ptr %nums6)
  %18 = call i32 (ptr, ...) @printf(ptr @.str, i32 %total5, i32 %17)
  ret i32 0
}
