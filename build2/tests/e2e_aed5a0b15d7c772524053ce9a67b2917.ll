; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/tuple.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/tuple.pol"
...
@.str = private unnamed_addr constant [11 x i8] c"q=%d r=%d\0A\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"lo=%d hi=%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [11 x i8] c"x=%d y=%d\0A\00", align 1
...
define internal { i32, i32 } @MathX.divmod(i32 %0, i32 %1) personality ptr @__CxxFrameHandler3 {
entry:
...
div.ok:                                           ; preds = %entry
  ...
  %9 = icmp eq i32 %b4, 0
  %10 = icmp eq i32 %a3, -2147483648
  %11 = icmp eq i32 %b4, -1
  %12 = and i1 %10, %11
  %13 = or i1 %9, %12
  br i1 %13, label %div.bad5, label %div.ok6
...
div.ok6:                                          ; preds = %div.ok
  %14 = srem i32 %a3, %b4
  %15 = insertvalue { i32, i32 } %8, i32 %14, 1
  ret { i32, i32 } %15
}

define internal { i32, i32 } @MathX.bounds() {
entry:
  ret { i32, i32 } { i32 3, i32 9 }
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call { i32, i32 } @MathX.divmod(i32 17, i32 5)
  ...
  %19 = call i32 (ptr, ...) @printf(ptr @.str, i32 %q1, i32 %r2)
  %20 = call { i32, i32 } @MathX.bounds()
  %21 = extractvalue { i32, i32 } %20, 0
  store i32 %21, ptr %lo, align 4
  %22 = extractvalue { i32, i32 } %20, 1
  store i32 %22, ptr %hi, align 4
  %lo3 = load i32, ptr %lo, align 4
  %hi4 = load i32, ptr %hi, align 4
  %23 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %lo3, i32 %hi4)
  %lo5 = load i32, ptr %lo, align 4
  %24 = add i32 %lo5, 1
  %25 = insertvalue { i32, i32 } undef, i32 %24, 0
  %hi6 = load i32, ptr %hi, align 4
  %26 = add i32 %hi6, 1
  %27 = insertvalue { i32, i32 } %25, i32 %26, 1
  ...
  %30 = call i32 (ptr, ...) @printf(ptr @.str.2, i32 %x7, i32 %y8)
  ret i32 0
}
