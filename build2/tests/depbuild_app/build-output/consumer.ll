; ModuleID = 'C:\Users\jvpts\Documents\GitHub\LDP3\build2\tests\depbuild_app\src/main.pol'
source_filename = "C:\\Users\\jvpts\\Documents\\GitHub\\LDP3\\build2\\tests\\depbuild_app\\src/main.pol"
...
argv.body:                                        ; preds = %entry, %argv.body
  %argv.i.02 = phi i64 [ %8, %argv.body ], [ 0, %entry ]
  %8 = add nuw nsw i64 %argv.i.02, 1
  ...
  %12 = getelementptr ptr, ptr %arr.data, i64 %argv.i.02
...
argv.end:                                         ; preds = %argv.body, %entry
  ...
  %15 = tail call i32 @Calc.square(i32 7)
  %16 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str, i32 %15)
  ret i32 0
}

declare i32 @Calc.square(i32) local_unnamed_addr
