; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/math_demo.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/math_demo.pol"
...
@.str = private unnamed_addr constant [28 x i8] c"gcd(48,18)=%d pow(2,10)=%d\0A\00", align 1
...
define internal i32 @MathUtil.gcd(i32 %0, i32 %1) personality ptr @__CxxFrameHandler3 {
entry:
...
div.ok:                                           ; preds = %if.end
  %9 = srem i32 %a4, %b5
  %10 = call i32 @MathUtil.gcd(i32 %b3, i32 %9)
  ret i32 %10
}

define internal i32 @MathUtil.pow(i32 %0, i32 %1) {
entry:
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 @MathUtil.gcd(i32 48, i32 18)
  %17 = call i32 @MathUtil.pow(i32 2, i32 10)
