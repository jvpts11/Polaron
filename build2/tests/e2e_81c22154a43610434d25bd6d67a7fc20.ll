; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_stack.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_stack.pol"
...
@Noisy.destroyed = private global i32 0
...
@.str = private unnamed_addr constant [14 x i8] c"destroyed=%d\0A\00", align 1
...
entry:
  %destroyed = load i32, ptr @Noisy.destroyed, align 4
  %1 = add i32 %destroyed, 1
  store i32 %1, ptr @Noisy.destroyed, align 4
  ret void
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @literal.kilobytes.int(i32 8)
  ...
  call void @__polaron_region_init(ptr %region, i64 2, i64 %bytes, i64 0)
  store ptr %region, ptr %r, align 8
  %region1 = load ptr, ptr %r, align 8
  %rgn.slot = call ptr @__polaron_region_new(ptr %region1, i64 ptrtoint (ptr getelementptr (%class.Noisy, ptr null, i64 1) to i64))
  invoke void @Noisy.Noisy(ptr %rgn.slot, i32 0)
...
cleanup.run:                                      ; preds = %cleanup.dispatch
  ...
  call void @__polaron_region_teardown(ptr %region2)
...
invoke.cont:                                      ; preds = %argv.end
  ...
  call void @__polaron_region_track(ptr %region3, ptr %rgn.slot, ptr @"Noisy.~Noisy")
  store ptr %rgn.slot, ptr %base, align 8
  store i32 0, ptr %round, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.update, %invoke.cont
  %round4 = load i32, ptr %round, align 4
  %20 = icmp slt i32 %round4, 1000
  %21 = zext i1 %20 to i32
  br i1 %20, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %region5 = load ptr, ptr %r, align 8
  %mark = load i64, ptr %region5, align 8
  store i64 %mark, ptr %m, align 8
  store i32 0, ptr %i, align 4
  br label %for.cond6

for.update:                                       ; preds = %for.end9
  %22 = load i32, ptr %round, align 4
  %23 = add i32 %22, 1
  store i32 %23, ptr %round, align 4
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %destroyed = load i32, ptr @Noisy.destroyed, align 4
  %24 = call i32 (ptr, ...) @printf(ptr @.str, i32 %destroyed)
  %25 = load ptr, ptr %r, align 8
  call void @__polaron_region_teardown(ptr %25)
  call void @__polaron_region_release(ptr %25)
  store ptr null, ptr %r, align 8
  %destroyed25 = load i32, ptr @Noisy.destroyed, align 4
  %26 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %destroyed25)
  %region26 = load ptr, ptr %r, align 8
  call void @__polaron_region_teardown(ptr %region26)
  call void @__polaron_region_release(ptr %region26)
  ret i32 0

for.cond6:                                        ; preds = %for.update8, %for.body
  %i10 = load i32, ptr %i, align 4
  %27 = icmp slt i32 %i10, 100
  %28 = zext i1 %27 to i32
  br i1 %27, label %for.body7, label %for.end9

for.body7:                                        ; preds = %for.cond6
  %region11 = load ptr, ptr %r, align 8
  %rgn.slot12 = call ptr @__polaron_region_new(ptr %region11, i64 ptrtoint (ptr getelementptr (%class.Noisy, ptr null, i64 1) to i64))
  %i13 = load i32, ptr %i, align 4
  invoke void @Noisy.Noisy(ptr %rgn.slot12, i32 %i13)
          to label %invoke.cont21 unwind label %cleanup14

for.update8:                                      ; preds = %invoke.cont21
...
for.end9:                                         ; preds = %for.cond6
  %region23 = load ptr, ptr %r, align 8
  %m24 = load i64, ptr %m, align 8
  call void @__polaron_region_rollback(ptr %region23, i64 %m24)
  br label %for.update

cleanup14:                                        ; preds = %for.body7
  %31 = catchswitch within none [label %cleanup.dispatch16] unwind to caller

cleanup.dispatch16:                               ; preds = %cleanup14
  %32 = catchpad within %31 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.cleanup15]
  catchret from %32 to label %cleanup.run17

cleanup.run17:                                    ; preds = %cleanup.dispatch16
  %cleanup.obj18 = load ptr, ptr %exc.cleanup15, align 8
  %region19 = load ptr, ptr %r, align 8
  call void @__polaron_region_teardown(ptr %region19)
...
invoke.cont21:                                    ; preds = %for.body7
  %region22 = load ptr, ptr %r, align 8
  call void @__polaron_region_track(ptr %region22, ptr %rgn.slot12, ptr @"Noisy.~Noisy")
  store ptr %rgn.slot12, ptr %t, align 8
...
declare void @__polaron_region_rollback(ptr, i64)
