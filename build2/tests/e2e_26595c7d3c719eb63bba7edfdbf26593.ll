; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_fixedslot.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_fixedslot.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @literal.kilobytes.int(i32 4)
  ...
  call void @__polaron_region_init(ptr %region, i64 3, i64 %bytes, i64 0)
...
for.cond:                                         ; preds = %for.update, %argv.end
  ...
  %18 = icmp slt i32 %i1, 200000
  %19 = zext i1 %18 to i32
  br i1 %18, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %region2 = load ptr, ptr %pen, align 8
  %rgn.slot = call ptr @__polaron_region_new(ptr %region2, i64 ptrtoint (ptr getelementptr (%class.Dog, ptr null, i64 1) to i64))
  %i3 = load i32, ptr %i, align 4
  %20 = icmp eq i32 %i3, -2147483648
  %21 = and i1 %20, false
  %22 = or i1 false, %21
  br i1 %22, label %div.bad, label %div.ok

for.update:                                       ; preds = %invoke.cont22
...
for.end:                                          ; preds = %for.cond
  ...
  %25 = call i32 (ptr, ...) @printf(ptr @.str, i32 %sum25)
  %26 = load ptr, ptr %pen, align 8
  call void @__polaron_region_release(ptr %26)
  store ptr null, ptr %pen, align 8
  %region26 = load ptr, ptr %pen, align 8
  call void @__polaron_region_release(ptr %region26)
  ret i32 0
...
div.bad:                                          ; preds = %for.body
  ...
  invoke void @_CxxThrowException(ptr %exc.thrown, ptr @_TI1PEAX)
          to label %throw.cont unwind label %cleanup

div.ok:                                           ; preds = %for.body
  %27 = srem i32 %i3, 100
  invoke void @Dog.Dog(ptr %rgn.slot, i32 %27)
          to label %invoke.cont unwind label %cleanup6

cleanup:                                          ; preds = %div.bad
  %28 = catchswitch within none [label %cleanup.dispatch] unwind to caller

cleanup.dispatch:                                 ; preds = %cleanup
  %29 = catchpad within %28 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.cleanup]
  catchret from %29 to label %cleanup.run
...
cleanup.run:                                      ; preds = %cleanup.dispatch
  ...
  store ptr %cleanup.obj, ptr %exc.thrown5, align 8
...
cleanup6:                                         ; preds = %div.ok
  %30 = catchswitch within none [label %cleanup.dispatch8] unwind to caller

cleanup.dispatch8:                                ; preds = %cleanup6
  %31 = catchpad within %30 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.cleanup7]
  catchret from %31 to label %cleanup.run9

cleanup.run9:                                     ; preds = %cleanup.dispatch8
  %cleanup.obj10 = load ptr, ptr %exc.cleanup7, align 8
  %region11 = load ptr, ptr %pen, align 8
...
invoke.cont:                                      ; preds = %div.ok
  store ptr %rgn.slot, ptr %d, align 8
  %sum13 = load i32, ptr %sum, align 4
  %d14 = load ptr, ptr %d, align 8
  %32 = invoke i32 @Dog.getAge(ptr %d14)
          to label %invoke.cont22 unwind label %cleanup15

cleanup15:                                        ; preds = %invoke.cont
  %33 = catchswitch within none [label %cleanup.dispatch17] unwind to caller

cleanup.dispatch17:                               ; preds = %cleanup15
  %34 = catchpad within %33 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.cleanup16]
  catchret from %34 to label %cleanup.run18

cleanup.run18:                                    ; preds = %cleanup.dispatch17
  %cleanup.obj19 = load ptr, ptr %exc.cleanup16, align 8
  %region20 = load ptr, ptr %pen, align 8
...
invoke.cont22:                                    ; preds = %invoke.cont
  ...
  call void @__polaron_check_live(ptr %d23)
  %region24 = load ptr, ptr %pen, align 8
  call void @__polaron_region_free(ptr %region24, ptr %d23, i64 ptrtoint (ptr getelementptr (%class.Dog, ptr null, i64 1) to i64))
  br label %for.update
}
