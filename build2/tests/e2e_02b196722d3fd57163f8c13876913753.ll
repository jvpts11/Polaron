; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/properties.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/properties.pol"
...
@.str = private unnamed_addr constant [25 x i8] c"area = %d w = %d h = %d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Rect.Rect(ptr %Rect.obj, i32 3, i32 4)
  store ptr %Rect.obj, ptr %r, align 8
  %r1 = load ptr, ptr %r, align 8
  %16 = call i32 @Rect.area(ptr %r1)
  %r2 = load ptr, ptr %r, align 8
  %w = getelementptr inbounds %class.Rect, ptr %r2, i32 0, i32 1
  %w3 = load i32, ptr %w, align 4, !tbaa !4
  %r4 = load ptr, ptr %r, align 8
  %h = getelementptr inbounds %class.Rect, ptr %r4, i32 0, i32 2
  %h5 = load i32, ptr %h, align 4, !tbaa !4
  %17 = call i32 (ptr, ...) @printf(ptr @.str, i32 %16, i32 %w3, i32 %h5)
  %r6 = load ptr, ptr %r, align 8
  %w7 = getelementptr inbounds %class.Rect, ptr %r6, i32 0, i32 1
  store i32 10, ptr %w7, align 4, !tbaa !4
  %r8 = load ptr, ptr %r, align 8
  %18 = call i32 @Rect.area(ptr %r8)
