; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/property_setter.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/property_setter.pol"
...
define internal void @Account.Account(ptr %0) {
entry:
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.Account, ptr %0, i32 0, i32 0
  store ptr @Account.vtable, ptr %vtbl.addr, align 8, !tbaa !4
  call void @"Account.balance$set"(ptr %0, i32 0)
  ret void
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Account.Account(ptr %Account.obj)
  store ptr %Account.obj, ptr %a, align 8
  %a1 = load ptr, ptr %a, align 8
  call void @"Account.balance$set"(ptr %a1, i32 50)
  %a2 = load ptr, ptr %a, align 8
  %balance = getelementptr inbounds %class.Account, ptr %a2, i32 0, i32 1
  %balance3 = load i32, ptr %balance, align 4, !tbaa !0
  %16 = call i32 (ptr, ...) @printf(ptr @.str, i32 %balance3)
  %a4 = load ptr, ptr %a, align 8
  call void @"Account.balance$set"(ptr %a4, i32 -10)
  %a5 = load ptr, ptr %a, align 8
  %balance6 = getelementptr inbounds %class.Account, ptr %a5, i32 0, i32 1
  %balance7 = load i32, ptr %balance6, align 4, !tbaa !0
  %17 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %balance7)
  ret i32 0
}
