; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/value_parameter.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/value_parameter.pol"
...
@.str = private unnamed_addr constant [17 x i8] c"value=%d ref=%d\0A\00", align 1
...
define internal void @Main.byValue(ptr %0) {
entry:
  %Box.copy = alloca %class.Box, align 8
  %b = alloca ptr, align 8
  %1 = call ptr @memcpy(ptr %Box.copy, ptr %0, i64 ptrtoint (ptr getelementptr (%class.Box, ptr null, i64 1) to i64))
  store ptr %Box.copy, ptr %b, align 8
  %b1 = load ptr, ptr %b, align 8
  %v = getelementptr inbounds %class.Box, ptr %b1, i32 0, i32 1
  store i32 99, ptr %v, align 4, !tbaa !4
  ret void
}

define internal void @Main.byRef(ptr %0) {
entry:
  %b = alloca ptr, align 8
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Box.Box(ptr %Box.obj, i32 7)
  store ptr %Box.obj, ptr %a, align 8
  %a1 = load ptr, ptr %a, align 8
  call void @Main.byValue(ptr %a1)
  %Box.obj2 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Box, ptr null, i64 1) to i64))
  call void @Box.Box(ptr %Box.obj2, i32 7)
  store ptr %Box.obj2, ptr %c, align 8
  %c3 = load ptr, ptr %c, align 8
  call void @Main.byRef(ptr %c3)
  %a4 = load ptr, ptr %a, align 8
  %v = getelementptr inbounds %class.Box, ptr %a4, i32 0, i32 1
  %v5 = load i32, ptr %v, align 4, !tbaa !4
  %c6 = load ptr, ptr %c, align 8
  %v7 = getelementptr inbounds %class.Box, ptr %c6, i32 0, i32 1
  %v8 = load i32, ptr %v7, align 4, !tbaa !4
  %16 = call i32 (ptr, ...) @printf(ptr @.str, i32 %v5, i32 %v8)
  ret i32 0
}
