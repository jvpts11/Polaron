; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_growable.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_growable.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @literal.bytes.int(i32 256)
  ...
  call void @__polaron_region_init(ptr %region, i64 1, i64 %bytes, i64 1)
  store ptr %region, ptr %g, align 8
...
for.cond:                                         ; preds = %for.update, %argv.end
  ...
  %18 = icmp slt i32 %i1, 1000
  %19 = zext i1 %18 to i32
  br i1 %18, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %region2 = load ptr, ptr %g, align 8
...
for.end:                                          ; preds = %for.cond
  ...
  %25 = call i32 (ptr, ...) @printf(ptr @.str, i32 %sum23)
  %26 = load ptr, ptr %g, align 8
  call void @__polaron_region_free_chain(ptr %26)
  store ptr null, ptr %g, align 8
  %region24 = load ptr, ptr %g, align 8
  call void @__polaron_region_free_chain(ptr %region24)
  ret i32 0
...
cleanup.run:                                      ; preds = %cleanup.dispatch
  ...
  %region4 = load ptr, ptr %g, align 8
  call void @__polaron_region_free_chain(ptr %region4)
...
cleanup.run9:                                     ; preds = %cleanup.dispatch8
  ...
  %region11 = load ptr, ptr %g, align 8
  call void @__polaron_region_free_chain(ptr %region11)
...
cleanup.run18:                                    ; preds = %cleanup.dispatch17
  ...
  %region20 = load ptr, ptr %g, align 8
  call void @__polaron_region_free_chain(ptr %region20)
...
declare void @__polaron_region_free_chain(ptr)
