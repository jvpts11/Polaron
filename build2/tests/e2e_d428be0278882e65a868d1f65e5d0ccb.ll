; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/units.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/units.pol"
...
@.str = private unnamed_addr constant [19 x i8] c"a = %lld b = %lld\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @literal.kilobytes.int(i32 64)
  store ptr %16, ptr %a, align 8
  %17 = call ptr @literal.megabytes.int(i32 2)
  store ptr %17, ptr %b, align 8
  %a1 = load ptr, ptr %a, align 8
  %bytes = getelementptr inbounds %class.ByteSize, ptr %a1, i32 0, i32 0
  %bytes2 = load i64, ptr %bytes, align 8, !tbaa !0
  %b3 = load ptr, ptr %b, align 8
  %bytes4 = getelementptr inbounds %class.ByteSize, ptr %b3, i32 0, i32 0
  %bytes5 = load i64, ptr %bytes4, align 8, !tbaa !0
  %18 = call i32 (ptr, ...) @printf(ptr @.str, i64 %bytes2, i64 %bytes5)
  ret i32 0
}
...
entry:
  ...
  store i64 %bytes2, ptr %bytes1, align 8, !tbaa !0
  ret void
}
...
define internal ptr @literal.megabytes.int(i32 %0) {
entry:
  %x = alloca i32, align 4
  store i32 %0, ptr %x, align 4
  %ByteSize.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.ByteSize, ptr null, i64 1) to i64))
  ...
  %2 = mul i64 %1, 1024
  %3 = mul i64 %2, 1024
  call void @ByteSize.ByteSize(ptr %ByteSize.obj, i64 %3)
  ret ptr %ByteSize.obj
}
