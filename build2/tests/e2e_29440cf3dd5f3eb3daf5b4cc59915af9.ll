; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reattach_in_scope.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reattach_in_scope.pol"
...
@main.c.__pblock = private global %persistblock.Car zeroinitializer
@.str = private unnamed_addr constant [7 x i8] c"re=%d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  store ptr @main.c.__pblock, ptr %__persist, align 8, !tbaa !0
  ...
  store i32 7, ptr %chassi, align 4
...
dtor.free:                                        ; preds = %dtor.call, %argv.end
  ...
  %Car.obj4 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Car, ptr null, i64 1) to i64))
  %__persist5 = getelementptr inbounds %class.Car, ptr %Car.obj4, i32 0, i32 2
  store ptr @main.c.__pblock, ptr %__persist5, align 8, !tbaa !0
  call void @Car.Car(ptr %Car.obj4)
  store ptr %Car.obj4, ptr %c6, align 8
  %c7 = load ptr, ptr %c6, align 8
  %__persist8 = getelementptr inbounds %class.Car, ptr %c7, i32 0, i32 2
  %pblock9 = load ptr, ptr %__persist8, align 8, !tbaa !0
  %chassi10 = getelementptr inbounds %persistblock.Car, ptr %pblock9, i32 0, i32 0
  %chassi11 = load i32, ptr %chassi10, align 4
  %17 = call i32 (ptr, ...) @printf(ptr @.str, i32 %chassi11)
  %c12 = load ptr, ptr %c6, align 8
  call void @__polaron_check_live(ptr %c12)
  %vtbl.addr13 = getelementptr inbounds %class.Car, ptr %c12, i32 0, i32 0
  ...
  %18 = icmp ne ptr %dtor.fn16, null
  br i1 %18, label %dtor.call17, label %dtor.free18

dtor.call17:                                      ; preds = %dtor.free
  call void %dtor.fn16(ptr %c12)
  br label %dtor.free18

dtor.free18:                                      ; preds = %dtor.call17, %dtor.free
  call void @__polaron_free(ptr %c12)
  ret i32 0
}
