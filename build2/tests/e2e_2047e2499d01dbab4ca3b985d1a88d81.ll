; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_char.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_char.pol"
...
@.str = private unnamed_addr constant [11 x i8] c"g=%c h=%c\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  store ptr @__polaron_closure, ptr %grade, align 8
  %grade1 = load ptr, ptr %grade, align 8
  %code = load ptr, ptr %grade1, align 8
  %16 = getelementptr ptr, ptr %grade1, i32 1
  %env = load ptr, ptr %16, align 8
  %17 = call i32 %code(ptr %env, i32 95)
  %grade2 = load ptr, ptr %grade, align 8
  %code3 = load ptr, ptr %grade2, align 8
  %18 = getelementptr ptr, ptr %grade2, i32 1
  %env4 = load ptr, ptr %18, align 8
  %19 = call i32 %code3(ptr %env4, i32 70)
