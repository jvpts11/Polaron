; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_dtor.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_dtor.pol"
...
invoke.cont21:                                    ; preds = %rgn.ok12
  ...
  %29 = call i32 (ptr, ...) @printf(ptr @.str.4, ptr @.str.5)
  %region22 = load ptr, ptr %pen, align 8
  call void @__polaron_region_release(ptr %region22)
  ret i32 0
}
