...
@.str = private unnamed_addr constant [11 x i8] c"length=%d\0A\00", align 1
...
define internal void @UserName.UserName(ptr %0, i32 %1) {
entry:
  %n = alloca i32, align 4
  store i32 %1, ptr %n, align 4
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.UserName, ptr %0, i32 0, i32 0
  store ptr @UserName.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %length = getelementptr inbounds %class.UserName, ptr %0, i32 0, i32 1
  %n1 = load i32, ptr %n, align 4
  store i32 %n1, ptr %length, align 4, !tbaa !4
  ret void
}

define internal i32 @UserName.length(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %length = getelementptr inbounds %class.UserName, ptr %0, i32 0, i32 1
  %length1 = load i32, ptr %length, align 4, !tbaa !4
  ret i32 %length1
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %UserName.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.UserName, ptr null, i64 1) to i64))
  call void @UserName.UserName(ptr %UserName.obj, i32 42)
  store ptr %UserName.obj, ptr %u, align 8
  %u1 = load ptr, ptr %u, align 8
  %16 = call i32 @UserName.length(ptr %u1)
  %17 = call i32 (ptr, ...) @printf(ptr @.str, i32 %16)
  %u2 = load ptr, ptr %u, align 8
  call void @__polaron_check_live(ptr %u2)
  %vtbl.addr = getelementptr inbounds %class.UserName, ptr %u2, i32 0, i32 0
...
dtor.call:                                        ; preds = %argv.end
  call void %dtor.fn(ptr %u2)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %argv.end
  call void @__polaron_free(ptr %u2)
  ret i32 0
}
