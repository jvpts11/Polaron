...
@main.c.__pblock = private global %persistblock.Cache zeroinitializer
...
entry:
  ...
  %slot = getelementptr inbounds %class.Cache, ptr %0, i32 0, i32 1
  store i32 0, ptr %slot, align 4, !tbaa !4
  ret void
}

define internal void @Cache.use(ptr nonnull align 8 dereferenceable(24) %0) {
entry:
  %__persist = getelementptr inbounds %class.Cache, ptr %0, i32 0, i32 2
  %pblock = load ptr, ptr %__persist, align 8, !tbaa !0
  %slot = getelementptr inbounds %persistblock.Cache, ptr %pblock, i32 0, i32 0
  %__persist1 = getelementptr inbounds %class.Cache, ptr %0, i32 0, i32 2
  %pblock2 = load ptr, ptr %__persist1, align 8, !tbaa !0
  %slot3 = getelementptr inbounds %persistblock.Cache, ptr %pblock2, i32 0, i32 0
  %slot4 = load i32, ptr %slot3, align 4
  %1 = add i32 %slot4, 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %__persist = getelementptr inbounds %class.Cache, ptr %Cache.obj, i32 0, i32 2
  ...
  call void @Cache.use(ptr %c1)
  %c2 = load ptr, ptr %c, align 8
  call void @Cache.use(ptr %c2)
  %c3 = load ptr, ptr %c, align 8
  %__persist4 = getelementptr inbounds %class.Cache, ptr %c3, i32 0, i32 2
  %pblock = load ptr, ptr %__persist4, align 8, !tbaa !0
  %slot = getelementptr inbounds %persistblock.Cache, ptr %pblock, i32 0, i32 0
  %slot5 = load i32, ptr %slot, align 4
  %16 = call i32 (ptr, ...) @printf(ptr @.str, i32 %slot5)
  %c6 = load ptr, ptr %c, align 8
  %__persist7 = getelementptr inbounds %class.Cache, ptr %c6, i32 0, i32 2
  %pblock8 = load ptr, ptr %__persist7, align 8, !tbaa !0
  %slot9 = getelementptr inbounds %persistblock.Cache, ptr %pblock8, i32 0, i32 0
  store i32 0, ptr %slot9, align 4
  %c10 = load ptr, ptr %c, align 8
  call void @__polaron_check_live(ptr %c10)
  %vtbl.addr = getelementptr inbounds %class.Cache, ptr %c10, i32 0, i32 0
...
dtor.call:                                        ; preds = %argv.end
  call void %dtor.fn(ptr %c10)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %argv.end
  call void @__polaron_free(ptr %c10)
  ret i32 0
}
