; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/comefrom_cleanup.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/comefrom_cleanup.pol"
...
@.str.4 = private unnamed_addr constant [13 x i8] c"unreachable\0A\00", align 1
@.str.5 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.6 = private unnamed_addr constant [18 x i8] c"also unreachable\0A\00", align 1
...
if.end:                                           ; preds = %dtor.done2, %argv.end
  %17 = call i32 (ptr, ...) @printf(ptr @.str.5, ptr @.str.6)
  ret i32 0

label.out:                                        ; preds = %if.then
  %18 = load ptr, ptr %a, align 8
  %19 = icmp ne ptr %18, null
  br i1 %19, label %dtor.live, label %dtor.done

dtor.live:                                        ; preds = %label.out
  call void @"Noisy.~Noisy"(ptr %18)
  br label %dtor.done

dtor.done:                                        ; preds = %dtor.live, %label.out
  br label %comefrom.out

comefrom.out:                                     ; preds = %dtor.done
  %20 = call i32 (ptr, ...) @printf(ptr @.str.7, ptr @.str.8)
  ret i32 0

label.stolen.out:                                 ; No predecessors!
  %21 = call i32 (ptr, ...) @printf(ptr @.str.3, ptr @.str.4)
  %22 = load ptr, ptr %a, align 8
  %23 = icmp ne ptr %22, null
  br i1 %23, label %dtor.live1, label %dtor.done2

dtor.live1:                                       ; preds = %label.stolen.out
  call void @"Noisy.~Noisy"(ptr %22)
  br label %dtor.done2

dtor.done2:                                       ; preds = %dtor.live1, %label.stolen.out
  br label %if.end
}
