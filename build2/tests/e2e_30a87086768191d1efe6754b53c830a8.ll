; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/ffi_callback.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/ffi_callback.pol"
...
declare i32 @polaron_apply_cb(ptr, i32)
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 @polaron_apply_cb(ptr @__polaron_cb_0, i32 7)
  store i32 %16, ptr %r, align 4
  %r1 = load i32, ptr %r, align 4
  %17 = call i32 (ptr, ...) @printf(ptr @.str, i32 %r1)
  ret i32 0
}
...
define internal i32 @__polaron_cb_0(i32 %0) {
entry:
