; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reflect_annotations.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reflect_annotations.pol"
...
@methods.Widget = private constant [0 x ptr] zeroinitializer
@.strdata.1 = private constant [3 x i8] c"id\00"
@.strobj.2 = private global %String { i64 2, ptr @.strdata.1, i64 0 }
@fields.Widget = private constant [1 x ptr] [ptr @.strobj.2]
@.strdata.3 = private constant [7 x i8] c"Marker\00"
@.strobj.4 = private global %String { i64 6, ptr @.strdata.3, i64 0 }
@.strdata.5 = private constant [8 x i8] c"Audited\00"
@.strobj.6 = private global %String { i64 7, ptr @.strdata.5, i64 0 }
@annotations.Widget = private constant [2 x ptr] [ptr @.strobj.4, ptr @.strobj.6]
@methodfns.Widget = private constant [0 x ptr] zeroinitializer
...
@methodanncounts.Widget = private constant [0 x i64] zeroinitializer
@methodannptrs.Widget = private constant [0 x ptr] zeroinitializer
@methodrettags.Widget = private constant [0 x i64] zeroinitializer
@type.Widget = private constant %ReflectType { ptr @.strobj, i64 0, ptr @methods.Widget, ptr @methodfns.Widget, i64 1, ptr @fields.Widget, i64 ptrtoint (ptr getelementptr (%class.Widget, ptr null, i64 1) to i64), ptr @Widget.Widget, i64 2, ptr @annotations.Widget, ptr @fieldget.Widget, ptr @fieldset.Widget, ptr @methodanncounts.Widget, ptr @methodannptrs.Widget, ptr @methodrettags.Widget }
@.str = private unnamed_addr constant [10 x i8] c"count=%d\0A\00", align 1
@.fail = private unnamed_addr constant [138 x i8] c"Polaron panic: array index out of bounds\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reflect_annotations.pol:27:17  in main\0A\00", align 1
...
@.contract.1306 = private unnamed_addr constant [132 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.ArrayList$Annotation\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1307 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1308 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1309 = private unnamed_addr constant [149 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.ArrayList$Annotation\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1310 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:320:35  in ArrayList$Annotation.add\0A\00", align 1
...
@.fail.1313 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:320:35  in ArrayList$Annotation.add\0A\00", align 1
...
@.fail.1316 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:325:39  in ArrayList$Annotation.add\0A\00", align 1
...
@.contract.1319 = private unnamed_addr constant [128 x i8] c"contract violated: ensures\0A  --> <prelude>:315:36  in ArrayList$Annotation.add\0A   |  ensures this.count == old(this.count) + 1\0A\00", align 1
@.contract.1320 = private unnamed_addr constant [115 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.add\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1321 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1322 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1323 = private unnamed_addr constant [132 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.add\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1324 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:334:78  in ArrayList$Annotation.ensureCapacity\0A\00", align 1
...
@.fail.1327 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:334:78  in ArrayList$Annotation.ensureCapacity\0A\00", align 1
...
@.contract.1330 = private unnamed_addr constant [126 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.ensureCapacity\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1331 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1332 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1333 = private unnamed_addr constant [143 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.ensureCapacity\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1334 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:345:21  in ArrayList$Annotation.get\0A\00", align 1
@.faila.1335 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1336 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1337 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:347:17  in ArrayList$Annotation.get\0A\00", align 1
...
@.fail.1340 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:351:51  in ArrayList$Annotation.set\0A\00", align 1
@.faila.1341 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1342 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.1343 = private unnamed_addr constant [132 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1344 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:354:30  in ArrayList$Annotation.set\0A\00", align 1
...
@.contract.1347 = private unnamed_addr constant [132 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1348 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:358:21  in ArrayList$Annotation.indexOf\0A\00", align 1
@.faila.1349 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1350 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1351 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:369:21  in ArrayList$Annotation.removeAt\0A\00", align 1
...
@.contract.1354 = private unnamed_addr constant [120 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.removeAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1355 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1356 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1357 = private unnamed_addr constant [137 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.removeAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1358 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:373:34  in ArrayList$Annotation.removeAt\0A\00", align 1
@.faila.1359 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1360 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1361 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:373:34  in ArrayList$Annotation.removeAt\0A\00", align 1
...
@.contract.1364 = private unnamed_addr constant [120 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.removeAt\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1367 = private unnamed_addr constant [137 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.removeAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1368 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:379:51  in ArrayList$Annotation.insertAt\0A\00", align 1
...
@.contract.1371 = private unnamed_addr constant [120 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1372 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1373 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1374 = private unnamed_addr constant [137 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1375 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:384:78  in ArrayList$Annotation.insertAt\0A\00", align 1
...
@.fail.1378 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:384:78  in ArrayList$Annotation.insertAt\0A\00", align 1
...
@.fail.1381 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:389:34  in ArrayList$Annotation.insertAt\0A\00", align 1
...
@.fail.1384 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:389:34  in ArrayList$Annotation.insertAt\0A\00", align 1
...
@.fail.1387 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:391:30  in ArrayList$Annotation.insertAt\0A\00", align 1
...
@.contract.1390 = private unnamed_addr constant [120 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1391 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1392 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1393 = private unnamed_addr constant [137 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.1394 = private unnamed_addr constant [117 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.clear\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1395 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1396 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1397 = private unnamed_addr constant [134 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.clear\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1398 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:405:71  in ArrayList$Annotation.toArray\0A\00", align 1
@.faila.1399 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1400 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1401 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:405:71  in ArrayList$Annotation.toArray\0A\00", align 1
@.faila.1402 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1403 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1404 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:416:70  in ArrayList$Annotation.forEach\0A\00", align 1
@.faila.1405 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1406 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1407 = private unnamed_addr constant [97 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:21  in ArrayList$Annotation.filter\0A\00", align 1
@.faila.1408 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1409 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1410 = private unnamed_addr constant [97 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:54  in ArrayList$Annotation.filter\0A\00", align 1
@.faila.1411 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1412 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1413 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:439:21  in ArrayList$Annotation.any\0A\00", align 1
@.faila.1414 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1415 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1416 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:445:21  in ArrayList$Annotation.all\0A\00", align 1
@.faila.1417 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1418 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1419 = private unnamed_addr constant [96 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:452:21  in ArrayList$Annotation.count\0A\00", align 1
@.faila.1420 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1421 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1422 = private unnamed_addr constant [99 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:462:71  in ArrayList$Annotation.sortedBy\0A\00", align 1
@.faila.1423 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1424 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.1425 = private unnamed_addr constant [120 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Annotation.sortedBy\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1428 = private unnamed_addr constant [137 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.sortedBy\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.1429 = private unnamed_addr constant [143 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1430 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:478:25  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
@.faila.1431 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1432 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1433 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:480:25  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
@.faila.1434 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1435 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1436 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
@.faila.1437 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1438 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1439 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1442 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:484:42  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.contract.1445 = private unnamed_addr constant [143 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1446 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1449 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.contract.1452 = private unnamed_addr constant [143 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1453 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
@.faila.1454 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1455 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1456 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1459 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1462 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1465 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1468 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1471 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1474 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1477 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1480 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
@.faila.1481 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1482 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1483 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.fail.1486 = private unnamed_addr constant [105 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$Annotation.mergeSortRange\0A\00", align 1
...
@.contract.1489 = private unnamed_addr constant [143 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Annotation.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1490 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:21  in ArrayList$Annotation.find\0A\00", align 1
...
@.fail.1493 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:47  in ArrayList$Annotation.find\0A\00", align 1
@.faila.1494 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1495 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1496 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:520:17  in ArrayList$Annotation.min\0A\00", align 1
...
@.fail.1499 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:21  in ArrayList$Annotation.min\0A\00", align 1
...
@.fail.1502 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:65  in ArrayList$Annotation.min\0A\00", align 1
...
@.fail.1505 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:528:17  in ArrayList$Annotation.max\0A\00", align 1
...
@.fail.1508 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:21  in ArrayList$Annotation.max\0A\00", align 1
...
@.fail.1511 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:65  in ArrayList$Annotation.max\0A\00", align 1
...
@.strdata.1524 = private constant [17 x i8] c"arithmetic error\00"
@.strobj.1525 = private global %String { i64 16, ptr @.strdata.1524, i64 0 }
@.strdata.1526 = private constant [17 x i8] c"division by zero\00"
@.strobj.1527 = private global %String { i64 16, ptr @.strdata.1526, i64 0 }
@.strdata.5525 = private constant [1 x i8] zeroinitializer
@.strobj.5526 = private global %String { i64 0, ptr @.strdata.5525, i64 0 }
...
argv.end:                                         ; preds = %argv.cond
  ...
  %list = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%"class.ArrayList$Annotation", ptr null, i64 1) to i64))
  call void @"ArrayList$Annotation.ArrayList$Annotation"(ptr %list)
  %16 = getelementptr inbounds %ReflectType, ptr %t1, i32 0, i32 8
  %n = load i64, ptr %16, align 8
  %17 = getelementptr inbounds %ReflectType, ptr %t1, i32 0, i32 9
...
l.hdr:                                            ; preds = %l.body, %argv.end
  ...
  %18 = icmp slt i64 %i, %n
  br i1 %18, label %l.body, label %l.done

l.body:                                           ; preds = %l.hdr
  %19 = getelementptr ptr, ptr %names, i64 %i
  %nm = load ptr, ptr %19, align 8
  %tok = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%ReflectAnnotation, ptr null, i64 1) to i64))
  %20 = getelementptr inbounds %ReflectAnnotation, ptr %tok, i32 0, i32 0
  store ptr %nm, ptr %20, align 8
  call void @"ArrayList$Annotation.add"(ptr %list, ptr %tok)
  %21 = add i64 %i, 1
  store i64 %21, ptr %li, align 8
  br label %l.hdr

l.done:                                           ; preds = %l.hdr
  store ptr %list, ptr %anns, align 8
  %anns2 = load ptr, ptr %anns, align 8
  %22 = call i32 @"ArrayList$Annotation.size"(ptr %anns2)
  %23 = call i32 (ptr, ...) @printf(ptr @.str, i32 %22)
  %anns3 = load ptr, ptr %anns, align 8
  %fe.arr = call ptr @"ArrayList$Annotation.toArray"(ptr %anns3)
...
fe.cond:                                          ; preds = %fe.update, %l.done
  ...
  %24 = icmp slt i32 %fe.iv, %fe.len32
  br i1 %24, label %fe.body, label %fe.end

fe.body:                                          ; preds = %fe.cond
  %25 = sext i32 %fe.iv to i64
...
fe.update:                                        ; preds = %idx.ok
  %26 = load i32, ptr %fe.i, align 4
  %27 = add i32 %26, 1
  store i32 %27, ptr %fe.i, align 4
  br label %fe.cond
...
idx.bad:                                          ; preds = %fe.body
  call void @__polaron_fail(ptr @.fail, ptr @.faila, i64 %25, ptr @.failb, i64 %arr.len, i32 70)
  unreachable

idx.ok:                                           ; preds = %fe.body
  %arr.data4 = getelementptr i8, ptr %fe.arr, i64 8
  %arr.elem = getelementptr inbounds ptr, ptr %arr.data4, i64 %25
  %fe.el = load ptr, ptr %arr.elem, align 8
  store ptr %fe.el, ptr %a, align 8
  %a5 = load ptr, ptr %a, align 8
  %28 = getelementptr inbounds %ReflectAnnotation, ptr %a5, i32 0, i32 0
  %a.name = load ptr, ptr %28, align 8
  %str.data = getelementptr inbounds %String, ptr %a.name, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %29 = call i32 (ptr, ...) @printf(ptr @.str.7, ptr %data)
  br label %fe.update
}
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.1306, ptr @.cl.1307, i64 %contract.l, ptr @.cr.1308, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1310, ptr @.faila.1311, i64 %19, ptr @.failb.1312, i64 %arr.len, i32 70)
  unreachable
...
idx.bad27:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1313, ptr @.faila.1314, i64 %22, ptr @.failb.1315, i64 %arr.len25, i32 70)
  unreachable
...
idx.bad41:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1316, ptr @.faila.1317, i64 %16, ptr @.failb.1318, i64 %arr.len39, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok42
  call void @__polaron_fail(ptr @.contract.1319, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
contract.fail55:                                  ; preds = %contract.cont
  ...
  call void @__polaron_fail(ptr @.contract.1320, ptr @.cl.1321, i64 %contract.l, ptr @.cr.1322, i64 0, i32 1)
  unreachable
...
contract.fail65:                                  ; preds = %contract.cont56
  call void @__polaron_fail(ptr @.contract.1323, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1324, ptr @.faila.1325, i64 %18, ptr @.failb.1326, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1327, ptr @.faila.1328, i64 %21, ptr @.failb.1329, i64 %arr.len20, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %if.end
  ...
  call void @__polaron_fail(ptr @.contract.1330, ptr @.cl.1331, i64 %contract.l, ptr @.cr.1332, i64 0, i32 1)
  unreachable
...
contract.fail40:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1333, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1334, ptr @.faila.1335, i64 %13, ptr @.failb.1336, i64 %arr.len, i32 70)
  unreachable
...
idx.bad20:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1337, ptr @.faila.1338, i64 %14, ptr @.failb.1339, i64 %arr.len18, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1340, ptr @.faila.1341, i64 %14, ptr @.failb.1342, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  call void @__polaron_fail(ptr @.contract.1343, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad26:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1344, ptr @.faila.1345, i64 %15, ptr @.failb.1346, i64 %arr.len24, i32 70)
  unreachable
...
contract.fail37:                                  ; preds = %idx.ok27
  call void @__polaron_fail(ptr @.contract.1347, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1348, ptr @.faila.1349, i64 %9, ptr @.failb.1350, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1351, ptr @.faila.1352, i64 %13, ptr @.failb.1353, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.1354, ptr @.cl.1355, i64 %contract.l, ptr @.cr.1356, i64 0, i32 1)
  unreachable
...
contract.fail25:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1357, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad36:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1358, ptr @.faila.1359, i64 %22, ptr @.failb.1360, i64 %arr.len34, i32 70)
  unreachable
...
idx.bad45:                                        ; preds = %idx.ok37
  call void @__polaron_fail(ptr @.fail.1361, ptr @.faila.1362, i64 %29, ptr @.failb.1363, i64 %arr.len43, i32 70)
  unreachable
...
contract.fail56:                                  ; preds = %for.end
  ...
  call void @__polaron_fail(ptr @.contract.1364, ptr @.cl.1365, i64 %contract.l60, ptr @.cr.1366, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1368, ptr @.faila.1369, i64 %14, ptr @.failb.1370, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.1371, ptr @.cl.1372, i64 %contract.l, ptr @.cr.1373, i64 0, i32 1)
  unreachable
...
contract.fail26:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1374, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad46:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1375, ptr @.faila.1376, i64 %31, ptr @.failb.1377, i64 %arr.len44, i32 70)
  unreachable
...
idx.bad55:                                        ; preds = %idx.ok47
  call void @__polaron_fail(ptr @.fail.1378, ptr @.faila.1379, i64 %34, ptr @.failb.1380, i64 %arr.len53, i32 70)
  unreachable
...
idx.bad76:                                        ; preds = %for.body66
  call void @__polaron_fail(ptr @.fail.1381, ptr @.faila.1382, i64 %37, ptr @.failb.1383, i64 %arr.len74, i32 70)
  unreachable
...
idx.bad85:                                        ; preds = %idx.ok77
  call void @__polaron_fail(ptr @.fail.1384, ptr @.faila.1385, i64 %42, ptr @.failb.1386, i64 %arr.len83, i32 70)
  unreachable
...
idx.bad95:                                        ; preds = %for.end68
  call void @__polaron_fail(ptr @.fail.1387, ptr @.faila.1388, i64 %40, ptr @.failb.1389, i64 %arr.len93, i32 70)
  unreachable
...
contract.fail106:                                 ; preds = %idx.ok96
  ...
  call void @__polaron_fail(ptr @.contract.1390, ptr @.cl.1391, i64 %contract.l110, ptr @.cr.1392, i64 0, i32 1)
  unreachable
...
contract.fail117:                                 ; preds = %contract.cont107
  call void @__polaron_fail(ptr @.contract.1393, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.1394, ptr @.cl.1395, i64 %contract.l, ptr @.cr.1396, i64 0, i32 1)
  unreachable
...
contract.fail17:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1397, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1398, ptr @.faila.1399, i64 %12, ptr @.failb.1400, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1401, ptr @.faila.1402, i64 %15, ptr @.failb.1403, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1404, ptr @.faila.1405, i64 %10, ptr @.failb.1406, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1407, ptr @.faila.1408, i64 %10, ptr @.failb.1409, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1410, ptr @.faila.1411, i64 %15, ptr @.failb.1412, i64 %arr.len20, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1413, ptr @.faila.1414, i64 %10, ptr @.failb.1415, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1416, ptr @.faila.1417, i64 %10, ptr @.failb.1418, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1419, ptr @.faila.1420, i64 %10, ptr @.failb.1421, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1422, ptr @.faila.1423, i64 %9, ptr @.failb.1424, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %if.then
  call void @__polaron_fail(ptr @.contract.1429, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1430, ptr @.faila.1431, i64 %25, ptr @.failb.1432, i64 %arr.len, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %sc.rhs
  call void @__polaron_fail(ptr @.fail.1433, ptr @.faila.1434, i64 %38, ptr @.failb.1435, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad43:                                        ; preds = %while.body
  call void @__polaron_fail(ptr @.fail.1436, ptr @.faila.1437, i64 %34, ptr @.failb.1438, i64 %arr.len41, i32 70)
  unreachable
...
idx.bad52:                                        ; preds = %idx.ok44
  call void @__polaron_fail(ptr @.fail.1439, ptr @.faila.1440, i64 %43, ptr @.failb.1441, i64 %arr.len50, i32 70)
  unreachable
...
idx.bad63:                                        ; preds = %while.end
  call void @__polaron_fail(ptr @.fail.1442, ptr @.faila.1443, i64 %36, ptr @.failb.1444, i64 %arr.len61, i32 70)
  unreachable
...
idx.bad95:                                        ; preds = %div.ok
  call void @__polaron_fail(ptr @.fail.1446, ptr @.faila.1447, i64 %48, ptr @.failb.1448, i64 %arr.len93, i32 70)
  unreachable
...
idx.bad105:                                       ; preds = %idx.ok96
  call void @__polaron_fail(ptr @.fail.1449, ptr @.faila.1450, i64 %50, ptr @.failb.1451, i64 %arr.len103, i32 70)
  unreachable
...
contract.fail118:                                 ; preds = %if.then110
  call void @__polaron_fail(ptr @.contract.1452, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad143:                                       ; preds = %while.body124
  call void @__polaron_fail(ptr @.fail.1453, ptr @.faila.1454, i64 %61, ptr @.failb.1455, i64 %arr.len141, i32 70)
  unreachable
...
idx.bad153:                                       ; preds = %idx.ok144
  call void @__polaron_fail(ptr @.fail.1456, ptr @.faila.1457, i64 %65, ptr @.failb.1458, i64 %arr.len151, i32 70)
  unreachable
...
idx.bad164:                                       ; preds = %if.then158
  call void @__polaron_fail(ptr @.fail.1459, ptr @.faila.1460, i64 %69, ptr @.failb.1461, i64 %arr.len162, i32 70)
  unreachable
...
idx.bad173:                                       ; preds = %idx.ok165
  call void @__polaron_fail(ptr @.fail.1462, ptr @.faila.1463, i64 %72, ptr @.failb.1464, i64 %arr.len171, i32 70)
  unreachable
...
idx.bad183:                                       ; preds = %if.else
  call void @__polaron_fail(ptr @.fail.1465, ptr @.faila.1466, i64 %70, ptr @.failb.1467, i64 %arr.len181, i32 70)
  unreachable
...
idx.bad192:                                       ; preds = %idx.ok184
  call void @__polaron_fail(ptr @.fail.1468, ptr @.faila.1469, i64 %74, ptr @.failb.1470, i64 %arr.len190, i32 70)
  unreachable
...
idx.bad208:                                       ; preds = %while.body200
  call void @__polaron_fail(ptr @.fail.1471, ptr @.faila.1472, i64 %78, ptr @.failb.1473, i64 %arr.len206, i32 70)
  unreachable
...
idx.bad217:                                       ; preds = %idx.ok209
  call void @__polaron_fail(ptr @.fail.1474, ptr @.faila.1475, i64 %79, ptr @.failb.1476, i64 %arr.len215, i32 70)
  unreachable
...
idx.bad233:                                       ; preds = %while.body225
  call void @__polaron_fail(ptr @.fail.1477, ptr @.faila.1478, i64 %84, ptr @.failb.1479, i64 %arr.len231, i32 70)
  unreachable
...
idx.bad242:                                       ; preds = %idx.ok234
  call void @__polaron_fail(ptr @.fail.1480, ptr @.faila.1481, i64 %85, ptr @.failb.1482, i64 %arr.len240, i32 70)
  unreachable
...
idx.bad261:                                       ; preds = %for.body251
  call void @__polaron_fail(ptr @.fail.1483, ptr @.faila.1484, i64 %90, ptr @.failb.1485, i64 %arr.len259, i32 70)
  unreachable
...
idx.bad269:                                       ; preds = %idx.ok262
  call void @__polaron_fail(ptr @.fail.1486, ptr @.faila.1487, i64 %95, ptr @.failb.1488, i64 %arr.len267, i32 70)
  unreachable
...
contract.fail281:                                 ; preds = %for.end253
  call void @__polaron_fail(ptr @.contract.1489, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1490, ptr @.faila.1491, i64 %10, ptr @.failb.1492, i64 %arr.len, i32 70)
  unreachable
...
idx.bad18:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1493, ptr @.faila.1494, i64 %15, ptr @.failb.1495, i64 %arr.len16, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1496, ptr @.faila.1497, i64 0, ptr @.failb.1498, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1499, ptr @.faila.1500, i64 %12, ptr @.failb.1501, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %if.then25
  call void @__polaron_fail(ptr @.fail.1502, ptr @.faila.1503, i64 %18, ptr @.failb.1504, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1505, ptr @.faila.1506, i64 0, ptr @.failb.1507, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1508, ptr @.faila.1509, i64 %12, ptr @.failb.1510, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %if.then25
  call void @__polaron_fail(ptr @.fail.1511, ptr @.faila.1512, i64 %18, ptr @.failb.1513, i64 %arr.len30, i32 70)
  unreachable
...
entry:
  %strcpy = call ptr @__polaron_str_copy(ptr @.strobj.1525)
  ret ptr %strcpy
}
...
entry:
  %strcpy = call ptr @__polaron_str_copy(ptr @.strobj.5526)
  %0 = load ptr, ptr @Test.criterion, align 8
  call void @__polaron_str_free(ptr %0)
  store ptr %strcpy, ptr @Test.criterion, align 8
  %strcpy1 = call ptr @__polaron_str_copy(ptr @.strobj.5528)
