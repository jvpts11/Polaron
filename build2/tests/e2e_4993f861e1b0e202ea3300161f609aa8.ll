; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reflect_typeof.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reflect_typeof.pol"
...
@methods.Dog = private constant [0 x ptr] zeroinitializer
@fields.Dog = private constant [0 x ptr] zeroinitializer
@annotations.Dog = private constant [0 x ptr] zeroinitializer
@methodfns.Dog = private constant [0 x ptr] zeroinitializer
@fieldget.Dog = private constant [0 x ptr] zeroinitializer
@fieldset.Dog = private constant [0 x ptr] zeroinitializer
@methodanncounts.Dog = private constant [0 x i64] zeroinitializer
@methodannptrs.Dog = private constant [0 x ptr] zeroinitializer
@methodrettags.Dog = private constant [0 x i64] zeroinitializer
@type.Dog = private constant %ReflectType { ptr @.strobj, i64 0, ptr @methods.Dog, ptr @methodfns.Dog, i64 0, ptr @fields.Dog, i64 ptrtoint (ptr getelementptr (%class.Dog, ptr null, i64 1) to i64), ptr @Dog.Dog, i64 0, ptr @annotations.Dog, ptr @fieldget.Dog, ptr @fieldset.Dog, ptr @methodanncounts.Dog, ptr @methodannptrs.Dog, ptr @methodrettags.Dog }
@.str = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"name=%s len=%d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = getelementptr inbounds %ReflectType, ptr %t1, i32 0, i32 0
  %name = load ptr, ptr %16, align 8
  %str.data = getelementptr inbounds %String, ptr %name, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %17 = call i32 (ptr, ...) @printf(ptr @.str, ptr %data)
  %name2 = load ptr, ptr @type.Dog, align 8
  %strcpy = call ptr @__polaron_str_copy(ptr %name2)
  store ptr %strcpy, ptr %n, align 8
  %n3 = load ptr, ptr %n, align 8
  %str.data4 = getelementptr inbounds %String, ptr %n3, i32 0, i32 1
  %data5 = load ptr, ptr %str.data4, align 8
  %n6 = load ptr, ptr %n, align 8
  %str.len = getelementptr inbounds %String, ptr %n6, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %18 = trunc i64 %len to i32
  %19 = call i32 (ptr, ...) @printf(ptr @.str.1, ptr %data5, i32 %18)
