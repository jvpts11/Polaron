; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/query_string.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/query_string.pol"
...
@.strdata = private constant [27 x i8] c"a=1&b=2&c=hello&me=A%20B&x\00"
@.strobj = private global %String { i64 26, ptr @.strdata, i64 0 }
@.str = private unnamed_addr constant [27 x i8] c"a=%s b=%s c=%s me=%s x=%s\0A\00", align 1
...
@.strdata.7 = private constant [3 x i8] c"me\00"
...
@.strdata.3101 = private constant [2 x i8] c"&\00"
@.strobj.3102 = private global %String { i64 1, ptr @.strdata.3101, i64 0 }
@.strdata.3103 = private constant [2 x i8] c"=\00"
@.strobj.3104 = private global %String { i64 1, ptr @.strdata.3103, i64 0 }
@.strdata.3105 = private constant [1 x i8] zeroinitializer
@.strobj.3106 = private global %String { i64 0, ptr @.strdata.3105, i64 0 }
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @QueryString.parse(ptr @.strobj)
  store ptr %16, ptr %m, align 8
  %m1 = load ptr, ptr %m, align 8
  %17 = call ptr @"HashMap$String$String.get"(ptr %m1, ptr @.strobj.2)
  %str.data = getelementptr inbounds %String, ptr %17, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %m2 = load ptr, ptr %m, align 8
  %18 = call ptr @"HashMap$String$String.get"(ptr %m2, ptr @.strobj.4)
  %str.data3 = getelementptr inbounds %String, ptr %18, i32 0, i32 1
  %data4 = load ptr, ptr %str.data3, align 8
  %m5 = load ptr, ptr %m, align 8
  %19 = call ptr @"HashMap$String$String.get"(ptr %m5, ptr @.strobj.6)
  %str.data6 = getelementptr inbounds %String, ptr %19, i32 0, i32 1
  %data7 = load ptr, ptr %str.data6, align 8
  %m8 = load ptr, ptr %m, align 8
  %20 = call ptr @"HashMap$String$String.get"(ptr %m8, ptr @.strobj.8)
  ...
  %21 = call ptr @"HashMap$String$String.get"(ptr %m11, ptr @.strobj.10)
  %str.data12 = getelementptr inbounds %String, ptr %21, i32 0, i32 1
  %data13 = load ptr, ptr %str.data12, align 8
  %22 = call i32 (ptr, ...) @printf(ptr @.str, ptr %data, ptr %data4, ptr %data7, ptr %data10, ptr %data13)
...
define internal ptr @QueryString.parse(ptr %0) {
entry:
  ...
  %qs1 = load ptr, ptr %qs, align 8
  %1 = call ptr @Strings.split(ptr %qs1, ptr @.strobj.3102)
...
for.cond:                                         ; preds = %for.update, %entry
  ...
  %2 = call i32 @"ArrayList$String.size"(ptr %parts3)
  %3 = icmp slt i32 %i2, %2
  %4 = zext i1 %3 to i32
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = call ptr @"ArrayList$String.get"(ptr %parts4, i32 %i5)
  %strcpy = call ptr @__polaron_str_copy(ptr %5)
  store ptr %strcpy, ptr %p, align 8
  call void @__polaron_str_free(ptr %5)
  %p6 = load ptr, ptr %p, align 8
  %str.len = getelementptr inbounds %String, ptr %p6, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %6 = trunc i64 %len to i32
  %7 = icmp eq i32 %6, 0
  %8 = zext i1 %7 to i32
...
for.update:                                       ; preds = %if.end14, %if.then
...
if.end:                                           ; preds = %for.body
  ...
  %str.data = getelementptr inbounds %String, ptr %p7, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %str.len8 = getelementptr inbounds %String, ptr %p7, i32 0, i32 0
  %len9 = load i64, ptr %str.len8, align 8
  %data10 = load ptr, ptr getelementptr inbounds (%String, ptr @.strobj.3104, i32 0, i32 1), align 8
  %len11 = load i64, ptr @.strobj.3104, align 8
  %11 = call i64 @__polaron_str_index(ptr %data, i64 %len9, ptr %data10, i64 %len11)
  %12 = trunc i64 %11 to i32
  store i32 %12, ptr %eq, align 4
  %eq12 = load i32, ptr %eq, align 4
  %13 = icmp slt i32 %eq12, 0
  %14 = zext i1 %13 to i32
  br i1 %13, label %if.then13, label %if.else

if.then13:                                        ; preds = %if.end
  %m15 = load ptr, ptr %m, align 8
  %p16 = load ptr, ptr %p, align 8
  %15 = call ptr @UrlCodec.decode(ptr %p16)
  call void @"HashMap$String$String.put"(ptr %m15, ptr %15, ptr @.strobj.3106)
  call void @__polaron_str_free(ptr %15)
  br label %if.end14

if.else:                                          ; preds = %if.end
  %p17 = load ptr, ptr %p, align 8
  %eq18 = load i32, ptr %eq, align 4
  %16 = sext i32 %eq18 to i64
  %17 = sub i64 %16, 0
  %18 = add i64 %17, 1
  %sub.buf = call ptr @__polaron_malloc(i64 %18)
  %str.data19 = getelementptr inbounds %String, ptr %p17, i32 0, i32 1
  %data20 = load ptr, ptr %str.data19, align 8
  %19 = getelementptr i8, ptr %data20, i64 0
  %20 = call ptr @memcpy(ptr %sub.buf, ptr %19, i64 %17)
  %21 = getelementptr i8, ptr %sub.buf, i64 %17
  ...
  store ptr %sub.buf, ptr %23, align 8
  %24 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 2
  store i64 0, ptr %24, align 8
  %25 = call ptr @UrlCodec.decode(ptr %newstr)
  %strcpy21 = call ptr @__polaron_str_copy(ptr %25)
  store ptr %strcpy21, ptr %k, align 8
  call void @__polaron_str_free(ptr %newstr)
  call void @__polaron_str_free(ptr %25)
  %p22 = load ptr, ptr %p, align 8
  %eq23 = load i32, ptr %eq, align 4
  %26 = add i32 %eq23, 1
  %27 = sext i32 %26 to i64
  %p24 = load ptr, ptr %p, align 8
  %str.len25 = getelementptr inbounds %String, ptr %p24, i32 0, i32 0
  %len26 = load i64, ptr %str.len25, align 8
  %28 = trunc i64 %len26 to i32
  %29 = sext i32 %28 to i64
  %30 = sub i64 %29, %27
  %31 = add i64 %30, 1
  %sub.buf27 = call ptr @__polaron_malloc(i64 %31)
  %str.data28 = getelementptr inbounds %String, ptr %p22, i32 0, i32 1
  %data29 = load ptr, ptr %str.data28, align 8
  %32 = getelementptr i8, ptr %data29, i64 %27
  %33 = call ptr @memcpy(ptr %sub.buf27, ptr %32, i64 %30)
  %34 = getelementptr i8, ptr %sub.buf27, i64 %30
  store i8 0, ptr %34, align 1
  %newstr30 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %35 = getelementptr inbounds %String, ptr %newstr30, i32 0, i32 0
  store i64 %30, ptr %35, align 8
  %36 = getelementptr inbounds %String, ptr %newstr30, i32 0, i32 1
  store ptr %sub.buf27, ptr %36, align 8
  %37 = getelementptr inbounds %String, ptr %newstr30, i32 0, i32 2
  store i64 0, ptr %37, align 8
  %38 = call ptr @UrlCodec.decode(ptr %newstr30)
  %strcpy31 = call ptr @__polaron_str_copy(ptr %38)
  store ptr %strcpy31, ptr %v, align 8
  call void @__polaron_str_free(ptr %newstr30)
  call void @__polaron_str_free(ptr %38)
  %m32 = load ptr, ptr %m, align 8
  %k33 = load ptr, ptr %k, align 8
  %v34 = load ptr, ptr %v, align 8
  call void @"HashMap$String$String.put"(ptr %m32, ptr %k33, ptr %v34)
