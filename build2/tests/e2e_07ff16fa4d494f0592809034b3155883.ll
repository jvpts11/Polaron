; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/goto_forward.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/goto_forward.pol"
...
@.str.1 = private unnamed_addr constant [13 x i8] c"non-negative\00", align 1
...
define internal void @Main.check(i32 %0) {
entry:
...
if.then:                                          ; preds = %entry
  br label %label.negative

if.end:                                           ; preds = %entry
  %3 = call i32 (ptr, ...) @printf(ptr @.str, ptr @.str.1)
  ret void

label.negative:                                   ; preds = %if.then
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Main.check(i32 5)
  call void @Main.check(i32 -3)
  ret i32 0
}
