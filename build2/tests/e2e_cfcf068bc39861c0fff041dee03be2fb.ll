; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/comparators.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/comparators.pol"
...
@.str = private unnamed_addr constant [35 x i8] c"asc=%d,%d,%d desc=%d,%d,%d tie=%d\0A\00", align 1
...
@__polaron_closure.1781 = private unnamed_addr constant [2 x ptr] [ptr @__polaron_lambda_1, ptr null]
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @"ArrayList$int.add"(ptr %nums1, i32 3)
  %nums2 = load ptr, ptr %nums, align 8
  call void @"ArrayList$int.add"(ptr %nums2, i32 1)
  %nums3 = load ptr, ptr %nums, align 8
  call void @"ArrayList$int.add"(ptr %nums3, i32 2)
  %nums4 = load ptr, ptr %nums, align 8
  %16 = call ptr @Comparators.naturalInt()
  %17 = call ptr @"ArrayList$int.sortedBy"(ptr %nums4, ptr %16)
  store ptr %17, ptr %asc, align 8
  %nums5 = load ptr, ptr %nums, align 8
  %18 = call ptr @Comparators.naturalInt()
  %19 = call ptr @Comparators.reversed(ptr %18)
  %20 = call ptr @"ArrayList$int.sortedBy"(ptr %nums5, ptr %19)
  store ptr %20, ptr %desc, align 8
  %21 = call ptr @Comparators.naturalInt()
  %22 = call ptr @Comparators.thenComparing(ptr @__polaron_closure, ptr %21)
  store ptr %22, ptr %tc, align 8
  %asc6 = load ptr, ptr %asc, align 8
  %23 = call i32 @"ArrayList$int.get"(ptr %asc6, i32 0)
  %asc7 = load ptr, ptr %asc, align 8
  %24 = call i32 @"ArrayList$int.get"(ptr %asc7, i32 1)
  %asc8 = load ptr, ptr %asc, align 8
  %25 = call i32 @"ArrayList$int.get"(ptr %asc8, i32 2)
  %desc9 = load ptr, ptr %desc, align 8
  %26 = call i32 @"ArrayList$int.get"(ptr %desc9, i32 0)
  %desc10 = load ptr, ptr %desc, align 8
  %27 = call i32 @"ArrayList$int.get"(ptr %desc10, i32 1)
  %desc11 = load ptr, ptr %desc, align 8
  %28 = call i32 @"ArrayList$int.get"(ptr %desc11, i32 2)
  %tc12 = load ptr, ptr %tc, align 8
  %code = load ptr, ptr %tc12, align 8
  %29 = getelementptr ptr, ptr %tc12, i32 1
  %env = load ptr, ptr %29, align 8
  %30 = call i32 %code(ptr %env, i32 5, i32 3)
  %31 = call i32 (ptr, ...) @printf(ptr @.str, i32 %23, i32 %24, i32 %25, i32 %26, i32 %27, i32 %28, i32 %30)
  ret i32 0
}
...
define internal ptr @Comparators.naturalInt() {
entry:
  ret ptr @__polaron_closure.1781
}

define internal ptr @Comparators.reversed(ptr %0) {
entry:
  %cmp = alloca ptr, align 8
  store ptr %0, ptr %cmp, align 8
...
define internal ptr @Comparators.thenComparing(ptr %0, ptr %1) {
entry:
  ...
  %closure = call ptr @__polaron_malloc(i64 16)
  store ptr @__polaron_lambda_3, ptr %closure, align 8
...
entry:
  ...
  %cmp = load ptr, ptr %3, align 8
  %cmp1 = load ptr, ptr %cmp, align 8
  %code = load ptr, ptr %cmp1, align 8
  %4 = getelementptr ptr, ptr %cmp1, i32 1
  %env = load ptr, ptr %4, align 8
  %b2 = load i32, ptr %b, align 4
  %a3 = load i32, ptr %a, align 4
  %5 = call i32 %code(ptr %env, i32 %b2, i32 %a3)
  ret i32 %5
}
...
entry:
  ...
  store i32 %2, ptr %b, align 4
  %3 = getelementptr ptr, ptr %0, i32 0
  %first = load ptr, ptr %3, align 8
  %4 = getelementptr ptr, ptr %0, i32 1
  %second = load ptr, ptr %4, align 8
  %first1 = load ptr, ptr %first, align 8
  %code = load ptr, ptr %first1, align 8
  %5 = getelementptr ptr, ptr %first1, i32 1
  %env = load ptr, ptr %5, align 8
  %a2 = load i32, ptr %a, align 4
  %b3 = load i32, ptr %b, align 4
  %6 = call i32 %code(ptr %env, i32 %a2, i32 %b3)
...
if.end:                                           ; preds = %entry
  %second6 = load ptr, ptr %second, align 8
  %code7 = load ptr, ptr %second6, align 8
  %9 = getelementptr ptr, ptr %second6, i32 1
  %env8 = load ptr, ptr %9, align 8
  %a9 = load i32, ptr %a, align 4
  %b10 = load i32, ptr %b, align 4
  %10 = call i32 %code7(ptr %env8, i32 %a9, i32 %b10)
  ret i32 %10
}
