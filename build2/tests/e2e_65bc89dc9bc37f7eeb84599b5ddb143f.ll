; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/while_true_return.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/while_true_return.pol"
...
define internal ptr @Main.make(i32 %0) {
entry:
...
if.then:                                          ; preds = %while.body
  ...
  call void @Box.Box(ptr %Box.obj, i32 %i3)
  ret ptr %Box.obj
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @Main.make(i32 40)
  store ptr %16, ptr %b, align 8
  %b1 = load ptr, ptr %b, align 8
  %v = getelementptr inbounds %class.Box, ptr %b1, i32 0, i32 1
  %v2 = load i32, ptr %v, align 4, !tbaa !4
  %17 = call i32 (ptr, ...) @printf(ptr @.str, i32 %v2)
  ret i32 0
}
