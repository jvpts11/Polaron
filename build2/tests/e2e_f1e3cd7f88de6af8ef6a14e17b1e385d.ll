; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/structs.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/structs.pol"
...
@.str.1 = private unnamed_addr constant [19 x i8] c"p.x = %d q.x = %d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 @Point.sum(ptr %p1)
  %17 = call i32 (ptr, ...) @printf(ptr @.str, i32 %16)
  %p2 = load ptr, ptr %p, align 8
  %18 = call ptr @memcpy(ptr %Point.copy, ptr %p2, i64 ptrtoint (ptr getelementptr (%class.Point, ptr null, i64 1) to i64))
  store ptr %Point.copy, ptr %q, align 8
  %q3 = load ptr, ptr %q, align 8
  %x = getelementptr inbounds %class.Point, ptr %q3, i32 0, i32 0
  store i32 100, ptr %x, align 4, !tbaa !0
  %p4 = load ptr, ptr %p, align 8
  %x5 = getelementptr inbounds %class.Point, ptr %p4, i32 0, i32 0
  %x6 = load i32, ptr %x5, align 4, !tbaa !0
  %q7 = load ptr, ptr %q, align 8
  %x8 = getelementptr inbounds %class.Point, ptr %q7, i32 0, i32 0
  %x9 = load i32, ptr %x8, align 4, !tbaa !0
  %19 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %x6, i32 %x9)
  ret i32 0
}
