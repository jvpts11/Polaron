...
define internal i32 @World__Paths.one(ptr nonnull align 8 dereferenceable(8) %0) {
entry:
  ret i32 41
}

define internal void @World__Paths.World__Paths(ptr %0) {
entry:
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.World__Paths, ptr %0, i32 0, i32 0
  store ptr @World__Paths.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  ret void
}

define internal void @World__Scanner.World__Scanner(ptr %0, i32 %1) {
entry:
  %n = alloca i32, align 4
  store i32 %1, ptr %n, align 4
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.World__Scanner, ptr %0, i32 0, i32 0
  store ptr @World__Scanner.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %n1 = getelementptr inbounds %class.World__Scanner, ptr %0, i32 0, i32 1
  %n2 = load i32, ptr %n, align 4
  store i32 %n2, ptr %n1, align 4, !tbaa !4
  ret void
}

define internal i32 @World__Scanner.value(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %n = getelementptr inbounds %class.World__Scanner, ptr %0, i32 0, i32 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %World__Paths.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.World__Paths, ptr null, i64 1) to i64))
  call void @World__Paths.World__Paths(ptr %World__Paths.obj)
  store ptr %World__Paths.obj, ptr %p, align 8
  %World__Scanner.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.World__Scanner, ptr null, i64 1) to i64))
  call void @World__Scanner.World__Scanner(ptr %World__Scanner.obj, i32 1)
  store ptr %World__Scanner.obj, ptr %f, align 8
  %p1 = load ptr, ptr %p, align 8
  %16 = call i32 @World__Paths.one(ptr %p1)
  %f2 = load ptr, ptr %f, align 8
  %17 = call i32 @World__Scanner.value(ptr %f2)
  %18 = add i32 %16, %17
  %19 = call i32 (ptr, ...) @printf(ptr @.str, i32 %18)
  %f3 = load ptr, ptr %f, align 8
  call void @__polaron_check_live(ptr %f3)
  %vtbl.addr = getelementptr inbounds %class.World__Scanner, ptr %f3, i32 0, i32 0
...
dtor.call:                                        ; preds = %argv.end
  call void %dtor.fn(ptr %f3)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %argv.end
  call void @__polaron_free(ptr %f3)
  %p4 = load ptr, ptr %p, align 8
  call void @__polaron_check_live(ptr %p4)
  %vtbl.addr5 = getelementptr inbounds %class.World__Paths, ptr %p4, i32 0, i32 0
  ...
  %21 = icmp ne ptr %dtor.fn8, null
  br i1 %21, label %dtor.call9, label %dtor.free10

dtor.call9:                                       ; preds = %dtor.free
  call void %dtor.fn8(ptr %p4)
  br label %dtor.free10

dtor.free10:                                      ; preds = %dtor.call9, %dtor.free
  call void @__polaron_free(ptr %p4)
  ret i32 0
}
