...
@.str = private unnamed_addr constant [22 x i8] c"legs = %d barks = %d\0A\00", align 1
...
define internal void @Animal.Animal(ptr %0, i32 %1) {
entry:
  %legs = alloca i32, align 4
  store i32 %1, ptr %legs, align 4
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.Animal, ptr %0, i32 0, i32 0
  store ptr @Animal.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %legs1 = getelementptr inbounds %class.Animal, ptr %0, i32 0, i32 1
  %legs2 = load i32, ptr %legs, align 4
  store i32 %legs2, ptr %legs1, align 4, !tbaa !4
  ret void
}

define internal i32 @Animal.legCount(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %legs = getelementptr inbounds %class.Animal, ptr %0, i32 0, i32 1
  %legs1 = load i32, ptr %legs, align 4, !tbaa !4
  ret i32 %legs1
}

define internal void @Dog.Dog(ptr %0, i32 %1) {
entry:
  %barks = alloca i32, align 4
  store i32 %1, ptr %barks, align 4
  call void @Animal.Animal(ptr %0, i32 4)
  %vtbl.addr = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 0
  store ptr @Dog.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %barks1 = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 2
  %barks2 = load i32, ptr %barks, align 4
  store i32 %barks2, ptr %barks1, align 4, !tbaa !4
  ret void
}

define internal void @Dog.describe(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %1 = call i32 @Animal.legCount(ptr %0)
  %barks = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 2
  %barks1 = load i32, ptr %barks, align 4, !tbaa !4
  %2 = call i32 (ptr, ...) @printf(ptr @.str, i32 %1, i32 %barks1)
  ret void
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Dog.describe(ptr %d1)
  %d2 = load ptr, ptr %d, align 8
  call void @__polaron_check_live(ptr %d2)
  %vtbl.addr = getelementptr inbounds %class.Dog, ptr %d2, i32 0, i32 0
...
dtor.call:                                        ; preds = %argv.end
  call void %dtor.fn(ptr %d2)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %argv.end
  call void @__polaron_free(ptr %d2)
  ret i32 0
}
