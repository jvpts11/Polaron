...
@.str = private unnamed_addr constant [8 x i8] c"rgb=%d\0A\00", align 1
...
define internal void @Color.Color(ptr %0, i32 %1) {
entry:
  %v = alloca i32, align 4
  store i32 %1, ptr %v, align 4
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.Color, ptr %0, i32 0, i32 0
  store ptr @Color.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %rgb = getelementptr inbounds %class.Color, ptr %0, i32 0, i32 1
  %v1 = load i32, ptr %v, align 4
  store i32 %v1, ptr %rgb, align 4, !tbaa !4
  ret void
}

define internal i32 @Color.value(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %rgb = getelementptr inbounds %class.Color, ptr %0, i32 0, i32 1
  %rgb1 = load i32, ptr %rgb, align 4, !tbaa !4
  ret i32 %rgb1
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %Color.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Color, ptr null, i64 1) to i64))
  call void @Color.Color(ptr %Color.obj, i32 255)
  store ptr %Color.obj, ptr %c, align 8
  %c1 = load ptr, ptr %c, align 8
  %16 = call i32 @Color.value(ptr %c1)
  %17 = call i32 (ptr, ...) @printf(ptr @.str, i32 %16)
  %c2 = load ptr, ptr %c, align 8
  call void @__polaron_check_live(ptr %c2)
  %vtbl.addr = getelementptr inbounds %class.Color, ptr %c2, i32 0, i32 0
...
dtor.call:                                        ; preds = %argv.end
  call void %dtor.fn(ptr %c2)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %argv.end
  call void @__polaron_free(ptr %c2)
  ret i32 0
}
