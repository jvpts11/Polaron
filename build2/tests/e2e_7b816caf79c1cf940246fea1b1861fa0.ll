; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_byref.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_byref.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  store ptr %counter, ptr %16, align 8
  %closure = call ptr @__polaron_malloc(i64 16)
  store ptr @__polaron_lambda_0, ptr %closure, align 8
  %17 = getelementptr ptr, ptr %closure, i32 1
  store ptr %env, ptr %17, align 8
  store ptr %closure, ptr %get, align 8
  store i32 9, ptr %counter, align 4
  %get1 = load ptr, ptr %get, align 8
  %code = load ptr, ptr %get1, align 8
  %18 = getelementptr ptr, ptr %get1, i32 1
  %env2 = load ptr, ptr %18, align 8
  %19 = call i32 %code(ptr %env2)
...
define internal i32 @__polaron_lambda_0(ptr %0) {
entry:
