; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/transient_copy.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/transient_copy.pol"
...
entry:
  ...
  %cachedDouble = getelementptr inbounds %class.Counter, ptr %0, i32 0, i32 2
  %v2 = load i32, ptr %v, align 4
  %2 = mul i32 %v2, 2
  store i32 %2, ptr %cachedDouble, align 4, !tbaa !4
  ret void
}

define internal i32 @Counter.value(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %value = getelementptr inbounds %class.Counter, ptr %0, i32 0, i32 1
...
define internal i32 @Counter.cached(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %cachedDouble = getelementptr inbounds %class.Counter, ptr %0, i32 0, i32 2
  %cachedDouble1 = load i32, ptr %cachedDouble, align 4, !tbaa !4
  ret i32 %cachedDouble1
}

define i32 @main(i32 %0, ptr %1) {
entry:
  %b = alloca ptr, align 8
  %Counter.copy = alloca %class.Counter, align 8
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Counter.Counter(ptr %Counter.obj, i32 21)
  store ptr %Counter.obj, ptr %a, align 8
  %a1 = load ptr, ptr %a, align 8
  %16 = call ptr @memcpy(ptr %Counter.copy, ptr %a1, i64 ptrtoint (ptr getelementptr (%class.Counter, ptr null, i64 1) to i64))
  %17 = getelementptr inbounds %class.Counter, ptr %Counter.copy, i32 0, i32 2
  store i32 0, ptr %17, align 4, !tbaa !4
  store ptr %Counter.copy, ptr %b, align 8
  %a2 = load ptr, ptr %a, align 8
  %18 = call i32 @Counter.value(ptr %a2)
  %a3 = load ptr, ptr %a, align 8
  %19 = call i32 @Counter.cached(ptr %a3)
  %b4 = load ptr, ptr %b, align 8
  %20 = call i32 @Counter.value(ptr %b4)
  %b5 = load ptr, ptr %b, align 8
  %21 = call i32 @Counter.cached(ptr %b5)
  %22 = call i32 (ptr, ...) @printf(ptr @.str, i32 %18, i32 %19, i32 %20, i32 %21)
  ret i32 0
}
