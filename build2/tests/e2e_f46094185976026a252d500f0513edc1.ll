; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/abstain_raii.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/abstain_raii.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%class.Noisy = type { ptr }
...
@abstain.Main.run.lbl = private global i32 0
...
if.then:                                          ; preds = %entry
  %3 = atomicrmw add ptr @abstain.Main.run.lbl, i32 1 seq_cst, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  br label %label.lbl

label.lbl:                                        ; preds = %if.end
  %abstain.c = load atomic i32, ptr @abstain.Main.run.lbl seq_cst, align 4
  %4 = icmp ne i32 %abstain.c, 0
  br i1 %4, label %label.off, label %label.on

label.on:                                         ; preds = %label.lbl
  call void @Noisy.Noisy(ptr %Noisy.obj)
  store ptr %Noisy.obj, ptr %a, align 8
  %5 = call i32 (ptr, ...) @printf(ptr @.str.4, ptr @.str.5)
  br label %label.next

label.off:                                        ; preds = %label.lbl
  br label %label.next

label.next:                                       ; preds = %label.on, %label.off
  %6 = load ptr, ptr %a, align 8
  %7 = icmp ne ptr %6, null
  br i1 %7, label %dtor.live, label %dtor.done

dtor.live:                                        ; preds = %label.next
  call void @"Noisy.~Noisy"(ptr %6)
  br label %dtor.done

dtor.done:                                        ; preds = %dtor.live, %label.next
  ret void
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %17 = call i32 (ptr, ...) @printf(ptr @.str.8, ptr @.str.9)
  ret i32 0
}
