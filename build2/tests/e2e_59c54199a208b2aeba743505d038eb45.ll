; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/deep_copy_reassign.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/deep_copy_reassign.pol"
...
@.fail = private unnamed_addr constant [140 x i8] c"Polaron panic: array index out of bounds\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/deep_copy_reassign.pol:16:31  in Bag.Bag\0A\00", align 1
@.faila = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1 = private unnamed_addr constant [140 x i8] c"Polaron panic: array index out of bounds\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/deep_copy_reassign.pol:18:74  in Bag.set\0A\00", align 1
...
@.fail.4 = private unnamed_addr constant [140 x i8] c"Polaron panic: array index out of bounds\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/deep_copy_reassign.pol:19:52  in Bag.get\0A\00", align 1
...
idx.bad:                                          ; preds = %entry
  call void @__polaron_fail(ptr @.fail.4, ptr @.faila.5, i64 %2, ptr @.failb.6, i64 %arr.len, i32 70)
  unreachable
...
entry:
  ...
  %Bag.obj1 = alloca %class.Bag, align 8
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Bag.Bag(ptr %Bag.obj1)
  store ptr %Bag.obj1, ptr %b, align 8
  %b2 = load ptr, ptr %b, align 8
  call void @Bag.set(ptr %b2, i32 0, i32 5)
  %a3 = load ptr, ptr %a, align 8
  %16 = load ptr, ptr %b, align 8
  %17 = icmp eq ptr %a3, %16
  br i1 %17, label %vcopy.done, label %vcopy

vcopy:                                            ; preds = %argv.end
  %18 = getelementptr inbounds %class.Bag, ptr %16, i32 0, i32 1
  %19 = load ptr, ptr %18, align 8, !tbaa !0
  call void @__polaron_free(ptr %19)
  %20 = call ptr @memcpy(ptr %16, ptr %a3, i64 ptrtoint (ptr getelementptr (%class.Bag, ptr null, i64 1) to i64))
  %21 = getelementptr inbounds %class.Bag, ptr %a3, i32 0, i32 1
  %22 = load ptr, ptr %21, align 8, !tbaa !0
  %arr.len = load i64, ptr %22, align 8
  %23 = mul i64 %arr.len, 4
  %24 = add i64 8, %23
  %arr.copy = call ptr @__polaron_malloc(i64 %24)
  %25 = call ptr @memcpy(ptr %arr.copy, ptr %22, i64 %24)
  %26 = getelementptr inbounds %class.Bag, ptr %16, i32 0, i32 1
  store ptr %arr.copy, ptr %26, align 8, !tbaa !0
  br label %vcopy.done

vcopy.done:                                       ; preds = %vcopy, %argv.end
  %b4 = load ptr, ptr %b, align 8
  call void @Bag.set(ptr %b4, i32 0, i32 999)
  %a5 = load ptr, ptr %a, align 8
  %27 = call i32 @Bag.get(ptr %a5, i32 0)
  %b6 = load ptr, ptr %b, align 8
  %28 = call i32 @Bag.get(ptr %b6, i32 0)
  %29 = call i32 (ptr, ...) @printf(ptr @.str, i32 %27, i32 %28)
  ret i32 0
}
