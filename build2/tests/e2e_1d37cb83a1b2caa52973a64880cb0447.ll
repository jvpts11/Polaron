; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/main_args.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/main_args.pol"
...
@.fail = private unnamed_addr constant [128 x i8] c"Polaron panic: array index out of bounds\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/main_args.pol:14:45  in main\0A\00", align 1
...
for.cond:                                         ; preds = %for.update, %argv.end
  ...
  %args3 = load ptr, ptr %args, align 8
  %len4 = load i64, ptr %args3, align 8
  %18 = trunc i64 %len4 to i32
  %19 = icmp slt i32 %i2, %18
  %20 = zext i1 %19 to i32
  br i1 %19, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %args5 = load ptr, ptr %args, align 8, !nonnull !0, !dereferenceable !1
  %i6 = load i32, ptr %i, align 4
  %21 = sext i32 %i6 to i64
  %arr.len = load i64, ptr %args5, align 8
...
idx.ok:                                           ; preds = %for.body
  %arr.data7 = getelementptr i8, ptr %args5, i64 8
  %arr.elem = getelementptr inbounds ptr, ptr %arr.data7, i64 %21
  %elem = load ptr, ptr %arr.elem, align 8
  %str.data = getelementptr inbounds %String, ptr %elem, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %25 = call i32 (ptr, ...) @printf(ptr @.str.1, ptr %data)
  br label %for.update
}
