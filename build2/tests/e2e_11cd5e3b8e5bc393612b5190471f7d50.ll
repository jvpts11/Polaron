; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/exceptions_propagate.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/exceptions_propagate.pol"
...
@.str.1 = private unnamed_addr constant [13 x i8] c"not reached\0A\00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"caught code=%d\0A\00", align 1
...
define internal void @Main.risky(i32 %0) personality ptr @__CxxFrameHandler3 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  call void @MyError.MyError(ptr %MyError.obj)
...
invoke.cont:                                      ; preds = %argv.end
  %18 = call i32 (ptr, ...) @printf(ptr @.str, ptr @.str.1)
  br label %try.cont

catch.dispatch:                                   ; preds = %ehpad
  %19 = catchpad within %16 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught]
  ...
  %20 = call i32 (ptr, ...) @printf(ptr @.str.2, i32 %code2)
  br label %try.cont
