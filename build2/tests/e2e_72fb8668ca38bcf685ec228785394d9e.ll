; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_raii.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_raii.pol"
...
rgn.ok:                                           ; preds = %argv.end
  ...
  invoke void @Dog.Dog(ptr %rgn.obj, i32 5)
...
invoke.cont:                                      ; preds = %rgn.ok
  ...
  %21 = invoke i32 @Dog.getAge(ptr %a4)
          to label %invoke.cont12 unwind label %cleanup5

cleanup5:                                         ; preds = %invoke.cont
