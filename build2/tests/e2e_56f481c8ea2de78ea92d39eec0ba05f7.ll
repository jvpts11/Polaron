; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/cast_checked.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/cast_checked.pol"
...
@.str.3 = private unnamed_addr constant [7 x i8] c"caught\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@.str.5 = private unnamed_addr constant [9 x i8] c"valid ok\00", align 1
@.strdata.1305 = private constant [13 x i8] c"invalid cast\00"
@.strobj.1306 = private global %String { i64 12, ptr @.strdata.1305, i64 0 }
...
entry:
  ...
  %exc.thrown2 = alloca ptr, align 8
...
try.cont:                                         ; preds = %catch.body, %cast.ok
  ...
  store ptr %Dog.obj, ptr %a2, align 8
  %a23 = load ptr, ptr %a2, align 8
  %cast.nn4 = icmp ne ptr %a23, null
  %isa.null5 = icmp eq ptr %a23, null
  br i1 %isa.null5, label %isa.cont7, label %isa.chk6

isa.chk:                                          ; preds = %argv.end
  %isa.vtbl = load ptr, ptr %a1, align 8
  %17 = icmp eq ptr %isa.vtbl, @Dog.vtable
  %18 = or i1 false, %17
  br label %isa.cont

isa.cont:                                         ; preds = %isa.chk, %argv.end
  %isa = phi i1 [ false, %argv.end ], [ %18, %isa.chk ]
  %19 = xor i1 %isa, true
  %20 = and i1 %cast.nn, %19
  br i1 %20, label %cast.bad, label %cast.ok
...
cast.ok:                                          ; preds = %isa.cont
  store ptr %a1, ptr %d, align 8
  %21 = call i32 (ptr, ...) @printf(ptr @.str, ptr @.str.1)
  br label %try.cont

throw.cont:                                       ; preds = %cast.bad
  unreachable

catch.dispatch:                                   ; preds = %ehpad
  %22 = catchpad within %16 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught]
  %caught = load ptr, ptr %exc.caught, align 8
  %exc.vtbl = load ptr, ptr %caught, align 8
  %is = icmp eq ptr %exc.vtbl, @ClassCastException.vtable
...
rethrow:                                          ; preds = %catch.next
  ...
  store ptr %rethrow.obj, ptr %exc.thrown2, align 8
  call void @_CxxThrowException(ptr %exc.thrown2, ptr @_TI1PEAX)
  unreachable

isa.chk6:                                         ; preds = %try.cont
  %isa.vtbl8 = load ptr, ptr %a23, align 8
  %24 = icmp eq ptr %isa.vtbl8, @Dog.vtable
  %25 = or i1 false, %24
  br label %isa.cont7

isa.cont7:                                        ; preds = %isa.chk6, %try.cont
  %isa9 = phi i1 [ false, %try.cont ], [ %25, %isa.chk6 ]
  %26 = xor i1 %isa9, true
  %27 = and i1 %cast.nn4, %26
  br i1 %27, label %cast.bad10, label %cast.ok11

cast.bad10:                                       ; preds = %isa.cont7
  %exc12 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.ClassCastException, ptr null, i64 1) to i64))
  call void @ClassCastException.ClassCastException(ptr %exc12)
  store ptr %exc12, ptr %exc.thrown13, align 8
  call void @_CxxThrowException(ptr %exc.thrown13, ptr @_TI1PEAX)
  unreachable

cast.ok11:                                        ; preds = %isa.cont7
  store ptr %a23, ptr %d2, align 8
