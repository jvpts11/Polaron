; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reflect_field_getset.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reflect_field_getset.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%ReflectType = type { ptr, i64, ptr, ptr, i64, ptr, i64, ptr, i64, ptr, ptr, ptr, ptr, ptr, ptr }
%class.Point = type { ptr, i32 }
...
@.strdata = private constant [6 x i8] c"Point\00"
@.strobj = private global %String { i64 5, ptr @.strdata, i64 0 }
@methods.Point = private constant [0 x ptr] zeroinitializer
@.strdata.1 = private constant [2 x i8] c"x\00"
@.strobj.2 = private global %String { i64 1, ptr @.strdata.1, i64 0 }
@fields.Point = private constant [1 x ptr] [ptr @.strobj.2]
@annotations.Point = private constant [0 x ptr] zeroinitializer
@methodfns.Point = private constant [0 x ptr] zeroinitializer
@fieldget.Point = private constant [1 x ptr] [ptr @__fget.Point.x]
@fieldset.Point = private constant [1 x ptr] [ptr @__fset.Point.x]
@methodanncounts.Point = private constant [0 x i64] zeroinitializer
@methodannptrs.Point = private constant [0 x ptr] zeroinitializer
@methodrettags.Point = private constant [0 x i64] zeroinitializer
@type.Point = private constant %ReflectType { ptr @.strobj, i64 0, ptr @methods.Point, ptr @methodfns.Point, i64 1, ptr @fields.Point, i64 ptrtoint (ptr getelementptr (%class.Point, ptr null, i64 1) to i64), ptr @Point.Point, i64 0, ptr @annotations.Point, ptr @fieldget.Point, ptr @fieldset.Point, ptr @methodanncounts.Point, ptr @methodannptrs.Point, ptr @methodrettags.Point }
@.str = private unnamed_addr constant [30 x i8] c"before=%d after=%d direct=%d\0A\00", align 1
...
@.contract.1298 = private unnamed_addr constant [122 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Field.ArrayList$Field\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1299 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1300 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1301 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.ArrayList$Field\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1302 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:320:35  in ArrayList$Field.add\0A\00", align 1
@.faila.1303 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1304 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1305 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:320:35  in ArrayList$Field.add\0A\00", align 1
@.faila.1306 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1307 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1308 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:325:39  in ArrayList$Field.add\0A\00", align 1
@.faila.1309 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1310 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.1311 = private unnamed_addr constant [123 x i8] c"contract violated: ensures\0A  --> <prelude>:315:36  in ArrayList$Field.add\0A   |  ensures this.count == old(this.count) + 1\0A\00", align 1
@.contract.1312 = private unnamed_addr constant [110 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Field.add\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1313 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1314 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1315 = private unnamed_addr constant [127 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.add\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1316 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:334:78  in ArrayList$Field.ensureCapacity\0A\00", align 1
...
@.fail.1319 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:334:78  in ArrayList$Field.ensureCapacity\0A\00", align 1
...
@.contract.1322 = private unnamed_addr constant [121 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Field.ensureCapacity\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1325 = private unnamed_addr constant [138 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.ensureCapacity\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1326 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:345:21  in ArrayList$Field.get\0A\00", align 1
...
@.fail.1329 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:347:17  in ArrayList$Field.get\0A\00", align 1
...
@.fail.1332 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:351:51  in ArrayList$Field.set\0A\00", align 1
...
@.contract.1335 = private unnamed_addr constant [127 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1336 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:354:30  in ArrayList$Field.set\0A\00", align 1
...
@.contract.1339 = private unnamed_addr constant [127 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1340 = private unnamed_addr constant [93 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:358:21  in ArrayList$Field.indexOf\0A\00", align 1
...
@.fail.1343 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:369:21  in ArrayList$Field.removeAt\0A\00", align 1
...
@.contract.1346 = private unnamed_addr constant [115 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Field.removeAt\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1349 = private unnamed_addr constant [132 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.removeAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1350 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:373:34  in ArrayList$Field.removeAt\0A\00", align 1
...
@.fail.1353 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:373:34  in ArrayList$Field.removeAt\0A\00", align 1
...
@.fail.1360 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:379:51  in ArrayList$Field.insertAt\0A\00", align 1
...
@.contract.1363 = private unnamed_addr constant [115 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Field.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1366 = private unnamed_addr constant [132 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1367 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:384:78  in ArrayList$Field.insertAt\0A\00", align 1
...
@.fail.1370 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:384:78  in ArrayList$Field.insertAt\0A\00", align 1
...
@.fail.1373 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:389:34  in ArrayList$Field.insertAt\0A\00", align 1
@.faila.1374 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1375 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1376 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:389:34  in ArrayList$Field.insertAt\0A\00", align 1
@.faila.1377 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1378 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1379 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:391:30  in ArrayList$Field.insertAt\0A\00", align 1
@.faila.1380 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1381 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.1382 = private unnamed_addr constant [115 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Field.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1385 = private unnamed_addr constant [132 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.1386 = private unnamed_addr constant [112 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Field.clear\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1389 = private unnamed_addr constant [129 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.clear\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1390 = private unnamed_addr constant [93 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:405:71  in ArrayList$Field.toArray\0A\00", align 1
...
@.fail.1393 = private unnamed_addr constant [93 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:405:71  in ArrayList$Field.toArray\0A\00", align 1
...
@.fail.1396 = private unnamed_addr constant [93 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:416:70  in ArrayList$Field.forEach\0A\00", align 1
@.faila.1397 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1398 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1399 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:21  in ArrayList$Field.filter\0A\00", align 1
@.faila.1400 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1401 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1402 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:54  in ArrayList$Field.filter\0A\00", align 1
@.faila.1403 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1404 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1405 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:439:21  in ArrayList$Field.any\0A\00", align 1
@.faila.1406 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1407 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1408 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:445:21  in ArrayList$Field.all\0A\00", align 1
@.faila.1409 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1410 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1411 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:452:21  in ArrayList$Field.count\0A\00", align 1
@.faila.1412 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1413 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1414 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:462:71  in ArrayList$Field.sortedBy\0A\00", align 1
@.faila.1415 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1416 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.1417 = private unnamed_addr constant [115 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$Field.sortedBy\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1418 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1419 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1420 = private unnamed_addr constant [132 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.sortedBy\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.1421 = private unnamed_addr constant [138 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1422 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:478:25  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1425 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:480:25  in ArrayList$Field.mergeSortRange\0A\00", align 1
@.faila.1426 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1427 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1428 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$Field.mergeSortRange\0A\00", align 1
@.faila.1429 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1430 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1431 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$Field.mergeSortRange\0A\00", align 1
@.faila.1432 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1433 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1434 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:484:42  in ArrayList$Field.mergeSortRange\0A\00", align 1
@.faila.1435 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1436 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.1437 = private unnamed_addr constant [138 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1438 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1441 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.contract.1444 = private unnamed_addr constant [138 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1445 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1448 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1451 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1454 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$Field.mergeSortRange\0A\00", align 1
@.faila.1455 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1456 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1457 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$Field.mergeSortRange\0A\00", align 1
@.faila.1458 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1459 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1460 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1463 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1466 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1469 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$Field.mergeSortRange\0A\00", align 1
@.faila.1470 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1471 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1472 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1475 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$Field.mergeSortRange\0A\00", align 1
...
@.fail.1478 = private unnamed_addr constant [100 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$Field.mergeSortRange\0A\00", align 1
@.faila.1479 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1480 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.1481 = private unnamed_addr constant [138 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$Field.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1482 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:21  in ArrayList$Field.find\0A\00", align 1
...
@.fail.1485 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:47  in ArrayList$Field.find\0A\00", align 1
...
@.fail.1488 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:520:17  in ArrayList$Field.min\0A\00", align 1
...
@.fail.1491 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:21  in ArrayList$Field.min\0A\00", align 1
@.faila.1492 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1493 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1494 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:65  in ArrayList$Field.min\0A\00", align 1
...
@.fail.1497 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:528:17  in ArrayList$Field.max\0A\00", align 1
@.faila.1498 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1499 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1500 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:21  in ArrayList$Field.max\0A\00", align 1
@.faila.1501 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1502 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1503 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:65  in ArrayList$Field.max\0A\00", align 1
@.faila.1504 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1505 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.strdata.1516 = private constant [17 x i8] c"arithmetic error\00"
@.strobj.1517 = private global %String { i64 16, ptr @.strdata.1516, i64 0 }
@.strdata.1518 = private constant [17 x i8] c"division by zero\00"
...
define internal void @Point.Point(ptr %0) {
entry:
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.Point, ptr %0, i32 0, i32 0
  store ptr @Point.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %x = getelementptr inbounds %class.Point, ptr %0, i32 0, i32 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %Point.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Point, ptr null, i64 1) to i64))
  call void @Point.Point(ptr %Point.obj)
  store ptr %Point.obj, ptr %p, align 8
  store ptr @type.Point, ptr %t, align 8
...
l.done:                                           ; preds = %l.hdr
  ...
  %33 = getelementptr inbounds %__box, ptr %box, i32 0, i32 0
  store ptr @Object.vtable, ptr %33, align 8
  %34 = getelementptr inbounds %__box, ptr %box, i32 0, i32 1
  store i64 99, ptr %34, align 8
  %35 = getelementptr inbounds %ReflectField, ptr %f6, i32 0, i32 2
  %f.set = load ptr, ptr %35, align 8
  call void %f.set(ptr %p7, ptr %box)
  %f8 = load ptr, ptr %f, align 8
  %p9 = load ptr, ptr %p, align 8
  %36 = getelementptr inbounds %ReflectField, ptr %f8, i32 0, i32 1
  %f.get10 = load ptr, ptr %36, align 8
  %37 = call ptr %f.get10(ptr %p9)
  %38 = getelementptr inbounds %__box, ptr %37, i32 0, i32 1
  %unbox11 = load i64, ptr %38, align 8
  %39 = trunc i64 %unbox11 to i32
  store i32 %39, ptr %after, align 4
  %before12 = load i32, ptr %before, align 4
  %after13 = load i32, ptr %after, align 4
  %p14 = load ptr, ptr %p, align 8
  %x = getelementptr inbounds %class.Point, ptr %p14, i32 0, i32 1
  %x15 = load i32, ptr %x, align 4, !tbaa !4
  %40 = call i32 (ptr, ...) @printf(ptr @.str, i32 %before12, i32 %after13, i32 %x15)
  %p16 = load ptr, ptr %p, align 8
  call void @__polaron_check_live(ptr %p16)
  %vtbl.addr = getelementptr inbounds %class.Point, ptr %p16, i32 0, i32 0
  ...
  %41 = icmp ne ptr %dtor.fn, null
  br i1 %41, label %dtor.call, label %dtor.free

dtor.call:                                        ; preds = %l.done
  call void %dtor.fn(ptr %p16)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %l.done
  call void @__polaron_free(ptr %p16)
  ret i32 0
}
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.1298, ptr @.cl.1299, i64 %contract.l, ptr @.cr.1300, i64 0, i32 1)
  unreachable
...
contract.fail11:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1301, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1302, ptr @.faila.1303, i64 %19, ptr @.failb.1304, i64 %arr.len, i32 70)
  unreachable
...
idx.bad27:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1305, ptr @.faila.1306, i64 %22, ptr @.failb.1307, i64 %arr.len25, i32 70)
  unreachable
...
idx.bad41:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1308, ptr @.faila.1309, i64 %16, ptr @.failb.1310, i64 %arr.len39, i32 70)
  unreachable
...
contract.fail55:                                  ; preds = %contract.cont
  ...
  call void @__polaron_fail(ptr @.contract.1312, ptr @.cl.1313, i64 %contract.l, ptr @.cr.1314, i64 0, i32 1)
  unreachable
...
contract.fail65:                                  ; preds = %contract.cont56
  call void @__polaron_fail(ptr @.contract.1315, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1316, ptr @.faila.1317, i64 %18, ptr @.failb.1318, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1319, ptr @.faila.1320, i64 %21, ptr @.failb.1321, i64 %arr.len20, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1326, ptr @.faila.1327, i64 %13, ptr @.failb.1328, i64 %arr.len, i32 70)
  unreachable
...
idx.bad20:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1329, ptr @.faila.1330, i64 %14, ptr @.failb.1331, i64 %arr.len18, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1332, ptr @.faila.1333, i64 %14, ptr @.failb.1334, i64 %arr.len, i32 70)
  unreachable
...
idx.bad26:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1336, ptr @.faila.1337, i64 %15, ptr @.failb.1338, i64 %arr.len24, i32 70)
  unreachable
...
contract.fail37:                                  ; preds = %idx.ok27
  call void @__polaron_fail(ptr @.contract.1339, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1340, ptr @.faila.1341, i64 %9, ptr @.failb.1342, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1343, ptr @.faila.1344, i64 %13, ptr @.failb.1345, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.1346, ptr @.cl.1347, i64 %contract.l, ptr @.cr.1348, i64 0, i32 1)
  unreachable
...
idx.bad36:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1350, ptr @.faila.1351, i64 %22, ptr @.failb.1352, i64 %arr.len34, i32 70)
  unreachable
...
idx.bad45:                                        ; preds = %idx.ok37
  call void @__polaron_fail(ptr @.fail.1353, ptr @.faila.1354, i64 %29, ptr @.failb.1355, i64 %arr.len43, i32 70)
  unreachable
...
contract.fail56:                                  ; preds = %for.end
  ...
  call void @__polaron_fail(ptr @.contract.1356, ptr @.cl.1357, i64 %contract.l60, ptr @.cr.1358, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1360, ptr @.faila.1361, i64 %14, ptr @.failb.1362, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.1363, ptr @.cl.1364, i64 %contract.l, ptr @.cr.1365, i64 0, i32 1)
  unreachable
...
idx.bad46:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1367, ptr @.faila.1368, i64 %31, ptr @.failb.1369, i64 %arr.len44, i32 70)
  unreachable
...
idx.bad55:                                        ; preds = %idx.ok47
  call void @__polaron_fail(ptr @.fail.1370, ptr @.faila.1371, i64 %34, ptr @.failb.1372, i64 %arr.len53, i32 70)
  unreachable
...
idx.bad76:                                        ; preds = %for.body66
  call void @__polaron_fail(ptr @.fail.1373, ptr @.faila.1374, i64 %37, ptr @.failb.1375, i64 %arr.len74, i32 70)
  unreachable
...
idx.bad85:                                        ; preds = %idx.ok77
  call void @__polaron_fail(ptr @.fail.1376, ptr @.faila.1377, i64 %42, ptr @.failb.1378, i64 %arr.len83, i32 70)
  unreachable
...
idx.bad95:                                        ; preds = %for.end68
  call void @__polaron_fail(ptr @.fail.1379, ptr @.faila.1380, i64 %40, ptr @.failb.1381, i64 %arr.len93, i32 70)
  unreachable
...
contract.fail106:                                 ; preds = %idx.ok96
  ...
  call void @__polaron_fail(ptr @.contract.1382, ptr @.cl.1383, i64 %contract.l110, ptr @.cr.1384, i64 0, i32 1)
  unreachable
...
contract.fail117:                                 ; preds = %contract.cont107
  call void @__polaron_fail(ptr @.contract.1385, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.1386, ptr @.cl.1387, i64 %contract.l, ptr @.cr.1388, i64 0, i32 1)
  unreachable
...
contract.fail17:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1389, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1390, ptr @.faila.1391, i64 %12, ptr @.failb.1392, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1393, ptr @.faila.1394, i64 %15, ptr @.failb.1395, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1396, ptr @.faila.1397, i64 %10, ptr @.failb.1398, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1399, ptr @.faila.1400, i64 %10, ptr @.failb.1401, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1402, ptr @.faila.1403, i64 %15, ptr @.failb.1404, i64 %arr.len20, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1405, ptr @.faila.1406, i64 %10, ptr @.failb.1407, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1408, ptr @.faila.1409, i64 %10, ptr @.failb.1410, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1411, ptr @.faila.1412, i64 %10, ptr @.failb.1413, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1414, ptr @.faila.1415, i64 %9, ptr @.failb.1416, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %if.end
  ...
  call void @__polaron_fail(ptr @.contract.1417, ptr @.cl.1418, i64 %contract.l, ptr @.cr.1419, i64 0, i32 1)
  unreachable
...
contract.fail35:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1420, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1422, ptr @.faila.1423, i64 %25, ptr @.failb.1424, i64 %arr.len, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %sc.rhs
  call void @__polaron_fail(ptr @.fail.1425, ptr @.faila.1426, i64 %38, ptr @.failb.1427, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad43:                                        ; preds = %while.body
  call void @__polaron_fail(ptr @.fail.1428, ptr @.faila.1429, i64 %34, ptr @.failb.1430, i64 %arr.len41, i32 70)
  unreachable
...
idx.bad52:                                        ; preds = %idx.ok44
  call void @__polaron_fail(ptr @.fail.1431, ptr @.faila.1432, i64 %43, ptr @.failb.1433, i64 %arr.len50, i32 70)
  unreachable
...
idx.bad63:                                        ; preds = %while.end
  call void @__polaron_fail(ptr @.fail.1434, ptr @.faila.1435, i64 %36, ptr @.failb.1436, i64 %arr.len61, i32 70)
  unreachable
...
contract.fail75:                                  ; preds = %for.end
  call void @__polaron_fail(ptr @.contract.1437, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad95:                                        ; preds = %div.ok
  call void @__polaron_fail(ptr @.fail.1438, ptr @.faila.1439, i64 %48, ptr @.failb.1440, i64 %arr.len93, i32 70)
  unreachable
...
idx.bad105:                                       ; preds = %idx.ok96
  call void @__polaron_fail(ptr @.fail.1441, ptr @.faila.1442, i64 %50, ptr @.failb.1443, i64 %arr.len103, i32 70)
  unreachable
...
idx.bad143:                                       ; preds = %while.body124
  call void @__polaron_fail(ptr @.fail.1445, ptr @.faila.1446, i64 %61, ptr @.failb.1447, i64 %arr.len141, i32 70)
  unreachable
...
idx.bad153:                                       ; preds = %idx.ok144
  call void @__polaron_fail(ptr @.fail.1448, ptr @.faila.1449, i64 %65, ptr @.failb.1450, i64 %arr.len151, i32 70)
  unreachable
...
idx.bad164:                                       ; preds = %if.then158
  call void @__polaron_fail(ptr @.fail.1451, ptr @.faila.1452, i64 %69, ptr @.failb.1453, i64 %arr.len162, i32 70)
  unreachable
...
idx.bad173:                                       ; preds = %idx.ok165
  call void @__polaron_fail(ptr @.fail.1454, ptr @.faila.1455, i64 %72, ptr @.failb.1456, i64 %arr.len171, i32 70)
  unreachable
...
idx.bad183:                                       ; preds = %if.else
  call void @__polaron_fail(ptr @.fail.1457, ptr @.faila.1458, i64 %70, ptr @.failb.1459, i64 %arr.len181, i32 70)
  unreachable
...
idx.bad192:                                       ; preds = %idx.ok184
  call void @__polaron_fail(ptr @.fail.1460, ptr @.faila.1461, i64 %74, ptr @.failb.1462, i64 %arr.len190, i32 70)
  unreachable
...
idx.bad208:                                       ; preds = %while.body200
  call void @__polaron_fail(ptr @.fail.1463, ptr @.faila.1464, i64 %78, ptr @.failb.1465, i64 %arr.len206, i32 70)
  unreachable
...
idx.bad217:                                       ; preds = %idx.ok209
  call void @__polaron_fail(ptr @.fail.1466, ptr @.faila.1467, i64 %79, ptr @.failb.1468, i64 %arr.len215, i32 70)
  unreachable
...
idx.bad233:                                       ; preds = %while.body225
  call void @__polaron_fail(ptr @.fail.1469, ptr @.faila.1470, i64 %84, ptr @.failb.1471, i64 %arr.len231, i32 70)
  unreachable
...
idx.bad242:                                       ; preds = %idx.ok234
  call void @__polaron_fail(ptr @.fail.1472, ptr @.faila.1473, i64 %85, ptr @.failb.1474, i64 %arr.len240, i32 70)
  unreachable
...
idx.bad261:                                       ; preds = %for.body251
  call void @__polaron_fail(ptr @.fail.1475, ptr @.faila.1476, i64 %90, ptr @.failb.1477, i64 %arr.len259, i32 70)
  unreachable
...
idx.bad269:                                       ; preds = %idx.ok262
  call void @__polaron_fail(ptr @.fail.1478, ptr @.faila.1479, i64 %95, ptr @.failb.1480, i64 %arr.len267, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1482, ptr @.faila.1483, i64 %10, ptr @.failb.1484, i64 %arr.len, i32 70)
  unreachable
...
idx.bad18:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1485, ptr @.faila.1486, i64 %15, ptr @.failb.1487, i64 %arr.len16, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1488, ptr @.faila.1489, i64 0, ptr @.failb.1490, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1491, ptr @.faila.1492, i64 %12, ptr @.failb.1493, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %if.then25
  call void @__polaron_fail(ptr @.fail.1494, ptr @.faila.1495, i64 %18, ptr @.failb.1496, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1497, ptr @.faila.1498, i64 0, ptr @.failb.1499, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1500, ptr @.faila.1501, i64 %12, ptr @.failb.1502, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %if.then25
  call void @__polaron_fail(ptr @.fail.1503, ptr @.faila.1504, i64 %18, ptr @.failb.1505, i64 %arr.len30, i32 70)
  unreachable
...
entry:
  %strcpy = call ptr @__polaron_str_copy(ptr @.strobj.1517)
  ret ptr %strcpy
}
...
entry:
  %strcpy = call ptr @__polaron_str_copy(ptr @.strobj.5518)
  %0 = load ptr, ptr @Test.criterion, align 8
  call void @__polaron_str_free(ptr %0)
  store ptr %strcpy, ptr @Test.criterion, align 8
  %strcpy1 = call ptr @__polaron_str_copy(ptr @.strobj.5520)
...
define private ptr @__fget.Point.x(ptr %0) {
entry:
  %f.addr = getelementptr inbounds %class.Point, ptr %0, i32 0, i32 1
...
define private void @__fset.Point.x(ptr %0, ptr %1) {
entry:
  %f.addr = getelementptr inbounds %class.Point, ptr %0, i32 0, i32 1
