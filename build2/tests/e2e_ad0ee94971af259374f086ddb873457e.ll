; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/null_cast_checked.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/null_cast_checked.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%class.Dog = type { ptr, i32 }
%class.NullReferenceException = type { ptr }
...
@.str.1 = private unnamed_addr constant [12 x i8] c"caught: %s\0A\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"narrowed: %d\0A\00", align 1
@.strdata.1304 = private constant [32 x i8] c"null where a value was asserted\00"
@.strobj.1305 = private global %String { i64 31, ptr @.strdata.1304, i64 0 }
...
entry:
  ...
  store i32 3, ptr %age, align 4, !tbaa !4
  ret void
}
...
entry:
  ...
  %age = getelementptr inbounds %class.Dog, ptr %d1, i32 0, i32 1
  %age2 = load i32, ptr %age, align 4, !tbaa !4
  ret i32 %age2
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  store ptr null, ptr %absent, align 8
  %absent1 = load ptr, ptr %absent, align 8
  %cast.isnull = icmp eq ptr %absent1, null
  br i1 %cast.isnull, label %cast.wasnull, label %cast.ok, !prof !6

ehpad:                                            ; preds = %cast.ok, %cast.wasnull
...
try.cont:                                         ; preds = %catch.body, %invoke.cont
  ...
  store ptr %Dog.obj, ptr %real, align 8
  %real5 = load ptr, ptr %real, align 8
  store ptr %real5, ptr %present, align 8
  %present6 = load ptr, ptr %present, align 8
  %17 = icmp eq ptr %present6, null
  %18 = zext i1 %17 to i32
  br i1 %17, label %if.then, label %if.end

cast.wasnull:                                     ; preds = %argv.end
  %exc = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.NullReferenceException, ptr null, i64 1) to i64))
  call void @NullReferenceException.NullReferenceException(ptr %exc)
  store ptr %exc, ptr %exc.thrown, align 8
  invoke void @_CxxThrowException(ptr %exc.thrown, ptr @_TI1PEAX)
          to label %throw.cont unwind label %ehpad

cast.ok:                                          ; preds = %argv.end
  %19 = invoke i32 @Main.takes(ptr %absent1)
          to label %invoke.cont unwind label %ehpad

throw.cont:                                       ; preds = %cast.wasnull
  unreachable

invoke.cont:                                      ; preds = %cast.ok
  store i32 %19, ptr %n, align 4
  %n2 = load i32, ptr %n, align 4
  %20 = call i32 (ptr, ...) @printf(ptr @.str, i32 %n2)
  br label %try.cont

catch.dispatch:                                   ; preds = %ehpad
  %21 = catchpad within %16 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught]
  ...
  catchret from %21 to label %catch.body
  ...
  %22 = call ptr @NullReferenceException.message(ptr %e3)
  %str.data = getelementptr inbounds %String, ptr %22, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %23 = call i32 (ptr, ...) @printf(ptr @.str.1, ptr %data)
...
if.end:                                           ; preds = %try.cont
  %present7 = load ptr, ptr %present, align 8
  %24 = call i32 @Main.takes(ptr %present7)
...
define internal void @NullReferenceException.NullReferenceException(ptr %0) {
entry:
  call void @Exception.Exception(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.NullReferenceException, ptr %0, i32 0, i32 0
  store ptr @NullReferenceException.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  ret void
}
