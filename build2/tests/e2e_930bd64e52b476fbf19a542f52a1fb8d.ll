; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/linked_list.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/linked_list.pol"
...
entry:
  ...
  %Node.obj2 = alloca %class.Node, align 8
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Node.Node(ptr %Node.obj1, i32 2)
  store ptr %Node.obj1, ptr %b, align 8
  call void @Node.Node(ptr %Node.obj2, i32 3)
  store ptr %Node.obj2, ptr %c, align 8
  %a3 = load ptr, ptr %a, align 8
  %next = getelementptr inbounds %class.Node, ptr %a3, i32 0, i32 2
  %b4 = load ptr, ptr %b, align 8
  store ptr %b4, ptr %next, align 8, !tbaa !0
  %b5 = load ptr, ptr %b, align 8
  %next6 = getelementptr inbounds %class.Node, ptr %b5, i32 0, i32 2
  %c7 = load ptr, ptr %c, align 8
  store ptr %c7, ptr %next6, align 8, !tbaa !0
  %a8 = load ptr, ptr %a, align 8
  %val = getelementptr inbounds %class.Node, ptr %a8, i32 0, i32 1
  %val9 = load i32, ptr %val, align 4, !tbaa !4
  %a10 = load ptr, ptr %a, align 8
  %next11 = getelementptr inbounds %class.Node, ptr %a10, i32 0, i32 2
  %next12 = load ptr, ptr %next11, align 8, !tbaa !0
  %val13 = getelementptr inbounds %class.Node, ptr %next12, i32 0, i32 1
  %val14 = load i32, ptr %val13, align 4, !tbaa !4
  %16 = add i32 %val9, %val14
  %a15 = load ptr, ptr %a, align 8
  %next16 = getelementptr inbounds %class.Node, ptr %a15, i32 0, i32 2
  %next17 = load ptr, ptr %next16, align 8, !tbaa !0
  %next18 = getelementptr inbounds %class.Node, ptr %next17, i32 0, i32 2
  %next19 = load ptr, ptr %next18, align 8, !tbaa !0
  %val20 = getelementptr inbounds %class.Node, ptr %next19, i32 0, i32 1
