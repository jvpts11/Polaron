; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/foreach.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/foreach.pol"
...
@.fail = private unnamed_addr constant [126 x i8] c"Polaron panic: array index out of bounds\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/foreach.pol:10:29  in main\0A\00", align 1
@.faila = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1 = private unnamed_addr constant [126 x i8] c"Polaron panic: array index out of bounds\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/foreach.pol:14:17  in main\0A\00", align 1
...
fe.end:                                           ; preds = %fe.cond
  ...
  %27 = call i32 (ptr, ...) @printf(ptr @.str, i32 %sum17)
  %nums18 = load ptr, ptr %nums, align 8
  call void @__polaron_free(ptr %nums18)
  ret i32 0
...
idx.ok12:                                         ; preds = %fe.body
  ...
  %28 = add i32 %sum15, %x16
  store i32 %28, ptr %sum, align 4
  br label %fe.update
}
