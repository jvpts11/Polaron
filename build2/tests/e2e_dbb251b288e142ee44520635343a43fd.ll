; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/checked_overflow.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/checked_overflow.pol"
...
@.strdata.1308 = private constant [17 x i8] c"integer overflow\00"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %18 = call { i32, i1 } @llvm.smul.with.overflow.i32(i32 %a2, i32 %a3)
  %ovf.res = extractvalue { i32, i1 } %18, 0
  %ovf.bit = extractvalue { i32, i1 } %18, 1
  br i1 %ovf.bit, label %ovf.bad, label %ovf.ok, !prof !0
...
ovf.ok:                                           ; preds = %argv.end
  ...
  %sum = add i32 %ovf.res, %a4
  %19 = xor i32 %a4, %sum
  %20 = xor i32 %ovf.res, %sum
  %21 = and i32 %20, %19
  %22 = icmp slt i32 %21, 0
  br i1 %22, label %ovf.bad5, label %ovf.ok6, !prof !0

ovf.bad5:                                         ; preds = %ovf.ok
  %exc7 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.OverflowException, ptr null, i64 1) to i64))
  call void @OverflowException.OverflowException(ptr %exc7)
  store ptr %exc7, ptr %exc.thrown8, align 8
  call void @_CxxThrowException(ptr %exc.thrown8, ptr @_TI1PEAX)
  unreachable

ovf.ok6:                                          ; preds = %ovf.ok
  store i32 %sum, ptr %s, align 4
  %s9 = load i32, ptr %s, align 4
  %23 = call i32 (ptr, ...) @printf(ptr @.str, i32 %s9)
  ret i32 0
}
