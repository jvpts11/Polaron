; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_void.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_void.pol"
...
@.str = private unnamed_addr constant [7 x i8] c"hi=%d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  store ptr @__polaron_closure, ptr %greet, align 8
  %greet1 = load ptr, ptr %greet, align 8
  %code = load ptr, ptr %greet1, align 8
  %16 = getelementptr ptr, ptr %greet1, i32 1
...
entry:
  %1 = call i32 (ptr, ...) @printf(ptr @.str, i32 7)
  ret void
}
