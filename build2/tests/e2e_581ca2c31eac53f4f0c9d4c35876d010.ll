; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/string_format.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/string_format.pol"
...
@.strdata = private constant [4 x i8] c"Ann\00"
@.strobj = private global %String { i64 3, ptr @.strdata, i64 0 }
@.strdata.1 = private constant [3 x i8] c"42\00"
@.strobj.2 = private global %String { i64 2, ptr @.strdata.1, i64 0 }
@.str = private unnamed_addr constant [8 x i8] c"fmt=%s\0A\00", align 1
@.strdata.3 = private constant [19 x i8] c"{} is {} years old\00"
@.strobj.4 = private global %String { i64 18, ptr @.strdata.3, i64 0 }
@.str.5 = private unnamed_addr constant [24 x i8] c"count=%d rev=%s cap=%s\0A\00", align 1
@.strdata.6 = private constant [8 x i8] c"abababa\00"
@.strobj.7 = private global %String { i64 7, ptr @.strdata.6, i64 0 }
@.strdata.8 = private constant [4 x i8] c"aba\00"
@.strobj.9 = private global %String { i64 3, ptr @.strdata.8, i64 0 }
@.strdata.10 = private constant [6 x i8] c"hello\00"
@.strobj.11 = private global %String { i64 5, ptr @.strdata.10, i64 0 }
@.strdata.12 = private constant [6 x i8] c"world\00"
...
@.contract.1101 = private unnamed_addr constant [124 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.ArrayList$String\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1102 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1103 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1104 = private unnamed_addr constant [141 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.ArrayList$String\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
...
@.fail.1108 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:320:35  in ArrayList$String.add\0A\00", align 1
...
@.fail.1111 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:325:39  in ArrayList$String.add\0A\00", align 1
...
@.contract.1114 = private unnamed_addr constant [124 x i8] c"contract violated: ensures\0A  --> <prelude>:315:36  in ArrayList$String.add\0A   |  ensures this.count == old(this.count) + 1\0A\00", align 1
@.contract.1115 = private unnamed_addr constant [111 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.add\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1116 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1117 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1118 = private unnamed_addr constant [128 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.add\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
...
@.fail.1122 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:334:78  in ArrayList$String.ensureCapacity\0A\00", align 1
...
@.contract.1125 = private unnamed_addr constant [122 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.ensureCapacity\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1128 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.ensureCapacity\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1129 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:345:21  in ArrayList$String.get\0A\00", align 1
...
@.fail.1132 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:347:17  in ArrayList$String.get\0A\00", align 1
...
@.fail.1135 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:351:51  in ArrayList$String.set\0A\00", align 1
...
@.contract.1138 = private unnamed_addr constant [128 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1139 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:354:30  in ArrayList$String.set\0A\00", align 1
@.faila.1140 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1141 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.1142 = private unnamed_addr constant [128 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1143 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:358:21  in ArrayList$String.indexOf\0A\00", align 1
...
@.fail.1146 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:369:21  in ArrayList$String.removeAt\0A\00", align 1
...
@.contract.1149 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.removeAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1150 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1151 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1152 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.removeAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
...
@.fail.1156 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:373:34  in ArrayList$String.removeAt\0A\00", align 1
...
@.contract.1159 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.removeAt\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1162 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.removeAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1163 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:379:51  in ArrayList$String.insertAt\0A\00", align 1
...
@.contract.1166 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1167 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1168 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1169 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
...
@.fail.1173 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:384:78  in ArrayList$String.insertAt\0A\00", align 1
...
@.fail.1179 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:389:34  in ArrayList$String.insertAt\0A\00", align 1
...
@.fail.1182 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:391:30  in ArrayList$String.insertAt\0A\00", align 1
...
@.contract.1185 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1186 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1187 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1188 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.1189 = private unnamed_addr constant [113 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.clear\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1190 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1191 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1192 = private unnamed_addr constant [130 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.clear\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
...
@.fail.1196 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:405:71  in ArrayList$String.toArray\0A\00", align 1
...
@.fail.1199 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:416:70  in ArrayList$String.forEach\0A\00", align 1
...
@.fail.1202 = private unnamed_addr constant [93 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:21  in ArrayList$String.filter\0A\00", align 1
...
@.fail.1205 = private unnamed_addr constant [93 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:54  in ArrayList$String.filter\0A\00", align 1
...
@.fail.1208 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:439:21  in ArrayList$String.any\0A\00", align 1
...
@.fail.1211 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:445:21  in ArrayList$String.all\0A\00", align 1
...
@.fail.1214 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:452:21  in ArrayList$String.count\0A\00", align 1
...
@.fail.1217 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:462:71  in ArrayList$String.sortedBy\0A\00", align 1
...
@.contract.1220 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.sortedBy\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1221 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1222 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1223 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.sortedBy\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.1224 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1225 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:478:25  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1228 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:480:25  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1234 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1237 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:484:42  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.contract.1240 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
...
@.fail.1244 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.contract.1247 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
...
@.fail.1251 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1257 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1263 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1269 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1275 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1281 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.contract.1284 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1285 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:21  in ArrayList$String.find\0A\00", align 1
...
@.fail.1288 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:47  in ArrayList$String.find\0A\00", align 1
...
@.fail.1291 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:520:17  in ArrayList$String.min\0A\00", align 1
...
@.fail.1294 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:21  in ArrayList$String.min\0A\00", align 1
...
@.fail.1297 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:65  in ArrayList$String.min\0A\00", align 1
...
@.fail.1300 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:528:17  in ArrayList$String.max\0A\00", align 1
...
@.fail.1303 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:21  in ArrayList$String.max\0A\00", align 1
...
@.fail.1306 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:65  in ArrayList$String.max\0A\00", align 1
...
entry:
  ...
  %"ArrayList$String.obj" = alloca %"class.ArrayList$String", align 8
...
argv.end:                                         ; preds = %argv.cond
  ...
  store ptr %"ArrayList$String.obj", ptr %fields, align 8
  %fields1 = load ptr, ptr %fields, align 8
  call void @"ArrayList$String.add"(ptr %fields1, ptr @.strobj)
  %fields2 = load ptr, ptr %fields, align 8
  call void @"ArrayList$String.add"(ptr %fields2, ptr @.strobj.2)
  %fields3 = load ptr, ptr %fields, align 8
  %16 = call ptr @Strings.format(ptr @.strobj.4, ptr %fields3)
  ...
  %18 = call i32 @Strings.count(ptr @.strobj.7, ptr @.strobj.9)
  %19 = call ptr @Strings.reverse(ptr @.strobj.11)
  %str.data4 = getelementptr inbounds %String, ptr %19, i32 0, i32 1
  %data5 = load ptr, ptr %str.data4, align 8
  %20 = call ptr @Strings.capitalize(ptr @.strobj.13)
  %str.data6 = getelementptr inbounds %String, ptr %20, i32 0, i32 1
  %data7 = load ptr, ptr %str.data6, align 8
  %21 = call i32 (ptr, ...) @printf(ptr @.str.5, i32 %18, ptr %data5, ptr %data7)
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.1101, ptr @.cl.1102, i64 %contract.l, ptr @.cr.1103, i64 0, i32 1)
  unreachable
...
contract.fail11:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1104, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1105, ptr @.faila.1106, i64 %19, ptr @.failb.1107, i64 %arr.len, i32 70)
  unreachable
...
idx.bad27:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1108, ptr @.faila.1109, i64 %22, ptr @.failb.1110, i64 %arr.len25, i32 70)
  unreachable
...
idx.bad42:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1111, ptr @.faila.1112, i64 %16, ptr @.failb.1113, i64 %arr.len40, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok43
  call void @__polaron_fail(ptr @.contract.1114, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
contract.fail57:                                  ; preds = %contract.cont
  ...
  call void @__polaron_fail(ptr @.contract.1115, ptr @.cl.1116, i64 %contract.l, ptr @.cr.1117, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1119, ptr @.faila.1120, i64 %18, ptr @.failb.1121, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1122, ptr @.faila.1123, i64 %21, ptr @.failb.1124, i64 %arr.len20, i32 70)
  unreachable
...
contract.fail41:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1128, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1129, ptr @.faila.1130, i64 %13, ptr @.failb.1131, i64 %arr.len, i32 70)
  unreachable
...
idx.bad20:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1132, ptr @.faila.1133, i64 %14, ptr @.failb.1134, i64 %arr.len18, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1135, ptr @.faila.1136, i64 %14, ptr @.failb.1137, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  call void @__polaron_fail(ptr @.contract.1138, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad26:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1139, ptr @.faila.1140, i64 %15, ptr @.failb.1141, i64 %arr.len24, i32 70)
  unreachable
...
contract.fail38:                                  ; preds = %idx.ok27
  call void @__polaron_fail(ptr @.contract.1142, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1143, ptr @.faila.1144, i64 %9, ptr @.failb.1145, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1146, ptr @.faila.1147, i64 %13, ptr @.failb.1148, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.1149, ptr @.cl.1150, i64 %contract.l, ptr @.cr.1151, i64 0, i32 1)
  unreachable
...
contract.fail25:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1152, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad36:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1153, ptr @.faila.1154, i64 %23, ptr @.failb.1155, i64 %arr.len34, i32 70)
  unreachable
...
idx.bad45:                                        ; preds = %idx.ok37
  call void @__polaron_fail(ptr @.fail.1156, ptr @.faila.1157, i64 %30, ptr @.failb.1158, i64 %arr.len43, i32 70)
  unreachable
...
contract.fail57:                                  ; preds = %for.end
  ...
  call void @__polaron_fail(ptr @.contract.1159, ptr @.cl.1160, i64 %contract.l61, ptr @.cr.1161, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1163, ptr @.faila.1164, i64 %14, ptr @.failb.1165, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.1166, ptr @.cl.1167, i64 %contract.l, ptr @.cr.1168, i64 0, i32 1)
  unreachable
...
contract.fail26:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1169, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad46:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1170, ptr @.faila.1171, i64 %32, ptr @.failb.1172, i64 %arr.len44, i32 70)
  unreachable
...
idx.bad55:                                        ; preds = %idx.ok47
  call void @__polaron_fail(ptr @.fail.1173, ptr @.faila.1174, i64 %35, ptr @.failb.1175, i64 %arr.len53, i32 70)
  unreachable
...
idx.bad78:                                        ; preds = %for.body68
  call void @__polaron_fail(ptr @.fail.1176, ptr @.faila.1177, i64 %42, ptr @.failb.1178, i64 %arr.len76, i32 70)
  unreachable
...
idx.bad87:                                        ; preds = %idx.ok79
  call void @__polaron_fail(ptr @.fail.1179, ptr @.faila.1180, i64 %47, ptr @.failb.1181, i64 %arr.len85, i32 70)
  unreachable
...
idx.bad98:                                        ; preds = %for.end70
  call void @__polaron_fail(ptr @.fail.1182, ptr @.faila.1183, i64 %45, ptr @.failb.1184, i64 %arr.len96, i32 70)
  unreachable
...
contract.fail110:                                 ; preds = %idx.ok99
  ...
  call void @__polaron_fail(ptr @.contract.1185, ptr @.cl.1186, i64 %contract.l114, ptr @.cr.1187, i64 0, i32 1)
  unreachable
...
contract.fail121:                                 ; preds = %contract.cont111
  call void @__polaron_fail(ptr @.contract.1188, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.1189, ptr @.cl.1190, i64 %contract.l, ptr @.cr.1191, i64 0, i32 1)
  unreachable
...
contract.fail17:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1192, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1193, ptr @.faila.1194, i64 %12, ptr @.failb.1195, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1196, ptr @.faila.1197, i64 %15, ptr @.failb.1198, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1205, ptr @.faila.1206, i64 %15, ptr @.failb.1207, i64 %arr.len20, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1214, ptr @.faila.1215, i64 %10, ptr @.failb.1216, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1217, ptr @.faila.1218, i64 %9, ptr @.failb.1219, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %if.end
  ...
  call void @__polaron_fail(ptr @.contract.1220, ptr @.cl.1221, i64 %contract.l, ptr @.cr.1222, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1225, ptr @.faila.1226, i64 %25, ptr @.failb.1227, i64 %arr.len, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %sc.rhs
  call void @__polaron_fail(ptr @.fail.1228, ptr @.faila.1229, i64 %38, ptr @.failb.1230, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad43:                                        ; preds = %while.body
  call void @__polaron_fail(ptr @.fail.1231, ptr @.faila.1232, i64 %34, ptr @.failb.1233, i64 %arr.len41, i32 70)
  unreachable
...
idx.bad52:                                        ; preds = %idx.ok44
  call void @__polaron_fail(ptr @.fail.1234, ptr @.faila.1235, i64 %43, ptr @.failb.1236, i64 %arr.len50, i32 70)
  unreachable
...
idx.bad64:                                        ; preds = %while.end
  call void @__polaron_fail(ptr @.fail.1237, ptr @.faila.1238, i64 %36, ptr @.failb.1239, i64 %arr.len62, i32 70)
  unreachable
...
contract.fail77:                                  ; preds = %for.end
  call void @__polaron_fail(ptr @.contract.1240, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad97:                                        ; preds = %div.ok
  call void @__polaron_fail(ptr @.fail.1241, ptr @.faila.1242, i64 %51, ptr @.failb.1243, i64 %arr.len95, i32 70)
  unreachable
...
idx.bad107:                                       ; preds = %idx.ok98
  call void @__polaron_fail(ptr @.fail.1244, ptr @.faila.1245, i64 %53, ptr @.failb.1246, i64 %arr.len105, i32 70)
  unreachable
...
contract.fail120:                                 ; preds = %if.then112
  call void @__polaron_fail(ptr @.contract.1247, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad145:                                       ; preds = %while.body126
  call void @__polaron_fail(ptr @.fail.1248, ptr @.faila.1249, i64 %64, ptr @.failb.1250, i64 %arr.len143, i32 70)
  unreachable
...
idx.bad155:                                       ; preds = %idx.ok146
  call void @__polaron_fail(ptr @.fail.1251, ptr @.faila.1252, i64 %68, ptr @.failb.1253, i64 %arr.len153, i32 70)
  unreachable
...
idx.bad166:                                       ; preds = %if.then160
  call void @__polaron_fail(ptr @.fail.1254, ptr @.faila.1255, i64 %72, ptr @.failb.1256, i64 %arr.len164, i32 70)
  unreachable
...
idx.bad175:                                       ; preds = %idx.ok167
  call void @__polaron_fail(ptr @.fail.1257, ptr @.faila.1258, i64 %75, ptr @.failb.1259, i64 %arr.len173, i32 70)
  unreachable
...
idx.bad186:                                       ; preds = %if.else
  call void @__polaron_fail(ptr @.fail.1260, ptr @.faila.1261, i64 %73, ptr @.failb.1262, i64 %arr.len184, i32 70)
  unreachable
...
idx.bad195:                                       ; preds = %idx.ok187
  call void @__polaron_fail(ptr @.fail.1263, ptr @.faila.1264, i64 %78, ptr @.failb.1265, i64 %arr.len193, i32 70)
  unreachable
...
idx.bad212:                                       ; preds = %while.body204
  call void @__polaron_fail(ptr @.fail.1266, ptr @.faila.1267, i64 %83, ptr @.failb.1268, i64 %arr.len210, i32 70)
  unreachable
...
idx.bad221:                                       ; preds = %idx.ok213
  call void @__polaron_fail(ptr @.fail.1269, ptr @.faila.1270, i64 %84, ptr @.failb.1271, i64 %arr.len219, i32 70)
  unreachable
...
idx.bad238:                                       ; preds = %while.body230
  call void @__polaron_fail(ptr @.fail.1272, ptr @.faila.1273, i64 %90, ptr @.failb.1274, i64 %arr.len236, i32 70)
  unreachable
...
idx.bad247:                                       ; preds = %idx.ok239
  call void @__polaron_fail(ptr @.fail.1275, ptr @.faila.1276, i64 %91, ptr @.failb.1277, i64 %arr.len245, i32 70)
  unreachable
...
idx.bad267:                                       ; preds = %for.body257
  call void @__polaron_fail(ptr @.fail.1278, ptr @.faila.1279, i64 %97, ptr @.failb.1280, i64 %arr.len265, i32 70)
  unreachable
...
idx.bad275:                                       ; preds = %idx.ok268
  call void @__polaron_fail(ptr @.fail.1281, ptr @.faila.1282, i64 %102, ptr @.failb.1283, i64 %arr.len273, i32 70)
  unreachable
...
contract.fail288:                                 ; preds = %for.end259
  call void @__polaron_fail(ptr @.contract.1284, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1285, ptr @.faila.1286, i64 %10, ptr @.failb.1287, i64 %arr.len, i32 70)
  unreachable
...
idx.bad18:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1288, ptr @.faila.1289, i64 %15, ptr @.failb.1290, i64 %arr.len16, i32 70)
  unreachable
...
define internal ptr @Strings.format(ptr %0, ptr %1) {
entry:
  ...
  %8 = getelementptr inbounds %"class.ArrayList$String", ptr %"ArrayList$String.copy", i32 0, i32 1
  store ptr %arr.copy, ptr %8, align 8, !tbaa !0
  store ptr %"ArrayList$String.copy", ptr %args, align 8
  %template1 = load ptr, ptr %template, align 8
  %str.len = getelementptr inbounds %String, ptr %template1, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
...
while.end:                                        ; preds = %while.cond
  ...
  %15 = call ptr @StringBuilder.toString(ptr %sb36)
  %strcpy = call ptr @__polaron_str_copy(ptr %15)
  call void @__polaron_str_free(ptr %15)
  ret ptr %strcpy

sc.rhs:                                           ; preds = %while.body
  %template6 = load ptr, ptr %template, align 8
  %i7 = load i32, ptr %i, align 4
  %16 = sext i32 %i7 to i64
  %str.data = getelementptr inbounds %String, ptr %template6, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
...
sc.end:                                           ; preds = %sc.rhs, %while.body
  ...
  %sc.a8 = icmp ne i32 %20, 0
  br i1 %sc.a8, label %sc.rhs9, label %sc.end10

sc.rhs9:                                          ; preds = %sc.end
  %template11 = load ptr, ptr %template, align 8
  %i12 = load i32, ptr %i, align 4
  %21 = add i32 %i12, 1
  %22 = sext i32 %21 to i64
  %str.data13 = getelementptr inbounds %String, ptr %template11, i32 0, i32 1
  %data14 = load ptr, ptr %str.data13, align 8
  %ch.addr15 = getelementptr i8, ptr %data14, i64 %22
  %ch16 = load i8, ptr %ch.addr15, align 1
  %23 = zext i8 %ch16 to i32
  %24 = icmp eq i32 %23, 125
  %25 = zext i1 %24 to i32
  %sc.b17 = icmp ne i32 %25, 0
  br label %sc.end10

sc.end10:                                         ; preds = %sc.rhs9, %sc.end
  %sc18 = phi i1 [ false, %sc.end ], [ %sc.b17, %sc.rhs9 ]
  %26 = zext i1 %sc18 to i32
  br i1 %sc18, label %if.then, label %if.else

if.then:                                          ; preds = %sc.end10
  %next19 = load i32, ptr %next, align 4
  %args20 = load ptr, ptr %args, align 8
  %27 = call i32 @"ArrayList$String.size"(ptr %args20)
  %28 = icmp slt i32 %next19, %27
  %29 = zext i1 %28 to i32
  br i1 %28, label %if.then21, label %if.end22

if.else:                                          ; preds = %sc.end10
  %sb28 = load ptr, ptr %sb, align 8
  %template29 = load ptr, ptr %template, align 8
  %i30 = load i32, ptr %i, align 4
  %30 = sext i32 %i30 to i64
  %str.data31 = getelementptr inbounds %String, ptr %template29, i32 0, i32 1
  %data32 = load ptr, ptr %str.data31, align 8
  %ch.addr33 = getelementptr i8, ptr %data32, i64 %30
  %ch34 = load i8, ptr %ch.addr33, align 1
  %31 = zext i8 %ch34 to i32
  %32 = call ptr @StringBuilder.appendChar(ptr %sb28, i32 %31)
...
if.then21:                                        ; preds = %if.then
  ...
  %34 = call ptr @"ArrayList$String.get"(ptr %args24, i32 %next25)
  %35 = call ptr @StringBuilder.append(ptr %sb23, ptr %34)
  call void @__polaron_str_free(ptr %34)
  %next26 = load i32, ptr %next, align 4
  %36 = add i32 %next26, 1
  store i32 %36, ptr %next, align 4
  br label %if.end22

if.end22:                                         ; preds = %if.then21, %if.then
  %i27 = load i32, ptr %i, align 4
  %37 = add i32 %i27, 2
...
define internal i32 @Strings.count(ptr %0, ptr %1) {
entry:
  %j = alloca i32, align 4
  ...
  %sub1 = load ptr, ptr %sub, align 8
  %str.len = getelementptr inbounds %String, ptr %sub1, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %2 = trunc i64 %len to i32
...
if.end:                                           ; preds = %entry
  ...
  %str.len4 = getelementptr inbounds %String, ptr %text3, i32 0, i32 0
...
for.body:                                         ; preds = %for.cond
  ...
  %11 = add i32 %i12, %j13
  %12 = sext i32 %11 to i64
  %str.data = getelementptr inbounds %String, ptr %text11, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %ch.addr = getelementptr i8, ptr %data, i64 %12
  %ch = load i8, ptr %ch.addr, align 1
  %13 = zext i8 %ch to i32
  %sub14 = load ptr, ptr %sub, align 8
  %j15 = load i32, ptr %j, align 4
  %14 = sext i32 %j15 to i64
  %str.data16 = getelementptr inbounds %String, ptr %sub14, i32 0, i32 1
  %data17 = load ptr, ptr %str.data16, align 8
  %ch.addr18 = getelementptr i8, ptr %data17, i64 %14
  %ch19 = load i8, ptr %ch.addr18, align 1
  %15 = zext i8 %ch19 to i32
  %16 = icmp ne i32 %13, %15
  %17 = zext i1 %16 to i32
  br i1 %16, label %if.then20, label %if.end21

for.update:                                       ; preds = %if.end21
...
for.end:                                          ; preds = %for.cond
  %hit22 = load i32, ptr %hit, align 4
  %20 = icmp ne i32 %hit22, 0
  br i1 %20, label %if.then23, label %if.else
...
if.then23:                                        ; preds = %for.end
  %hits25 = load i32, ptr %hits, align 4
  %21 = add i32 %hits25, 1
  store i32 %21, ptr %hits, align 4
  %i26 = load i32, ptr %i, align 4
  %m27 = load i32, ptr %m, align 4
  %22 = add i32 %i26, %m27
...
define internal ptr @Strings.reverse(ptr %0) {
entry:
  %i = alloca i32, align 4
  %sb = alloca ptr, align 8
  %text = alloca ptr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %str.data = getelementptr inbounds %String, ptr %text4, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %ch.addr = getelementptr i8, ptr %data, i64 %5
  %ch = load i8, ptr %ch.addr, align 1
  %6 = zext i8 %ch to i32
  %7 = call ptr @StringBuilder.appendChar(ptr %sb3, i32 %6)
  br label %for.update
...
for.end:                                          ; preds = %for.cond
  ...
  %10 = call ptr @StringBuilder.toString(ptr %sb6)
  %strcpy = call ptr @__polaron_str_copy(ptr %10)
  call void @__polaron_str_free(ptr %10)
  ret ptr %strcpy
}

define internal ptr @Strings.capitalize(ptr %0) {
entry:
  %text = alloca ptr, align 8
  store ptr %0, ptr %text, align 8
  %text1 = load ptr, ptr %text, align 8
...
if.end:                                           ; preds = %entry
  %text3 = load ptr, ptr %text, align 8
  %sub.buf = call ptr @__polaron_malloc(i64 2)
  %str.data = getelementptr inbounds %String, ptr %text3, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %4 = getelementptr i8, ptr %data, i64 0
  %5 = call ptr @memcpy(ptr %sub.buf, ptr %4, i64 1)
  %6 = getelementptr i8, ptr %sub.buf, i64 1
  store i8 0, ptr %6, align 1
  %newstr = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %7 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 0
  store i64 1, ptr %7, align 8
  %8 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 1
  store ptr %sub.buf, ptr %8, align 8
  %9 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 2
  store i64 0, ptr %9, align 8
  %str.len4 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 0
  %len5 = load i64, ptr %str.len4, align 8
  %str.data6 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 1
  %data7 = load ptr, ptr %str.data6, align 8
  %10 = call ptr @__polaron_str_upper(ptr %data7, i64 %len5)
  %newstr8 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %11 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 0
  store i64 %len5, ptr %11, align 8
  %12 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 1
  store ptr %10, ptr %12, align 8
  %13 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 2
  store i64 0, ptr %13, align 8
  %text9 = load ptr, ptr %text, align 8
  %text10 = load ptr, ptr %text, align 8
  %str.len11 = getelementptr inbounds %String, ptr %text10, i32 0, i32 0
  %len12 = load i64, ptr %str.len11, align 8
  %14 = trunc i64 %len12 to i32
  %15 = sext i32 %14 to i64
  %16 = sub i64 %15, 1
  %17 = add i64 %16, 1
  %sub.buf13 = call ptr @__polaron_malloc(i64 %17)
  %str.data14 = getelementptr inbounds %String, ptr %text9, i32 0, i32 1
  %data15 = load ptr, ptr %str.data14, align 8
  %18 = getelementptr i8, ptr %data15, i64 1
  %19 = call ptr @memcpy(ptr %sub.buf13, ptr %18, i64 %16)
  %20 = getelementptr i8, ptr %sub.buf13, i64 %16
  store i8 0, ptr %20, align 1
  %newstr16 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %21 = getelementptr inbounds %String, ptr %newstr16, i32 0, i32 0
  store i64 %16, ptr %21, align 8
  %22 = getelementptr inbounds %String, ptr %newstr16, i32 0, i32 1
  store ptr %sub.buf13, ptr %22, align 8
  %23 = getelementptr inbounds %String, ptr %newstr16, i32 0, i32 2
  store i64 0, ptr %23, align 8
  %str.len17 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 0
  ...
  %24 = add i64 %len18, %len20
  %25 = add i64 %24, 1
  %cat.buf = call ptr @__polaron_malloc(i64 %25)
  %str.data21 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 1
  %data22 = load ptr, ptr %str.data21, align 8
  %26 = call ptr @memcpy(ptr %cat.buf, ptr %data22, i64 %len18)
  %str.data23 = getelementptr inbounds %String, ptr %newstr16, i32 0, i32 1
  %data24 = load ptr, ptr %str.data23, align 8
  %27 = getelementptr i8, ptr %cat.buf, i64 %len18
  %28 = call ptr @memcpy(ptr %27, ptr %data24, i64 %len20)
  %29 = getelementptr i8, ptr %cat.buf, i64 %24
  store i8 0, ptr %29, align 1
  %newstr25 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %30 = getelementptr inbounds %String, ptr %newstr25, i32 0, i32 0
  store i64 %24, ptr %30, align 8
  %31 = getelementptr inbounds %String, ptr %newstr25, i32 0, i32 1
  store ptr %cat.buf, ptr %31, align 8
  %32 = getelementptr inbounds %String, ptr %newstr25, i32 0, i32 2
  store i64 0, ptr %32, align 8
  %strcpy26 = call ptr @__polaron_str_copy(ptr %newstr25)
  call void @__polaron_str_free(ptr %newstr)
