; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/stringbuilder_stdlib.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/stringbuilder_stdlib.pol"
...
@.strdata = private constant [7 x i8] c"count=\00"
@.strobj = private global %String { i64 6, ptr @.strdata, i64 0 }
@.strdata.1 = private constant [7 x i8] c", neg=\00"
@.strobj.2 = private global %String { i64 6, ptr @.strdata.1, i64 0 }
@.str = private unnamed_addr constant [29 x i8] c"len=%d eq=%d c0=%c clast=%c\0A\00", align 1
@.strdata.3 = private constant [18 x i8] c"count=42, neg=-7!\00"
@.strobj.4 = private global %String { i64 17, ptr @.strdata.3, i64 0 }
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @StringBuilder.append(ptr %sb1, ptr @.strobj)
  %17 = call ptr @StringBuilder.appendInt(ptr %16, i32 42)
  %18 = call ptr @StringBuilder.append(ptr %17, ptr @.strobj.2)
  %19 = call ptr @StringBuilder.appendInt(ptr %18, i32 -7)
  %20 = call ptr @StringBuilder.appendChar(ptr %19, i32 33)
  %sb2 = load ptr, ptr %sb, align 8
  %21 = call ptr @StringBuilder.toString(ptr %sb2)
  ...
  %str.len = getelementptr inbounds %String, ptr %r3, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %22 = trunc i64 %len to i32
  %r4 = load ptr, ptr %r, align 8
  %str.data = getelementptr inbounds %String, ptr %r4, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %data5 = load ptr, ptr getelementptr inbounds (%String, ptr @.strobj.4, i32 0, i32 1), align 8
  %23 = call i32 @strcmp(ptr %data, ptr %data5)
  %24 = icmp eq i32 %23, 0
  %25 = zext i1 %24 to i32
  %r6 = load ptr, ptr %r, align 8
  %str.data7 = getelementptr inbounds %String, ptr %r6, i32 0, i32 1
  %data8 = load ptr, ptr %str.data7, align 8
  %ch.addr = getelementptr i8, ptr %data8, i64 0
  %ch = load i8, ptr %ch.addr, align 1
  %26 = zext i8 %ch to i32
  %r9 = load ptr, ptr %r, align 8
  %r10 = load ptr, ptr %r, align 8
  %str.len11 = getelementptr inbounds %String, ptr %r10, i32 0, i32 0
  %len12 = load i64, ptr %str.len11, align 8
  %27 = trunc i64 %len12 to i32
  %28 = sub i32 %27, 1
  %29 = sext i32 %28 to i64
  %str.data13 = getelementptr inbounds %String, ptr %r9, i32 0, i32 1
  %data14 = load ptr, ptr %str.data13, align 8
  %ch.addr15 = getelementptr i8, ptr %data14, i64 %29
  %ch16 = load i8, ptr %ch.addr15, align 1
  %30 = zext i8 %ch16 to i32
  %31 = call i32 (ptr, ...) @printf(ptr @.str, i32 %22, i32 %25, i32 %26, i32 %30)
