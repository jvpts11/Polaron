; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/arraylist_bounds_ok.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/arraylist_bounds_ok.pol"
...
@.str = private unnamed_addr constant [33 x i8] c"size=%d first=%d last=%d sum=%d\0A\00", align 1
...
for.body:                                         ; preds = %for.cond
  ...
  %18 = mul i32 %i3, %i4
  call void @"ArrayList$int.add"(ptr %xs2, i32 %18)
  br label %for.update
...
for.end:                                          ; preds = %for.cond
  ...
  call void @"ArrayList$int.set"(ptr %xs5, i32 0, i32 100)
  %xs6 = load ptr, ptr %xs, align 8
  call void @"ArrayList$int.set"(ptr %xs6, i32 9, i32 900)
  store i32 0, ptr %sum, align 4
  store i32 0, ptr %j, align 4
  br label %for.cond7

for.cond7:                                        ; preds = %for.update9, %for.end
  %j11 = load i32, ptr %j, align 4
  %xs12 = load ptr, ptr %xs, align 8
  %21 = call i32 @"ArrayList$int.size"(ptr %xs12)
  %22 = icmp slt i32 %j11, %21
  %23 = zext i1 %22 to i32
  br i1 %22, label %for.body8, label %for.end10

for.body8:                                        ; preds = %for.cond7
  %sum13 = load i32, ptr %sum, align 4
  %xs14 = load ptr, ptr %xs, align 8
  %j15 = load i32, ptr %j, align 4
  %24 = call i32 @"ArrayList$int.get"(ptr %xs14, i32 %j15)
  %25 = add i32 %sum13, %24
...
for.end10:                                        ; preds = %for.cond7
  ...
  %28 = call i32 @"ArrayList$int.size"(ptr %xs16)
  %xs17 = load ptr, ptr %xs, align 8
  %29 = call i32 @"ArrayList$int.get"(ptr %xs17, i32 0)
  %xs18 = load ptr, ptr %xs, align 8
  %30 = call i32 @"ArrayList$int.get"(ptr %xs18, i32 9)
  %sum19 = load i32, ptr %sum, align 4
  %31 = call i32 (ptr, ...) @printf(ptr @.str, i32 %28, i32 %29, i32 %30, i32 %sum19)
  ret i32 0
}
