; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/exceptions_finally.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/exceptions_finally.pol"
...
@.str.1 = private unnamed_addr constant [9 x i8] c"body ok\0A\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.3 = private unnamed_addr constant [8 x i8] c"caught\0A\00", align 1
@.str.4 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.5 = private unnamed_addr constant [9 x i8] c"finally\0A\00", align 1
@.str.6 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.7 = private unnamed_addr constant [9 x i8] c"finally\0A\00", align 1
...
define internal void @Main.run(i32 %0) personality ptr @__CxxFrameHandler3 {
entry:
  ...
  %fail1 = load i32, ptr %fail, align 4
  %1 = icmp ne i32 %fail1, 0
  br i1 %1, label %if.then, label %if.end

ehpad:                                            ; preds = %invoke.cont, %if.then
...
if.end:                                           ; preds = %entry
  %4 = call i32 (ptr, ...) @printf(ptr @.str, ptr @.str.1)
  br label %try.cont
...
throw.cont:                                       ; preds = %invoke.cont
  ...
  %5 = catchpad within %2 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught]
  ...
  catchret from %5 to label %catch.body

catch.next:                                       ; preds = %catch.dispatch
  catchret from %5 to label %rethrow
