; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/slice_oob_bad.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/slice_oob_bad.pol"
...
@.fail = private unnamed_addr constant [132 x i8] c"Polaron panic: array index out of bounds\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/slice_oob_bad.pol:15:26  in main\0A\00", align 1
@.faila = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1 = private unnamed_addr constant [83 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:642:21  in Slice$int.get\0A\00", align 1
...
@.fail.4 = private unnamed_addr constant [83 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:644:17  in Slice$int.get\0A\00", align 1
...
@.fail.7 = private unnamed_addr constant [83 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:648:57  in Slice$int.set\0A\00", align 1
...
@.fail.10 = private unnamed_addr constant [83 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:651:46  in Slice$int.set\0A\00", align 1
...
@.fail.13 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:658:69  in Slice$int.toArray\0A\00", align 1
...
@.fail.16 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:658:69  in Slice$int.toArray\0A\00", align 1
...
for.end:                                          ; preds = %for.cond
  ...
  call void @"Slice$int.Slice$int"(ptr %"Slice$int.obj", ptr %a7, i32 2, i32 3)
  store ptr %"Slice$int.obj", ptr %s, align 8
  %s8 = load ptr, ptr %s, align 8
  %22 = call i32 @"Slice$int.get"(ptr %s8, i32 3)
  ret i32 %22
...
idx.bad14:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.4, ptr @.faila.5, i64 %10, ptr @.failb.6, i64 %arr.len12, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.7, ptr @.faila.8, i64 %9, ptr @.failb.9, i64 %arr.len, i32 70)
  unreachable
...
idx.bad15:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.10, ptr @.faila.11, i64 %11, ptr @.failb.12, i64 %arr.len13, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.13, ptr @.faila.14, i64 %7, ptr @.failb.15, i64 %arr.len, i32 70)
  unreachable
...
idx.bad13:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.16, ptr @.faila.17, i64 %11, ptr @.failb.18, i64 %arr.len11, i32 70)
  unreachable
