; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/persist_this.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/persist_this.pol"
...
@Main.tick.c.__pblock = private global %persistblock.Car zeroinitializer
...
define internal void @Car.bump(ptr nonnull align 8 dereferenceable(24) %0) {
entry:
  %__persist = getelementptr inbounds %class.Car, ptr %0, i32 0, i32 2
  %pblock = load ptr, ptr %__persist, align 8, !tbaa !0
  %chassi = getelementptr inbounds %persistblock.Car, ptr %pblock, i32 0, i32 0
  %__persist1 = getelementptr inbounds %class.Car, ptr %0, i32 0, i32 2
  %pblock2 = load ptr, ptr %__persist1, align 8, !tbaa !0
  %chassi3 = getelementptr inbounds %persistblock.Car, ptr %pblock2, i32 0, i32 0
  %chassi4 = load i32, ptr %chassi3, align 4
  %1 = add i32 %chassi4, 1
  store i32 %1, ptr %chassi, align 4
  ret void
}

define internal i32 @Car.get(ptr nonnull align 8 dereferenceable(24) %0) {
entry:
  %__persist = getelementptr inbounds %class.Car, ptr %0, i32 0, i32 2
  %pblock = load ptr, ptr %__persist, align 8, !tbaa !0
  %chassi = getelementptr inbounds %persistblock.Car, ptr %pblock, i32 0, i32 0
  %chassi1 = load i32, ptr %chassi, align 4
  ret i32 %chassi1
}

define internal i32 @Main.tick() {
entry:
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 @Main.tick()
  %17 = call i32 @Main.tick()
  %18 = call i32 @Main.tick()
