; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/validators.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/validators.pol"
...
@.str = private unnamed_addr constant [43 x i8] c"luhnOk=%d luhnBad=%d isbnOk=%d isbnBad=%d\0A\00", align 1
@.strdata = private constant [12 x i8] c"79927398713\00"
@.strobj = private global %String { i64 11, ptr @.strdata, i64 0 }
@.strdata.1 = private constant [12 x i8] c"79927398710\00"
@.strobj.2 = private global %String { i64 11, ptr @.strdata.1, i64 0 }
@.strdata.3 = private constant [14 x i8] c"9780306406157\00"
@.strobj.4 = private global %String { i64 13, ptr @.strdata.3, i64 0 }
@.strdata.5 = private constant [14 x i8] c"9780306406158\00"
@.strobj.6 = private global %String { i64 13, ptr @.strdata.5, i64 0 }
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 @Luhn.isValid(ptr @.strobj)
  %17 = call i32 @Luhn.isValid(ptr @.strobj.2)
  %18 = call i32 @Isbn.isValid13(ptr @.strobj.4)
  %19 = call i32 @Isbn.isValid13(ptr @.strobj.6)
...
define internal i32 @Luhn.isValid(ptr %0) personality ptr @__CxxFrameHandler3 {
entry:
...
for.end:                                          ; preds = %for.cond
  ...
  %10 = icmp eq i32 %sum20, -2147483648
  %11 = and i1 %10, false
  %12 = or i1 false, %11
...
if.end:                                           ; preds = %sc.end
  ...
  %dbl8 = load i32, ptr %dbl, align 4
  %17 = icmp ne i32 %dbl8, 0
  br i1 %17, label %if.then9, label %if.end10

if.then9:                                         ; preds = %if.end
  %d11 = load i32, ptr %d, align 4
  %18 = mul i32 %d11, 2
  store i32 %18, ptr %d, align 4
  %d12 = load i32, ptr %d, align 4
  %19 = icmp sgt i32 %d12, 9
  %20 = zext i1 %19 to i32
  br i1 %19, label %if.then13, label %if.end14

if.end10:                                         ; preds = %if.end14, %if.end
  %sum16 = load i32, ptr %sum, align 4
  %d17 = load i32, ptr %d, align 4
  %21 = add i32 %sum16, %d17
  store i32 %21, ptr %sum, align 4
  %dbl18 = load i32, ptr %dbl, align 4
  %22 = icmp eq i32 %dbl18, 0
  %23 = zext i1 %22 to i32
  store i32 %23, ptr %dbl, align 4
  br label %for.update
...
div.ok:                                           ; preds = %for.end
  %25 = srem i32 %sum20, 10
  %26 = icmp eq i32 %25, 0
  %27 = zext i1 %26 to i32
  ret i32 %27
}

define internal i32 @Isbn.isValid13(ptr %0) personality ptr @__CxxFrameHandler3 {
entry:
...
for.end:                                          ; preds = %for.cond
  ...
  %10 = icmp ne i32 %count16, 13
  %11 = zext i1 %10 to i32
  br i1 %10, label %if.then17, label %if.end18

sc.rhs:                                           ; preds = %for.body
  %c6 = load i32, ptr %c, align 4
  %12 = icmp sgt i32 %c6, 57
...
if.end:                                           ; preds = %sc.end
  ...
  %16 = icmp eq i32 %count8, -2147483648
  %17 = and i1 %16, false
  %18 = or i1 false, %17
...
if.end10:                                         ; preds = %if.else, %if.then9
  %count15 = load i32, ptr %count, align 4
  %25 = add i32 %count15, 1
...
if.end18:                                         ; preds = %for.end
  ...
  %26 = icmp eq i32 %sum19, -2147483648
  %27 = and i1 %26, false
  %28 = or i1 false, %27
  br i1 %28, label %div.bad20, label %div.ok21

div.bad20:                                        ; preds = %if.end18
...
div.ok21:                                         ; preds = %if.end18
  %29 = srem i32 %sum19, 10
  %30 = icmp eq i32 %29, 0
