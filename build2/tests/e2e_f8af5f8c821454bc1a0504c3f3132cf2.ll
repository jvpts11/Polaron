; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/catalog_values.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/catalog_values.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 (ptr, ...) @printf(ptr @.str, i32 0, i32 1, i32 2)
  %17 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 3, i32 4, i32 5)
  store i32 5, ptr %t, align 4
  %t1 = load i32, ptr %t, align 4
  %18 = call i32 (ptr, ...) @printf(ptr @.str.2, i32 %t1)
  %19 = call i32 (ptr, ...) @printf(ptr @.str.3, i32 6)
  ret i32 0
}
