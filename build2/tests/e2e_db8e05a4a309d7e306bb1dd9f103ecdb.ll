; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/path_utils.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/path_utils.pol"
...
@.str = private unnamed_addr constant [9 x i8] c"join=%s\0A\00", align 1
@.strdata = private constant [8 x i8] c"src/lib\00"
@.strobj = private global %String { i64 7, ptr @.strdata, i64 0 }
@.strdata.1 = private constant [9 x i8] c"file.pol\00"
@.strobj.2 = private global %String { i64 8, ptr @.strdata.1, i64 0 }
@.str.3 = private unnamed_addr constant [23 x i8] c"base=%s dir=%s ext=%s\0A\00", align 1
@.strdata.4 = private constant [17 x i8] c"src/lib/file.pol\00"
@.strobj.5 = private global %String { i64 16, ptr @.strdata.4, i64 0 }
@.strdata.6 = private constant [17 x i8] c"src/lib/file.pol\00"
@.strobj.7 = private global %String { i64 16, ptr @.strdata.6, i64 0 }
@.strdata.8 = private constant [17 x i8] c"src/lib/file.pol\00"
@.strobj.9 = private global %String { i64 16, ptr @.strdata.8, i64 0 }
@.str.10 = private unnamed_addr constant [12 x i8] c"noext=[%s]\0A\00", align 1
@.strdata.11 = private constant [7 x i8] c"README\00"
...
@.strdata.3867 = private constant [2 x i8] c"/\00"
@.strobj.3868 = private global %String { i64 1, ptr @.strdata.3867, i64 0 }
@.strdata.3869 = private constant [2 x i8] c"/\00"
@.strobj.3870 = private global %String { i64 1, ptr @.strdata.3869, i64 0 }
@.strdata.3871 = private constant [1 x i8] zeroinitializer
@.strobj.3872 = private global %String { i64 0, ptr @.strdata.3871, i64 0 }
@.strdata.3873 = private constant [2 x i8] c".\00"
@.strobj.3874 = private global %String { i64 1, ptr @.strdata.3873, i64 0 }
@.strdata.3875 = private constant [1 x i8] zeroinitializer
@.strobj.3876 = private global %String { i64 0, ptr @.strdata.3875, i64 0 }
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @Paths.join(ptr @.strobj, ptr @.strobj.2)
...
define internal ptr @Paths.join(ptr %0, ptr %1) {
entry:
  %name = alloca ptr, align 8
  %base = alloca ptr, align 8
  store ptr %0, ptr %base, align 8
  store ptr %1, ptr %name, align 8
  %base1 = load ptr, ptr %base, align 8
  %str.len = getelementptr inbounds %String, ptr %base1, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %2 = trunc i64 %len to i32
  %3 = icmp eq i32 %2, 0
  %4 = zext i1 %3 to i32
...
if.end:                                           ; preds = %entry
  ...
  %str.data = getelementptr inbounds %String, ptr %base3, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %str.len4 = getelementptr inbounds %String, ptr %base3, i32 0, i32 0
  %len5 = load i64, ptr %str.len4, align 8
  %data6 = load ptr, ptr getelementptr inbounds (%String, ptr @.strobj.3868, i32 0, i32 1), align 8
  %len7 = load i64, ptr @.strobj.3868, align 8
  %5 = call i32 @__polaron_str_ends(ptr %data, i64 %len5, ptr %data6, i64 %len7)
  %6 = icmp ne i32 %5, 0
...
if.then8:                                         ; preds = %if.end
  ...
  %str.len12 = getelementptr inbounds %String, ptr %base10, i32 0, i32 0
  %len13 = load i64, ptr %str.len12, align 8
  %str.len14 = getelementptr inbounds %String, ptr %name11, i32 0, i32 0
  %len15 = load i64, ptr %str.len14, align 8
  %7 = add i64 %len13, %len15
  %8 = add i64 %7, 1
  %cat.buf = call ptr @__polaron_malloc(i64 %8)
  %str.data16 = getelementptr inbounds %String, ptr %base10, i32 0, i32 1
  %data17 = load ptr, ptr %str.data16, align 8
  %9 = call ptr @memcpy(ptr %cat.buf, ptr %data17, i64 %len13)
  %str.data18 = getelementptr inbounds %String, ptr %name11, i32 0, i32 1
  %data19 = load ptr, ptr %str.data18, align 8
  %10 = getelementptr i8, ptr %cat.buf, i64 %len13
  %11 = call ptr @memcpy(ptr %10, ptr %data19, i64 %len15)
  ...
  %strcpy20 = call ptr @__polaron_str_copy(ptr %newstr)
  call void @__polaron_str_free(ptr %newstr)
  ret ptr %strcpy20

if.end9:                                          ; preds = %if.end
  %base21 = load ptr, ptr %base, align 8
  %str.len22 = getelementptr inbounds %String, ptr %base21, i32 0, i32 0
  %len23 = load i64, ptr %str.len22, align 8
  %len24 = load i64, ptr @.strobj.3870, align 8
  %16 = add i64 %len23, %len24
  %17 = add i64 %16, 1
  %cat.buf25 = call ptr @__polaron_malloc(i64 %17)
  %str.data26 = getelementptr inbounds %String, ptr %base21, i32 0, i32 1
  %data27 = load ptr, ptr %str.data26, align 8
  %18 = call ptr @memcpy(ptr %cat.buf25, ptr %data27, i64 %len23)
  %data28 = load ptr, ptr getelementptr inbounds (%String, ptr @.strobj.3870, i32 0, i32 1), align 8
  %19 = getelementptr i8, ptr %cat.buf25, i64 %len23
  %20 = call ptr @memcpy(ptr %19, ptr %data28, i64 %len24)
  %21 = getelementptr i8, ptr %cat.buf25, i64 %16
  store i8 0, ptr %21, align 1
  %newstr29 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %22 = getelementptr inbounds %String, ptr %newstr29, i32 0, i32 0
  store i64 %16, ptr %22, align 8
  %23 = getelementptr inbounds %String, ptr %newstr29, i32 0, i32 1
  store ptr %cat.buf25, ptr %23, align 8
  %24 = getelementptr inbounds %String, ptr %newstr29, i32 0, i32 2
  store i64 0, ptr %24, align 8
  %name30 = load ptr, ptr %name, align 8
  %str.len31 = getelementptr inbounds %String, ptr %newstr29, i32 0, i32 0
  %len32 = load i64, ptr %str.len31, align 8
  %str.len33 = getelementptr inbounds %String, ptr %name30, i32 0, i32 0
  %len34 = load i64, ptr %str.len33, align 8
  %25 = add i64 %len32, %len34
  %26 = add i64 %25, 1
  %cat.buf35 = call ptr @__polaron_malloc(i64 %26)
  %str.data36 = getelementptr inbounds %String, ptr %newstr29, i32 0, i32 1
  %data37 = load ptr, ptr %str.data36, align 8
  %27 = call ptr @memcpy(ptr %cat.buf35, ptr %data37, i64 %len32)
  %str.data38 = getelementptr inbounds %String, ptr %name30, i32 0, i32 1
  %data39 = load ptr, ptr %str.data38, align 8
  %28 = getelementptr i8, ptr %cat.buf35, i64 %len32
  %29 = call ptr @memcpy(ptr %28, ptr %data39, i64 %len34)
  %30 = getelementptr i8, ptr %cat.buf35, i64 %25
  store i8 0, ptr %30, align 1
  %newstr40 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %31 = getelementptr inbounds %String, ptr %newstr40, i32 0, i32 0
  store i64 %25, ptr %31, align 8
  %32 = getelementptr inbounds %String, ptr %newstr40, i32 0, i32 1
  store ptr %cat.buf35, ptr %32, align 8
  %33 = getelementptr inbounds %String, ptr %newstr40, i32 0, i32 2
  store i64 0, ptr %33, align 8
  %strcpy41 = call ptr @__polaron_str_copy(ptr %newstr40)
  call void @__polaron_str_free(ptr %newstr29)
  call void @__polaron_str_free(ptr %newstr40)
  ret ptr %strcpy41
}
...
tern.end:                                         ; preds = %tern.else, %tern.then
  %tern = phi ptr [ @.strobj.3872, %tern.then ], [ %newstr, %tern.else ]
...
define internal ptr @Paths.extension(ptr %0) {
entry:
  ...
  store ptr %0, ptr %path, align 8
  %path1 = load ptr, ptr %path, align 8
  %1 = call ptr @Paths.basename(ptr %path1)
  %strcpy = call ptr @__polaron_str_copy(ptr %1)
  store ptr %strcpy, ptr %base, align 8
  call void @__polaron_str_free(ptr %1)
  %base2 = load ptr, ptr %base, align 8
  %2 = call ptr @Strings.split(ptr %base2, ptr @.strobj.3874)
  store ptr %2, ptr %parts, align 8
  %parts3 = load ptr, ptr %parts, align 8
  %3 = call i32 @"ArrayList$String.size"(ptr %parts3)
  %4 = icmp slt i32 %3, 2
  %5 = zext i1 %4 to i32
  br i1 %4, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %strcpy4 = call ptr @__polaron_str_copy(ptr @.strobj.3876)
  %6 = load ptr, ptr %base, align 8
  call void @__polaron_str_free(ptr %6)
  ret ptr %strcpy4

if.end:                                           ; preds = %entry
  %parts5 = load ptr, ptr %parts, align 8
  %parts6 = load ptr, ptr %parts, align 8
  %7 = call i32 @"ArrayList$String.size"(ptr %parts6)
  %8 = sub i32 %7, 1
  %9 = call ptr @"ArrayList$String.get"(ptr %parts5, i32 %8)
  %strcpy7 = call ptr @__polaron_str_copy(ptr %9)
