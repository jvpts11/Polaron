; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/class_counter.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/class_counter.pol"
...
define internal void @Counter.increment(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %count = getelementptr inbounds %class.Counter, ptr %0, i32 0, i32 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Counter.increment(ptr %c1)
  %c2 = load ptr, ptr %c, align 8
  call void @Counter.increment(ptr %c2)
  %c3 = load ptr, ptr %c, align 8
  %16 = call i32 @Counter.get(ptr %c3)
