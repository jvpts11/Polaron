; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/unsigned.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/unsigned.pol"
...
@.str = private unnamed_addr constant [10 x i8] c"big = %u\0A\00", align 1
...
@.str.1 = private unnamed_addr constant [11 x i8] c"half = %u\0A\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"big > 1 = %d\0A\00", align 1
@.str.3 = private unnamed_addr constant [13 x i8] c"huge = %llu\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 (ptr, ...) @printf(ptr @.str, i32 %big1)
...
div.ok:                                           ; preds = %argv.end
  %17 = udiv i32 %big2, 2
  %18 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %17)
  %big3 = load i32, ptr %big, align 4
  %19 = icmp ugt i32 %big3, 1
  %20 = zext i1 %19 to i32
  %21 = call i32 (ptr, ...) @printf(ptr @.str.2, i32 %20)
  store i64 -446744073709551616, ptr %huge, align 8
  %huge4 = load i64, ptr %huge, align 8
  %22 = call i32 (ptr, ...) @printf(ptr @.str.3, i64 %huge4)
  ret i32 0
}
