; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/interface_field_delegation.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/interface_field_delegation.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%class.DoublingIterator = type { ptr, ptr }
...
define internal void @DoublingIterator.DoublingIterator(ptr %0, ptr %1) {
entry:
  %src = alloca ptr, align 8
  store ptr %1, ptr %src, align 8
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.DoublingIterator, ptr %0, i32 0, i32 0
  store ptr @DoublingIterator.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %src1 = getelementptr inbounds %class.DoublingIterator, ptr %0, i32 0, i32 1
  %src2 = load ptr, ptr %src, align 8
  store ptr %src2, ptr %src1, align 8, !tbaa !0
  ret void
}

define internal i32 @DoublingIterator.hasNext(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %src = getelementptr inbounds %class.DoublingIterator, ptr %0, i32 0, i32 1
  ...
  %slot = getelementptr [348 x ptr], ptr %vtbl, i64 0, i64 0
  %fn = load ptr, ptr %slot, align 8
  %1 = call i32 %fn(ptr %src1)
  ret i32 %1
}

define internal i32 @DoublingIterator.next(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %src = getelementptr inbounds %class.DoublingIterator, ptr %0, i32 0, i32 1
  %src1 = load ptr, ptr %src, align 8, !tbaa !0
  %vtbl.addr = getelementptr inbounds %"class.Iterator$int", ptr %src1, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %slot = getelementptr [348 x ptr], ptr %vtbl, i64 0, i64 1
  %fn = load ptr, ptr %slot, align 8
  %1 = call i32 %fn(ptr %src1)
  %2 = mul i32 %1, 2
  ret i32 %2
...
for.end:                                          ; preds = %for.cond
  %DoublingIterator.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.DoublingIterator, ptr null, i64 1) to i64))
  %nums4 = load ptr, ptr %nums, align 8
  %20 = call ptr @"ArrayList$int.iterator"(ptr %nums4)
  call void @DoublingIterator.DoublingIterator(ptr %DoublingIterator.obj, ptr %20)
  store ptr %DoublingIterator.obj, ptr %d, align 8
  store i32 0, ptr %sum, align 4
  br label %while.cond

while.cond:                                       ; preds = %while.body, %for.end
  %d5 = load ptr, ptr %d, align 8
  %21 = call i32 @DoublingIterator.hasNext(ptr %d5)
  %22 = icmp ne i32 %21, 0
...
while.body:                                       ; preds = %while.cond
  ...
  %23 = call i32 @DoublingIterator.next(ptr %d7)
  %24 = add i32 %sum6, %23
...
while.end:                                        ; preds = %while.cond
  ...
  %25 = call i32 (ptr, ...) @printf(ptr @.str, i32 %sum8)
  ret i32 0
}
