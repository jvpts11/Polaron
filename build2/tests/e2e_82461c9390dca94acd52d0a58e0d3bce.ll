; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/checked_unsigned_bad.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/checked_unsigned_bad.pol"
...
@.str = private unnamed_addr constant [17 x i8] c"unreachable: %u\0A\00", align 1
@.str.1 = private unnamed_addr constant [12 x i8] c"caught: %s\0A\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.3 = private unnamed_addr constant [10 x i8] c"survived\0A\00", align 1
...
@.strdata.1311 = private constant [17 x i8] c"integer overflow\00"
...
argv.end:                                         ; preds = %argv.cond
  ...
  store i32 3, ptr %small, align 4
  store i32 10, ptr %big, align 4
  %small1 = load i32, ptr %small, align 4
  %big2 = load i32, ptr %big, align 4
  %udif = sub i32 %small1, %big2
  %16 = icmp ult i32 %small1, %big2
  br i1 %16, label %ovf.bad, label %ovf.ok, !prof !0

ehpad:                                            ; preds = %ovf.bad
  %17 = catchswitch within none [label %catch.dispatch] unwind to caller

try.cont:                                         ; preds = %catch.body, %ovf.ok
  %18 = call i32 (ptr, ...) @printf(ptr @.str.2, ptr @.str.3)
  ret i32 0

ovf.bad:                                          ; preds = %argv.end
  %exc = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.OverflowException, ptr null, i64 1) to i64))
  call void @OverflowException.OverflowException(ptr %exc)
  store ptr %exc, ptr %exc.thrown, align 8
  invoke void @_CxxThrowException(ptr %exc.thrown, ptr @_TI1PEAX)
          to label %throw.cont unwind label %ehpad

ovf.ok:                                           ; preds = %argv.end
  store i32 %udif, ptr %wrapped, align 4
  %wrapped3 = load i32, ptr %wrapped, align 4
  %19 = call i32 (ptr, ...) @printf(ptr @.str, i32 %wrapped3)
  br label %try.cont

throw.cont:                                       ; preds = %ovf.bad
  unreachable

catch.dispatch:                                   ; preds = %ehpad
  %20 = catchpad within %17 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught]
  %caught = load ptr, ptr %exc.caught, align 8
  %exc.vtbl = load ptr, ptr %caught, align 8
  %is = icmp eq ptr %exc.vtbl, @OverflowException.vtable
  br i1 %is, label %catch.match, label %catch.next

catch.match:                                      ; preds = %catch.dispatch
  store ptr %caught, ptr %e, align 8
  catchret from %20 to label %catch.body

catch.next:                                       ; preds = %catch.dispatch
  catchret from %20 to label %rethrow

catch.body:                                       ; preds = %catch.match
  %e4 = load ptr, ptr %e, align 8
  %21 = call ptr @OverflowException.message(ptr %e4)
  %str.data = getelementptr inbounds %String, ptr %21, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %22 = call i32 (ptr, ...) @printf(ptr @.str.1, ptr %data)
