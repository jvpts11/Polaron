; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lazy_thread.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lazy_thread.pol"
...
@.str = private unnamed_addr constant [15 x i8] c"thread ran %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"before\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@.str.4 = private unnamed_addr constant [11 x i8] c"after decl\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  store i32 7, ptr %marker, align 4
  ...
  store i1 false, ptr %t.lazy, align 1
  %20 = call i32 (ptr, ...) @printf(ptr @.str.3, ptr @.str.4)
  %t.lazy.set = load i1, ptr %t.lazy, align 1
  br i1 %t.lazy.set, label %t.lazy.done, label %t.lazy.lock

t.lazy.lock:                                      ; preds = %argv.end
  call void @__polaron_lazy_lock()
  %t.lazy.set2 = load i1, ptr %t.lazy, align 1
  br i1 %t.lazy.set2, label %t.lazy.unlock, label %t.lazy.init

t.lazy.init:                                      ; preds = %t.lazy.lock
  ...
  store i1 true, ptr %t.lazy, align 1
  br label %t.lazy.unlock

t.lazy.unlock:                                    ; preds = %t.lazy.init, %t.lazy.lock
  call void @__polaron_lazy_unlock()
  br label %t.lazy.done

t.lazy.done:                                      ; preds = %t.lazy.unlock, %argv.end
  %t2 = load ptr, ptr %t, align 8
  call void @Thread.start(ptr %t2)
  %t.lazy.set7 = load i1, ptr %t.lazy, align 1
  br i1 %t.lazy.set7, label %t.lazy.done6, label %t.lazy.lock3

t.lazy.lock3:                                     ; preds = %t.lazy.done
  call void @__polaron_lazy_lock()
  %t.lazy.set28 = load i1, ptr %t.lazy, align 1
  br i1 %t.lazy.set28, label %t.lazy.unlock5, label %t.lazy.init4

t.lazy.init4:                                     ; preds = %t.lazy.lock3
  %Thread.obj9 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Thread, ptr null, i64 1) to i64))
  %work10 = load ptr, ptr %work, align 8
  call void @Thread.Thread(ptr %Thread.obj9, ptr %work10)
  store ptr %Thread.obj9, ptr %t, align 8
  store i1 true, ptr %t.lazy, align 1
  br label %t.lazy.unlock5

t.lazy.unlock5:                                   ; preds = %t.lazy.init4, %t.lazy.lock3
  call void @__polaron_lazy_unlock()
  br label %t.lazy.done6

t.lazy.done6:                                     ; preds = %t.lazy.unlock5, %t.lazy.done
  %t11 = load ptr, ptr %t, align 8
  call void @Thread.join(ptr %t11)
...
entry:
  ...
  %marker = load ptr, ptr %1, align 8
  %marker1 = load i32, ptr %marker, align 4
  %2 = call i32 (ptr, ...) @printf(ptr @.str, i32 %marker1)
  ret void
}
