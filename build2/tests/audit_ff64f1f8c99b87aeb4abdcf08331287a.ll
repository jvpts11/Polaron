...
define internal i32 @Node.bump(ptr nonnull align 4 dereferenceable(12) %0) {
entry:
  %seen = getelementptr inbounds %class.Node, ptr %0, i32 0, i32 2
...
entry:
  ...
  store i64 %5, ptr %argv.arr, align 4
  %arr.data = getelementptr i8, ptr %argv.arr, i64 8
  store i64 0, ptr %argv.i, align 4
  br label %argv.cond

argv.cond:                                        ; preds = %argv.body, %entry
  %argv.iv = load i64, ptr %argv.i, align 4
...
argv.body:                                        ; preds = %argv.cond
  ...
  %argv.s = load ptr, ptr %10, align 4
  %argv.rawlen = call i32 @strlen(ptr %argv.s)
  %argv.len = zext i32 %argv.rawlen to i64
  %newstr = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %11 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 0
  store i64 %argv.len, ptr %11, align 4
  %12 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 1
  store ptr %argv.s, ptr %12, align 4
  %13 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 2
  store i64 0, ptr %13, align 4
  %14 = getelementptr ptr, ptr %arr.data, i64 %argv.iv
  store ptr %newstr, ptr %14, align 4
  %15 = add i64 %argv.iv, 1
  store i64 %15, ptr %argv.i, align 4
  br label %argv.cond

argv.end:                                         ; preds = %argv.cond
  store ptr %argv.arr, ptr %args, align 4
  ...
  %len = load i64, ptr %str.len, align 4
  %len4 = load i64, ptr @.strobj.5, align 4
  %18 = add i64 %len, %len4
  %19 = add i64 %18, 1
  ...
  %20 = call ptr @memcpy(ptr %cat.buf, ptr %data, i32 %len5)
  ...
  %22 = call ptr @memcpy(ptr %21, ptr %data6, i32 %len7)
  ...
  %24 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 0
  store i64 %18, ptr %24, align 4
  %25 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 1
  store ptr %cat.buf, ptr %25, align 4
  %26 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 2
  store i64 0, ptr %26, align 4
  %strcpy9 = call ptr @__polaron_str_copy(ptr %newstr8)
  store ptr %strcpy9, ptr %t, align 4
  call void @__polaron_str_free(ptr %newstr8)
  %t10 = load ptr, ptr %t, align 4
  %str.data11 = getelementptr inbounds %String, ptr %t10, i32 0, i32 1
  %data12 = load ptr, ptr %str.data11, align 4
  %r13 = load i32, ptr %r, align 4
  %t14 = load ptr, ptr %t, align 4
  %str.len15 = getelementptr inbounds %String, ptr %t14, i32 0, i32 0
  %len16 = load i64, ptr %str.len15, align 4
  %27 = trunc i64 %len16 to i32
  %28 = call i32 (ptr, ...) @printf(ptr @.str, ptr %data12, i32 %r13, i32 %27)
  %n17 = load ptr, ptr %n, align 4
  call void @__polaron_check_live(ptr %n17)
  %vtbl.addr = getelementptr inbounds %class.Node, ptr %n17, i32 0, i32 0
...
define internal i32 @Object.equals(ptr nonnull align 4 dereferenceable(4) %0, ptr %1) {
entry:
...
define internal i32 @Object.hashCode(ptr nonnull align 4 dereferenceable(4) %0) {
entry:
  ret i32 0
}

define internal i32 @Object.equalsKey(ptr nonnull align 4 dereferenceable(4) %0, ptr %1) {
entry:
  %Object.copy = alloca %class.Object, align 8
  %other = alloca ptr, align 4
  %2 = call ptr @memcpy(ptr %Object.copy, ptr %1, i32 ptrtoint (ptr getelementptr (%class.Object, ptr null, i64 1) to i32))
