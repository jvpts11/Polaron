; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/sealed.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/sealed.pol"
...
@.str = private unnamed_addr constant [15 x i8] c"circle r = %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [18 x i8] c"square side = %d\0A\00", align 1
...
match.end:                                        ; preds = %match.next5, %match.case4, %match.case
  %s9 = load ptr, ptr %s, align 8
  call void @__polaron_check_live(ptr %s9)
  %vtbl.addr10 = getelementptr inbounds %class.Shape, ptr %s9, i32 0, i32 0
  %vtbl11 = load ptr, ptr %vtbl.addr10, align 8, !tbaa !0
  %dtor.slot = getelementptr [350 x ptr], ptr %vtbl11, i64 0, i64 349
...
match.case:                                       ; preds = %argv.end
  %17 = getelementptr inbounds %class.Circle, ptr %s1, i32 0, i32 1
  %r = load i32, ptr %17, align 4, !tbaa !4
  store i32 %r, ptr %r2, align 4
  %r3 = load i32, ptr %r2, align 4
  %18 = call i32 (ptr, ...) @printf(ptr @.str, i32 %r3)
  br label %match.end

match.next:                                       ; preds = %argv.end
  %is6 = icmp eq ptr %vtbl, @Square.vtable
  br i1 %is6, label %match.case4, label %match.next5

match.case4:                                      ; preds = %match.next
  %19 = getelementptr inbounds %class.Square, ptr %s1, i32 0, i32 1
  %side = load i32, ptr %19, align 4, !tbaa !4
  store i32 %side, ptr %side7, align 4
  %side8 = load i32, ptr %side7, align 4
  %20 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %side8)
  br label %match.end

match.next5:                                      ; preds = %match.next
  br label %match.end

dtor.call:                                        ; preds = %match.end
  call void %dtor.fn(ptr %s9)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %match.end
  call void @__polaron_free(ptr %s9)
  ret i32 0
}
