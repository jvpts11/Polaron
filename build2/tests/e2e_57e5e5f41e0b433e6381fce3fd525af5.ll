; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lazy_streams.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lazy_streams.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%"class.ArrayList$int" = type { ptr, ptr, i32 }
%"class.IteratorStream$int" = type { ptr, ptr }
%"class.Stream$int" = type { ptr }
%"class.FilterStream$int" = type { ptr, ptr, ptr, i32, i32 }
%"class.MapStream$int$int" = type { ptr, ptr, ptr }
...
@.fail.1093 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:429:71  in ArrayList$int.map$int\0A\00", align 1
...
for.body:                                         ; preds = %for.cond
  ...
  call void @"ArrayList$int.add"(ptr %nums2, i32 %i3)
  br label %for.update
...
for.end:                                          ; preds = %for.cond
  %"IteratorStream$int.obj" = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%"class.IteratorStream$int", ptr null, i64 1) to i64))
  %nums4 = load ptr, ptr %nums, align 8
  %20 = call ptr @"ArrayList$int.iterator"(ptr %nums4)
  call void @"IteratorStream$int.IteratorStream$int"(ptr %"IteratorStream$int.obj", ptr %20)
  store ptr %"IteratorStream$int.obj", ptr %base, align 8
  %base5 = load ptr, ptr %base, align 8
  %21 = call ptr @"Stream$int.filter#0=__polaron_lambda_0$fs"(ptr %base5, ptr @__polaron_closure)
  store ptr %21, ptr %evens, align 8
  %evens6 = load ptr, ptr %evens, align 8
  %vtbl.addr = getelementptr inbounds %"class.Stream$int", ptr %evens6, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %slot = getelementptr [350 x ptr], ptr %vtbl, i64 0, i64 5
  %fn = load ptr, ptr %slot, align 8
  %22 = call ptr %fn(ptr %evens6, ptr @__polaron_closure.1)
  store ptr %22, ptr %squares, align 8
  %squares7 = load ptr, ptr %squares, align 8
  %vtbl.addr8 = getelementptr inbounds %"class.Stream$int", ptr %squares7, i32 0, i32 0
  %vtbl9 = load ptr, ptr %vtbl.addr8, align 8, !tbaa !0
  %slot10 = getelementptr [350 x ptr], ptr %vtbl9, i64 0, i64 6
  %fn11 = load ptr, ptr %slot10, align 8
  %dv.is = icmp eq ptr %fn11, @"Stream$int.fold$int"
  br i1 %dv.is, label %dv.hit, label %dv.miss

dv.join:                                          ; preds = %dv.miss, %dv.hit
  %dv.r = phi i32 [ %24, %dv.hit ], [ %25, %dv.miss ]
  store i32 %dv.r, ptr %total, align 4
  %total12 = load i32, ptr %total, align 4
  %23 = call i32 (ptr, ...) @printf(ptr @.str, i32 %total12)
  ret i32 0

dv.hit:                                           ; preds = %for.end
  %24 = call i32 @"Stream$int.fold$int"(ptr %squares7, i32 0, ptr @__polaron_closure.2)
  br label %dv.join

dv.miss:                                          ; preds = %for.end
  %25 = call i32 %fn11(ptr %squares7, i32 0, ptr @__polaron_closure.2)
  br label %dv.join
}

define internal ptr @"Stream$int.filter"(ptr nonnull align 8 dereferenceable(8) %0, ptr %1) {
entry:
  %pred = alloca ptr, align 8
  store ptr %1, ptr %pred, align 8
  %"FilterStream$int.obj" = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%"class.FilterStream$int", ptr null, i64 1) to i64))
  %pred1 = load ptr, ptr %pred, align 8
  call void @"FilterStream$int.FilterStream$int"(ptr %"FilterStream$int.obj", ptr %0, ptr %pred1)
  ret ptr %"FilterStream$int.obj"
}

define internal void @"Stream$int.forEach"(ptr nonnull align 8 dereferenceable(8) %0, ptr %1) {
entry:
...
while.cond:                                       ; preds = %while.body, %entry
  %vtbl.addr = getelementptr inbounds %"class.Stream$int", ptr %0, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
...
while.body:                                       ; preds = %while.cond
  ...
  %4 = getelementptr ptr, ptr %action1, i32 1
  %env = load ptr, ptr %4, align 8
  %vtbl.addr2 = getelementptr inbounds %"class.Stream$int", ptr %0, i32 0, i32 0
  %vtbl3 = load ptr, ptr %vtbl.addr2, align 8, !tbaa !0
  %slot4 = getelementptr [350 x ptr], ptr %vtbl3, i64 0, i64 1
  %fn5 = load ptr, ptr %slot4, align 8
  %5 = call i32 %fn5(ptr %0)
  call void %code(ptr %env, i32 %5)
  br label %while.cond
...
define internal i32 @"Stream$int.count"(ptr nonnull align 8 dereferenceable(8) %0) {
entry:
...
while.body:                                       ; preds = %while.cond
  %vtbl.addr1 = getelementptr inbounds %"class.Stream$int", ptr %0, i32 0, i32 0
  %vtbl2 = load ptr, ptr %vtbl.addr1, align 8, !tbaa !0
  %slot3 = getelementptr [350 x ptr], ptr %vtbl2, i64 0, i64 1
  %fn4 = load ptr, ptr %slot3, align 8
  %3 = call i32 %fn4(ptr %0)
...
define internal ptr @"Stream$int.map$int"(ptr nonnull align 8 dereferenceable(8) %0, ptr %1) {
entry:
  %fn = alloca ptr, align 8
  store ptr %1, ptr %fn, align 8
  %"MapStream$int$int.obj" = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%"class.MapStream$int$int", ptr null, i64 1) to i64))
  %fn1 = load ptr, ptr %fn, align 8
  call void @"MapStream$int$int.MapStream$int$int"(ptr %"MapStream$int$int.obj", ptr %0, ptr %fn1)
  ret ptr %"MapStream$int$int.obj"
}

define internal i32 @"Stream$int.fold$int"(ptr nonnull align 8 dereferenceable(8) %0, i32 %1, ptr %2) {
entry:
  ...
  %init1 = load i32, ptr %init, align 4
  store i32 %init1, ptr %acc, align 4
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  %combine2 = load ptr, ptr %combine, align 8
  %code = load ptr, ptr %combine2, align 8
  %5 = getelementptr ptr, ptr %combine2, i32 1
  %env = load ptr, ptr %5, align 8
  %acc3 = load i32, ptr %acc, align 4
  %vtbl.addr4 = getelementptr inbounds %"class.Stream$int", ptr %0, i32 0, i32 0
  %vtbl5 = load ptr, ptr %vtbl.addr4, align 8, !tbaa !0
  %slot6 = getelementptr [350 x ptr], ptr %vtbl5, i64 0, i64 1
  %fn7 = load ptr, ptr %slot6, align 8
  %6 = call i32 %fn7(ptr %0)
  %7 = call i32 %code(ptr %env, i32 %acc3, i32 %6)
  store i32 %7, ptr %acc, align 4
  br label %while.cond
...
define internal void @"Stream$int.Stream$int"(ptr %0) {
entry:
  call void @Object.Object(ptr %0)
  ret void
}

define internal void @"MapStream$int$int.MapStream$int$int"(ptr %0, ptr %1, ptr %2) {
entry:
  %fn = alloca ptr, align 8
  %src = alloca ptr, align 8
  store ptr %1, ptr %src, align 8
  store ptr %2, ptr %fn, align 8
  call void @"Stream$int.Stream$int"(ptr %0)
  %vtbl.addr = getelementptr inbounds %"class.MapStream$int$int", ptr %0, i32 0, i32 0
  store ptr @"MapStream$int$int.vtable", ptr %vtbl.addr, align 8, !tbaa !0
  %src1 = getelementptr inbounds %"class.MapStream$int$int", ptr %0, i32 0, i32 1
  %src2 = load ptr, ptr %src, align 8
  store ptr %src2, ptr %src1, align 8, !tbaa !0
  %fn3 = getelementptr inbounds %"class.MapStream$int$int", ptr %0, i32 0, i32 2
  %fn4 = load ptr, ptr %fn, align 8
  store ptr %fn4, ptr %fn3, align 8, !tbaa !0
  ret void
}

define internal i32 @"MapStream$int$int.next"(ptr nonnull align 8 dereferenceable(24) %0) {
entry:
  %fn = getelementptr inbounds %"class.MapStream$int$int", ptr %0, i32 0, i32 2
  ...
  %src = getelementptr inbounds %"class.MapStream$int$int", ptr %0, i32 0, i32 1
  %src2 = load ptr, ptr %src, align 8, !tbaa !0
  %vtbl.addr = getelementptr inbounds %"class.Stream$int", ptr %src2, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %slot = getelementptr [350 x ptr], ptr %vtbl, i64 0, i64 1
  %fn3 = load ptr, ptr %slot, align 8
  %2 = call i32 %fn3(ptr %src2)
  %3 = call i32 %code(ptr %env, i32 %2)
  ret i32 %3
}

define internal i32 @"MapStream$int$int.hasNext"(ptr nonnull align 8 dereferenceable(24) %0) {
entry:
  %src = getelementptr inbounds %"class.MapStream$int$int", ptr %0, i32 0, i32 1
  %src1 = load ptr, ptr %src, align 8, !tbaa !0
  %vtbl.addr = getelementptr inbounds %"class.Stream$int", ptr %src1, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %slot = getelementptr [350 x ptr], ptr %vtbl, i64 0, i64 0
  %fn = load ptr, ptr %slot, align 8
  %1 = call i32 %fn(ptr %src1)
  ret i32 %1
}

define internal void @"FilterStream$int.FilterStream$int"(ptr %0, ptr %1, ptr %2) {
entry:
  %pred = alloca ptr, align 8
  %src = alloca ptr, align 8
  store ptr %1, ptr %src, align 8
  ...
  call void @"Stream$int.Stream$int"(ptr %0)
  %vtbl.addr = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 0
  store ptr @"FilterStream$int.vtable", ptr %vtbl.addr, align 8, !tbaa !0
  %src1 = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 1
  %src2 = load ptr, ptr %src, align 8
  store ptr %src2, ptr %src1, align 8, !tbaa !0
  %pred3 = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 2
  %pred4 = load ptr, ptr %pred, align 8
  store ptr %pred4, ptr %pred3, align 8, !tbaa !0
  %hasCached = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 3
  store i32 0, ptr %hasCached, align 4, !tbaa !4
  ret void
}

define internal i32 @"FilterStream$int.hasNext"(ptr nonnull align 8 dereferenceable(32) %0) {
entry:
  %v = alloca i32, align 4
  %hasCached = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 3
  %hasCached1 = load i32, ptr %hasCached, align 4, !tbaa !4
  %1 = icmp ne i32 %hasCached1, 0
...
while.cond:                                       ; preds = %if.end12, %if.end
  %src = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 1
  %src2 = load ptr, ptr %src, align 8, !tbaa !0
  %vtbl.addr = getelementptr inbounds %"class.Stream$int", ptr %src2, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %slot = getelementptr [350 x ptr], ptr %vtbl, i64 0, i64 0
  %fn = load ptr, ptr %slot, align 8
  %2 = call i32 %fn(ptr %src2)
  %3 = icmp ne i32 %2, 0
  br i1 %3, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %src3 = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 1
  %src4 = load ptr, ptr %src3, align 8, !tbaa !0
  %vtbl.addr5 = getelementptr inbounds %"class.Stream$int", ptr %src4, i32 0, i32 0
  %vtbl6 = load ptr, ptr %vtbl.addr5, align 8, !tbaa !0
  %slot7 = getelementptr [350 x ptr], ptr %vtbl6, i64 0, i64 1
  %fn8 = load ptr, ptr %slot7, align 8
  %4 = call i32 %fn8(ptr %src4)
  store i32 %4, ptr %v, align 4
  %pred = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 2
  %pred9 = load ptr, ptr %pred, align 8, !tbaa !0
  %code = load ptr, ptr %pred9, align 8
  %5 = getelementptr ptr, ptr %pred9, i32 1
  %env = load ptr, ptr %5, align 8
  %v10 = load i32, ptr %v, align 4
  %6 = call i32 %code(ptr %env, i32 %v10)
  %7 = icmp ne i32 %6, 0
...
if.then11:                                        ; preds = %while.body
  %cached = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 4
  %v13 = load i32, ptr %v, align 4
  store i32 %v13, ptr %cached, align 4, !tbaa !4
  %hasCached14 = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 3
  store i32 1, ptr %hasCached14, align 4, !tbaa !4
  ret i32 1
...
define internal i32 @"FilterStream$int.next"(ptr nonnull align 8 dereferenceable(32) %0) {
entry:
  %hasCached = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 3
  store i32 0, ptr %hasCached, align 4, !tbaa !4
  %cached = getelementptr inbounds %"class.FilterStream$int", ptr %0, i32 0, i32 4
  %cached1 = load i32, ptr %cached, align 4, !tbaa !4
  ret i32 %cached1
}

define internal void @"IteratorStream$int.IteratorStream$int"(ptr %0, ptr %1) {
entry:
  %src = alloca ptr, align 8
  store ptr %1, ptr %src, align 8
  call void @"Stream$int.Stream$int"(ptr %0)
  %vtbl.addr = getelementptr inbounds %"class.IteratorStream$int", ptr %0, i32 0, i32 0
  store ptr @"IteratorStream$int.vtable", ptr %vtbl.addr, align 8, !tbaa !0
  %src1 = getelementptr inbounds %"class.IteratorStream$int", ptr %0, i32 0, i32 1
  %src2 = load ptr, ptr %src, align 8
  store ptr %src2, ptr %src1, align 8, !tbaa !0
  ret void
}

define internal i32 @"IteratorStream$int.hasNext"(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %src = getelementptr inbounds %"class.IteratorStream$int", ptr %0, i32 0, i32 1
  %src1 = load ptr, ptr %src, align 8, !tbaa !0
  %vtbl.addr = getelementptr inbounds %"class.Iterator$int", ptr %src1, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %slot = getelementptr [350 x ptr], ptr %vtbl, i64 0, i64 0
  %fn = load ptr, ptr %slot, align 8
  %1 = call i32 %fn(ptr %src1)
...
define internal i32 @"IteratorStream$int.next"(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %src = getelementptr inbounds %"class.IteratorStream$int", ptr %0, i32 0, i32 1
  %src1 = load ptr, ptr %src, align 8, !tbaa !0
  %vtbl.addr = getelementptr inbounds %"class.Iterator$int", ptr %src1, i32 0, i32 0
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1093, ptr @.faila.1094, i64 %10, ptr @.failb.1095, i64 %arr.len, i32 70)
  unreachable
...
define internal i32 @__polaron_lambda_0(ptr %0, i32 %1) personality ptr @__CxxFrameHandler3 {
entry:
  %exc.thrown = alloca ptr, align 8
...
define internal ptr @"Stream$int.filter#0=__polaron_lambda_0$fs"(ptr %0, ptr %1) {
entry:
  %pred = alloca ptr, align 8
  store ptr %1, ptr %pred, align 8
  %"FilterStream$int.obj" = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%"class.FilterStream$int", ptr null, i64 1) to i64))
