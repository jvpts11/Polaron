; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reimport.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/reimport.pol"
...
@.str.3 = private unnamed_addr constant [17 x i8] c"should not reach\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@.str.5 = private unnamed_addr constant [11 x i8] c"unimported\00", align 1
...
entry:
  %exc.thrown37 = alloca ptr, align 8
...
alive.ok3:                                        ; preds = %alive.ok
  ...
  call void @__polaron_check_live(ptr %a7)
  %vtbl.addr = getelementptr inbounds %class.Dog, ptr %a7, i32 0, i32 0
...
dtor.call:                                        ; preds = %alive.ok3
  call void %dtor.fn(ptr %a7)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %alive.ok3
  call void @__polaron_free(ptr %a7)
...
unimport.ok:                                      ; preds = %dtor.free
  ...
  call void @__polaron_unload_fn(ptr @Dog.Dog, ptr %code.base10, i64 %code.n11)
  %code.base12 = load ptr, ptr @__polaron_code_base, align 8
  %code.n13 = load i64, ptr @__polaron_code_count, align 8
  call void @__polaron_unload_fn(ptr @"Dog.~Dog", ptr %code.base12, i64 %code.n13)
  %alive14 = load i32, ptr @alive.Dog, align 4
  %20 = icmp eq i32 %alive14, 0
  br i1 %20, label %unimported15, label %alive.ok16

ehpad:                                            ; preds = %alive.ok16, %unimported15
  %21 = catchswitch within none [label %catch.dispatch] unwind to caller
...
try.cont:                                         ; preds = %catch.body, %invoke.cont
  ...
  call void @__polaron_reload_fn(ptr @Dog.bark, ptr %code.base21, i64 %code.n22)
  %code.base23 = load ptr, ptr @__polaron_code_base, align 8
  %code.n24 = load i64, ptr @__polaron_code_count, align 8
  call void @__polaron_reload_fn(ptr @Dog.Dog, ptr %code.base23, i64 %code.n24)
  %code.base25 = load ptr, ptr @__polaron_code_base, align 8
  %code.n26 = load i64, ptr @__polaron_code_count, align 8
  call void @__polaron_reload_fn(ptr @"Dog.~Dog", ptr %code.base25, i64 %code.n26)
  store i32 1, ptr @alive.Dog, align 4
  %alive27 = load i32, ptr @alive.Dog, align 4
  %22 = icmp eq i32 %alive27, 0
  br i1 %22, label %unimported28, label %alive.ok29

unimported15:                                     ; preds = %unimport.ok
  ...
  invoke void @_CxxThrowException(ptr %exc.thrown18, ptr @_TI1PEAX)
          to label %throw.cont unwind label %ehpad

alive.ok16:                                       ; preds = %unimport.ok
  %Dog.obj19 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Dog, ptr null, i64 1) to i64))
  invoke void @Dog.Dog(ptr %Dog.obj19)
          to label %invoke.cont unwind label %ehpad

throw.cont:                                       ; preds = %unimported15
  unreachable

invoke.cont:                                      ; preds = %alive.ok16
  store ptr %Dog.obj19, ptr %b, align 8
  %23 = call i32 (ptr, ...) @printf(ptr @.str.2, ptr @.str.3)
  br label %try.cont

catch.dispatch:                                   ; preds = %ehpad
  %24 = catchpad within %21 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught]
  ...
  catchret from %24 to label %catch.body

catch.next:                                       ; preds = %catch.dispatch
  catchret from %24 to label %rethrow

catch.body:                                       ; preds = %catch.match
  %25 = call i32 (ptr, ...) @printf(ptr @.str.4, ptr @.str.5)
  br label %try.cont

rethrow:                                          ; preds = %catch.next
  %rethrow.obj = load ptr, ptr %exc.caught, align 8
  store ptr %rethrow.obj, ptr %exc.thrown20, align 8
  call void @_CxxThrowException(ptr %exc.thrown20, ptr @_TI1PEAX)
  unreachable

unimported28:                                     ; preds = %try.cont
  %unimp.exc30 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.UnimportedTypeException, ptr null, i64 1) to i64))
  call void @UnimportedTypeException.UnimportedTypeException(ptr %unimp.exc30)
  store ptr %unimp.exc30, ptr %exc.thrown31, align 8
  call void @_CxxThrowException(ptr %exc.thrown31, ptr @_TI1PEAX)
  unreachable

alive.ok29:                                       ; preds = %try.cont
  %Dog.obj32 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Dog, ptr null, i64 1) to i64))
  call void @Dog.Dog(ptr %Dog.obj32)
  store ptr %Dog.obj32, ptr %c, align 8
  %alive33 = load i32, ptr @alive.Dog, align 4
  %26 = icmp eq i32 %alive33, 0
  br i1 %26, label %unimported34, label %alive.ok35

unimported34:                                     ; preds = %alive.ok29
  %unimp.exc36 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.UnimportedTypeException, ptr null, i64 1) to i64))
  call void @UnimportedTypeException.UnimportedTypeException(ptr %unimp.exc36)
  store ptr %unimp.exc36, ptr %exc.thrown37, align 8
  call void @_CxxThrowException(ptr %exc.thrown37, ptr @_TI1PEAX)
  unreachable

alive.ok35:                                       ; preds = %alive.ok29
  %c38 = load ptr, ptr %c, align 8
  call void @Dog.bark(ptr %c38)
  ret i32 0
}
