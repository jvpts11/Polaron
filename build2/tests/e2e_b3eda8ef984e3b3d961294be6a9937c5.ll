; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/loop.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/loop.pol"
...
@.str = private unnamed_addr constant [17 x i8] c"sum=%d steps=%d\0A\00", align 1
...
while.cond:                                       ; preds = %div.ok, %for.end
  %n4 = load i32, ptr %n, align 4
  %21 = icmp sgt i32 %n4, 1
  %22 = zext i1 %21 to i32
  br i1 %21, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %n5 = load i32, ptr %n, align 4
  %23 = icmp eq i32 %n5, -2147483648
  %24 = and i1 %23, false
  %25 = or i1 false, %24
...
while.end:                                        ; preds = %while.cond
  ...
  %steps7 = load i32, ptr %steps, align 4
  %26 = call i32 (ptr, ...) @printf(ptr @.str, i32 %sum6, i32 %steps7)
  ret i32 0
...
div.ok:                                           ; preds = %while.body
  ...
  %29 = add i32 %28, 1
  store i32 %29, ptr %steps, align 4
  br label %while.cond
}
