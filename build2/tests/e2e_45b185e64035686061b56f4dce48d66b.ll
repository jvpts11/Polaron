; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/stringbuilder_lifetime.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/stringbuilder_lifetime.pol"
...
@.strdata = private constant [7 x i8] c"scoped\00"
@.strobj = private global %String { i64 6, ptr @.strdata, i64 0 }
@.strdata.1 = private constant [3 x i8] c"ab\00"
@.strobj.2 = private global %String { i64 2, ptr @.strdata.1, i64 0 }
@.strdata.3 = private constant [2 x i8] c"x\00"
@.strobj.4 = private global %String { i64 1, ptr @.strdata.3, i64 0 }
@.str = private unnamed_addr constant [25 x i8] c"s=%s scoped=%d total=%d\0A\00", align 1
...
define internal i32 @Main.scoped() personality ptr @__CxxFrameHandler3 {
entry:
  %sb = alloca ptr, align 8
  store ptr null, ptr %sb, align 8
  %StringBuilder.obj = alloca %class.StringBuilder, align 8
  ...
  %0 = invoke ptr @StringBuilder.append(ptr %sb1, ptr @.strobj)
          to label %invoke.cont unwind label %cleanup.StringBuilder

cleanup.StringBuilder:                            ; preds = %entry
  %1 = cleanuppad within none []
  %2 = load ptr, ptr %sb, align 8
  call void @"StringBuilder.~StringBuilder"(ptr %2) [ "funclet"(token %1) ]
  cleanupret from %1 unwind to caller

invoke.cont:                                      ; preds = %entry
  %sb2 = load ptr, ptr %sb, align 8
  %3 = invoke i32 @StringBuilder.length(ptr %sb2)
          to label %invoke.cont4 unwind label %cleanup.StringBuilder3

cleanup.StringBuilder3:                           ; preds = %invoke.cont
  %4 = cleanuppad within none []
  %5 = load ptr, ptr %sb, align 8
  call void @"StringBuilder.~StringBuilder"(ptr %5) [ "funclet"(token %4) ]
  cleanupret from %4 unwind to caller

invoke.cont4:                                     ; preds = %invoke.cont
  %6 = load ptr, ptr %sb, align 8
  %7 = icmp ne ptr %6, null
  br i1 %7, label %dtor.live, label %dtor.done

dtor.live:                                        ; preds = %invoke.cont4
  call void @"StringBuilder.~StringBuilder"(ptr %6)
  br label %dtor.done

dtor.done:                                        ; preds = %dtor.live, %invoke.cont4
  ret i32 %3
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @StringBuilder.StringBuilder(ptr %StringBuilder.obj)
  store ptr %StringBuilder.obj, ptr %a, align 8
  %a1 = load ptr, ptr %a, align 8
  %16 = call ptr @StringBuilder.append(ptr %a1, ptr @.strobj.2)
  %a2 = load ptr, ptr %a, align 8
  %17 = call ptr @StringBuilder.appendChar(ptr %a2, i32 99)
  %a3 = load ptr, ptr %a, align 8
  %18 = call ptr @StringBuilder.toString(ptr %a3)
  ...
  call void @__polaron_check_live(ptr %a4)
  %vtbl.addr = getelementptr inbounds %class.StringBuilder, ptr %a4, i32 0, i32 0
...
dtor.call:                                        ; preds = %argv.end
  call void %dtor.fn(ptr %a4)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %argv.end
  call void @__polaron_free(ptr %a4)
  store i32 0, ptr %total, align 4
  store i32 0, ptr %i, align 4
  br label %while.cond

while.cond:                                       ; preds = %dtor.free18, %dtor.free
  %i5 = load i32, ptr %i, align 4
  %20 = icmp slt i32 %i5, 1000
  %21 = zext i1 %20 to i32
  br i1 %20, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %StringBuilder.obj6 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.StringBuilder, ptr null, i64 1) to i64))
  call void @StringBuilder.StringBuilder(ptr %StringBuilder.obj6)
  store ptr %StringBuilder.obj6, ptr %t, align 8
  %t7 = load ptr, ptr %t, align 8
  %22 = call ptr @StringBuilder.append(ptr %t7, ptr @.strobj.4)
  %t8 = load ptr, ptr %t, align 8
  %i9 = load i32, ptr %i, align 4
  %23 = call ptr @StringBuilder.appendInt(ptr %t8, i32 %i9)
  %total10 = load i32, ptr %total, align 4
  %t11 = load ptr, ptr %t, align 8
  %24 = call ptr @StringBuilder.toString(ptr %t11)
  %str.len = getelementptr inbounds %String, ptr %24, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %25 = trunc i64 %len to i32
  %26 = add i32 %total10, %25
  store i32 %26, ptr %total, align 4
  call void @__polaron_str_free(ptr %24)
  %t12 = load ptr, ptr %t, align 8
  call void @__polaron_check_live(ptr %t12)
  %vtbl.addr13 = getelementptr inbounds %class.StringBuilder, ptr %t12, i32 0, i32 0
  %vtbl14 = load ptr, ptr %vtbl.addr13, align 8, !tbaa !0
  %dtor.slot15 = getelementptr [349 x ptr], ptr %vtbl14, i64 0, i64 348
  %dtor.fn16 = load ptr, ptr %dtor.slot15, align 8
  %27 = icmp ne ptr %dtor.fn16, null
  br i1 %27, label %dtor.call17, label %dtor.free18

while.end:                                        ; preds = %while.cond
  %s20 = load ptr, ptr %s, align 8
  %str.data = getelementptr inbounds %String, ptr %s20, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %28 = call i32 @Main.scoped()
  %total21 = load i32, ptr %total, align 4
  %29 = call i32 (ptr, ...) @printf(ptr @.str, ptr %data, i32 %28, i32 %total21)
  %30 = load ptr, ptr %s, align 8
  call void @__polaron_str_free(ptr %30)
  ret i32 0

dtor.call17:                                      ; preds = %while.body
  call void %dtor.fn16(ptr %t12)
  br label %dtor.free18

dtor.free18:                                      ; preds = %dtor.call17, %while.body
  call void @__polaron_free(ptr %t12)
