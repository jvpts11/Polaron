; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/case_convert.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/case_convert.pol"
...
@.str = private unnamed_addr constant [38 x i8] c"snake=%s kebab=%s camel=%s camel2=%s\0A\00", align 1
@.strdata = private constant [11 x i8] c"helloWorld\00"
@.strobj = private global %String { i64 10, ptr @.strdata, i64 0 }
@.strdata.1 = private constant [11 x i8] c"helloWorld\00"
@.strobj.2 = private global %String { i64 10, ptr @.strdata.1, i64 0 }
@.strdata.3 = private constant [12 x i8] c"hello_world\00"
@.strobj.4 = private global %String { i64 11, ptr @.strdata.3, i64 0 }
@.strdata.5 = private constant [12 x i8] c"foo-bar-baz\00"
...
define internal i32 @CaseConvert.lower(i32 %0) {
entry:
  %c = alloca i32, align 4
...
define internal i32 @CaseConvert.upper(i32 %0) {
entry:
  %c = alloca i32, align 4
  store i32 %0, ptr %c, align 4
  %c1 = load i32, ptr %c, align 4
...
define internal ptr @CaseConvert.delimit(ptr %0, i32 %1) {
entry:
  %c = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  ...
  %11 = call ptr @StringBuilder.toString(ptr %sb16)
...
if.then:                                          ; preds = %sc.end
  ...
  %15 = icmp sgt i32 %i7, 0
  %16 = zext i1 %15 to i32
  br i1 %15, label %if.then8, label %if.end9

if.else:                                          ; preds = %sc.end
  %sb14 = load ptr, ptr %sb, align 8
  %c15 = load i32, ptr %c, align 4
  %17 = call ptr @StringBuilder.appendChar(ptr %sb14, i32 %c15)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.end9
  br label %for.update

if.then8:                                         ; preds = %if.then
  %sb10 = load ptr, ptr %sb, align 8
  %sep11 = load i32, ptr %sep, align 4
  %18 = call ptr @StringBuilder.appendChar(ptr %sb10, i32 %sep11)
  br label %if.end9

if.end9:                                          ; preds = %if.then8, %if.then
  %sb12 = load ptr, ptr %sb, align 8
  %c13 = load i32, ptr %c, align 4
  %19 = call i32 @CaseConvert.lower(i32 %c13)
  %20 = call ptr @StringBuilder.appendChar(ptr %sb12, i32 %19)
  br label %if.end
}

define internal ptr @CaseConvert.toSnake(ptr %0) {
entry:
  %s = alloca ptr, align 8
  store ptr %0, ptr %s, align 8
  %s1 = load ptr, ptr %s, align 8
  %1 = call ptr @CaseConvert.delimit(ptr %s1, i32 95)
  %strcpy = call ptr @__polaron_str_copy(ptr %1)
  call void @__polaron_str_free(ptr %1)
  ret ptr %strcpy
}

define internal ptr @CaseConvert.toKebab(ptr %0) {
entry:
  %s = alloca ptr, align 8
  store ptr %0, ptr %s, align 8
  %s1 = load ptr, ptr %s, align 8
  %1 = call ptr @CaseConvert.delimit(ptr %s1, i32 45)
  %strcpy = call ptr @__polaron_str_copy(ptr %1)
  call void @__polaron_str_free(ptr %1)
  ret ptr %strcpy
}

define internal ptr @CaseConvert.toCamel(ptr %0) {
entry:
  %c = alloca i32, align 4
  %i = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  ...
  %10 = call ptr @StringBuilder.toString(ptr %sb15)
...
if.else:                                          ; preds = %sc.end
  %up7 = load i32, ptr %up, align 4
  %14 = icmp ne i32 %up7, 0
  br i1 %14, label %if.then8, label %if.else9

if.end:                                           ; preds = %if.end10, %if.then
  br label %for.update

if.then8:                                         ; preds = %if.else
  %sb11 = load ptr, ptr %sb, align 8
  %c12 = load i32, ptr %c, align 4
  %15 = call i32 @CaseConvert.upper(i32 %c12)
...
if.else9:                                         ; preds = %if.else
  ...
  %17 = call ptr @StringBuilder.appendChar(ptr %sb13, i32 %c14)
  br label %if.end10
