; ModuleID = 'C:\Users\jvpts\Documents\GitHub\LDP3\build2\tests\testcmd_lib\src/lib.pol'
source_filename = "C:\\Users\\jvpts\\Documents\\GitHub\\LDP3\\build2\\tests\\testcmd_lib\\src/lib.pol"
...
@.test.name.5452 = private unnamed_addr constant [16 x i8] c"Adder.add_works\00", align 1
...
then1:                                            ; preds = %entry
  ...
  %strcpy.i5 = tail call ptr @__polaron_str_copy(ptr nonnull @.strobj.5333)
  %6 = load ptr, ptr @Test.criterion, align 8
  tail call void @__polaron_str_free(ptr %6)
  store ptr %strcpy.i5, ptr @Test.criterion, align 8
  %strcpy1.i6 = tail call ptr @__polaron_str_copy(ptr nonnull @.strobj.5335)
  %7 = load ptr, ptr @Test.skipWhy, align 8
  tail call void @__polaron_str_free(ptr %7)
  store ptr %strcpy1.i6, ptr @Test.skipWhy, align 8
  %t1 = tail call i64 @__polaron_now_ns()
  %ns = sub i64 %t1, %t0
  %skipWhy.i = load ptr, ptr @Test.skipWhy, align 8
  %strcpy.i7 = tail call ptr @__polaron_str_copy(ptr %skipWhy.i)
  %8 = tail call ptr @__polaron_str_cstr(ptr %strcpy.i7)
