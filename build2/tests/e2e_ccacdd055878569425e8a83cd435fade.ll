; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/match.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/match.pol"
...
entry:
  ...
  %r1 = load i32, ptr %r, align 4, !tbaa !0
  %r2 = getelementptr inbounds %class.Circle, ptr %0, i32 0, i32 1
  %r3 = load i32, ptr %r2, align 4, !tbaa !0
  %1 = mul i32 %r1, %r3
  %2 = mul i32 %1, 3
  ret i32 %2
}
...
entry:
  ...
  store ptr @Square.vtable, ptr %vtbl.addr, align 8, !tbaa !4
  %side1 = getelementptr inbounds %class.Square, ptr %0, i32 0, i32 1
  %side2 = load i32, ptr %side, align 4
  store i32 %side2, ptr %side1, align 4, !tbaa !0
  ret void
}
...
entry:
  ...
  %side1 = load i32, ptr %side, align 4, !tbaa !0
  %side2 = getelementptr inbounds %class.Square, ptr %0, i32 0, i32 1
  %side3 = load i32, ptr %side2, align 4, !tbaa !0
...
match.end:                                        ; preds = %match.next5, %match.case4, %match.case
  ...
  %vtbl11 = load ptr, ptr %vtbl.addr10, align 8, !tbaa !4
...
match.case:                                       ; preds = %argv.end
  ...
  %r = load i32, ptr %17, align 4, !tbaa !0
...
match.case4:                                      ; preds = %match.next
  ...
  %side = load i32, ptr %19, align 4, !tbaa !0
