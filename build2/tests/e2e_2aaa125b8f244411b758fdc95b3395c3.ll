; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/adler.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/adler.pol"
...
@.str = private unnamed_addr constant [10 x i8] c"adler=%d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 @Digest.adler32(ptr @.strobj)
...
define internal i32 @Digest.adler32(ptr %0) personality ptr @__CxxFrameHandler3 {
entry:
...
div.ok:                                           ; preds = %for.body
  ...
  %14 = icmp eq i32 %m10, 0
  br i1 %14, label %div.bad11, label %div.ok12

div.bad11:                                        ; preds = %div.ok
