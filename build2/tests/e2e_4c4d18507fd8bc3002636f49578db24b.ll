; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/result_sugar.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/result_sugar.pol"
...
@.str.1 = private unnamed_addr constant [11 x i8] c"c=%d d=%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"some %d\0A\00", align 1
@.str.3 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.4 = private unnamed_addr constant [6 x i8] c"none\0A\00", align 1
@.str.5 = private unnamed_addr constant [9 x i8] c"some %d\0A\00", align 1
...
define internal ptr @Main.parse(i32 %0) {
entry:
...
if.end:                                           ; preds = %entry
  ...
  call void @"Ok$int$int.Ok$int$int"(ptr %"Ok$int$int.obj", i32 %n2)
...
argv.end:                                         ; preds = %argv.cond
  ...
  store ptr %"Ok$int$int.obj", ptr %a, align 8
  %"Err$int$int.obj" = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%"class.Err$int$int", ptr null, i64 1) to i64))
  call void @"Err$int$int.Err$int$int"(ptr %"Err$int$int.obj", i32 404)
  store ptr %"Err$int$int.obj", ptr %b, align 8
  %a1 = load ptr, ptr %a, align 8
  %16 = call i32 @Main.grade(ptr %a1)
  %b2 = load ptr, ptr %b, align 8
  %17 = call i32 @Main.grade(ptr %b2)
  %18 = call i32 (ptr, ...) @printf(ptr @.str, i32 %16, i32 %17)
  %19 = call ptr @Main.parse(i32 5)
  store ptr %19, ptr %c, align 8
  %20 = call ptr @Main.parse(i32 -1)
  store ptr %20, ptr %d, align 8
  %c3 = load ptr, ptr %c, align 8
  %21 = call i32 @Main.grade(ptr %c3)
  %d4 = load ptr, ptr %d, align 8
  %22 = call i32 @Main.grade(ptr %d4)
  %23 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %21, i32 %22)
  ...
  store ptr %"Some$int.obj", ptr %o, align 8
  ...
  store ptr %"None$int.obj", ptr %p, align 8
  %o5 = load ptr, ptr %o, align 8
  %vtbl.addr = getelementptr inbounds %"class.Option$int", ptr %o5, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %is = icmp eq ptr %vtbl, @"Some$int.vtable"
  br i1 %is, label %match.case, label %match.next

match.end:                                        ; preds = %match.next8, %match.case7, %match.case
  %p10 = load ptr, ptr %p, align 8
  %vtbl.addr11 = getelementptr inbounds %"class.Option$int", ptr %p10, i32 0, i32 0
  %vtbl12 = load ptr, ptr %vtbl.addr11, align 8, !tbaa !0
  %is16 = icmp eq ptr %vtbl12, @"Some$int.vtable"
  br i1 %is16, label %match.case14, label %match.next15

match.case:                                       ; preds = %argv.end
  %24 = getelementptr inbounds %"class.Some$int", ptr %o5, i32 0, i32 1
  %value = load i32, ptr %24, align 4, !tbaa !4
  store i32 %value, ptr %v, align 4
  %v6 = load i32, ptr %v, align 4
  %25 = call i32 (ptr, ...) @printf(ptr @.str.2, i32 %v6)
  br label %match.end

match.next:                                       ; preds = %argv.end
  %is9 = icmp eq ptr %vtbl, @"None$int.vtable"
  br i1 %is9, label %match.case7, label %match.next8

match.case7:                                      ; preds = %match.next
  %26 = call i32 (ptr, ...) @printf(ptr @.str.3, ptr @.str.4)
  br label %match.end

match.next8:                                      ; preds = %match.next
  br label %match.end

match.end13:                                      ; preds = %match.next21, %match.case20, %match.case14
  ret i32 0

match.case14:                                     ; preds = %match.end
  %27 = getelementptr inbounds %"class.Some$int", ptr %p10, i32 0, i32 1
  %value17 = load i32, ptr %27, align 4, !tbaa !4
  store i32 %value17, ptr %v18, align 4
  %v19 = load i32, ptr %v18, align 4
  %28 = call i32 (ptr, ...) @printf(ptr @.str.5, i32 %v19)
  br label %match.end13

match.next15:                                     ; preds = %match.end
  %is22 = icmp eq ptr %vtbl12, @"None$int.vtable"
