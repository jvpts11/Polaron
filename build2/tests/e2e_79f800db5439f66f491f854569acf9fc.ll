; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/literal_overload.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/literal_overload.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 @literal.scaled.int(i32 5)
  store i32 %16, ptr %a, align 4
  %17 = call i32 @literal.scaled.double(double 1.500000e+00)
  store i32 %17, ptr %b, align 4
  %a1 = load i32, ptr %a, align 4
  %b2 = load i32, ptr %b, align 4
  %18 = call i32 (ptr, ...) @printf(ptr @.str, i32 %a1, i32 %b2)
  ret i32 0
}

define internal i32 @literal.scaled.int(i32 %0) {
entry:
...
define internal i32 @literal.scaled.double(double %0) {
entry:
  %x = alloca double, align 8
  store double %0, ptr %x, align 8
  %x1 = load double, ptr %x, align 8
  %1 = fmul double %x1, 1.000000e+01
