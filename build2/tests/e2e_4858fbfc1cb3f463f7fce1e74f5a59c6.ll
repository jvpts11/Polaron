; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/string_utils.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/string_utils.pol"
...
@.strdata = private constant [9 x i8] c"a,bb,ccc\00"
...
@.str = private unnamed_addr constant [12 x i8] c"n=%d p1=%s\0A\00", align 1
@.str.3 = private unnamed_addr constant [9 x i8] c"join=%s\0A\00", align 1
@.strdata.4 = private constant [2 x i8] c"-\00"
@.strobj.5 = private global %String { i64 1, ptr @.strdata.4, i64 0 }
@.str.6 = private unnamed_addr constant [9 x i8] c"repl=%s\0A\00", align 1
@.strdata.7 = private constant [18 x i8] c"hello world hello\00"
@.strobj.8 = private global %String { i64 17, ptr @.strdata.7, i64 0 }
@.strdata.9 = private constant [6 x i8] c"hello\00"
@.strobj.10 = private global %String { i64 5, ptr @.strdata.9, i64 0 }
@.strdata.11 = private constant [3 x i8] c"hi\00"
@.strobj.12 = private global %String { i64 2, ptr @.strdata.11, i64 0 }
@.str.13 = private unnamed_addr constant [21 x i8] c"padL=[%s] padR=[%s]\0A\00", align 1
@.strdata.14 = private constant [3 x i8] c"42\00"
@.strobj.15 = private global %String { i64 2, ptr @.strdata.14, i64 0 }
@.strdata.16 = private constant [2 x i8] c"0\00"
@.strobj.17 = private global %String { i64 1, ptr @.strdata.16, i64 0 }
@.strdata.18 = private constant [3 x i8] c"42\00"
@.strobj.19 = private global %String { i64 2, ptr @.strdata.18, i64 0 }
@.strdata.20 = private constant [2 x i8] c".\00"
@.strobj.21 = private global %String { i64 1, ptr @.strdata.20, i64 0 }
...
@.contract.1109 = private unnamed_addr constant [124 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.ArrayList$String\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1110 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1111 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1112 = private unnamed_addr constant [141 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.ArrayList$String\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1113 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:320:35  in ArrayList$String.add\0A\00", align 1
...
@.fail.1116 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:320:35  in ArrayList$String.add\0A\00", align 1
...
@.fail.1119 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:325:39  in ArrayList$String.add\0A\00", align 1
...
@.contract.1122 = private unnamed_addr constant [124 x i8] c"contract violated: ensures\0A  --> <prelude>:315:36  in ArrayList$String.add\0A   |  ensures this.count == old(this.count) + 1\0A\00", align 1
@.contract.1123 = private unnamed_addr constant [111 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.add\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1124 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1125 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1126 = private unnamed_addr constant [128 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.add\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1127 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:334:78  in ArrayList$String.ensureCapacity\0A\00", align 1
...
@.fail.1130 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:334:78  in ArrayList$String.ensureCapacity\0A\00", align 1
...
@.contract.1133 = private unnamed_addr constant [122 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.ensureCapacity\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1134 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1135 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1136 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.ensureCapacity\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1137 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:345:21  in ArrayList$String.get\0A\00", align 1
...
@.fail.1140 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:347:17  in ArrayList$String.get\0A\00", align 1
...
@.fail.1143 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:351:51  in ArrayList$String.set\0A\00", align 1
...
@.contract.1146 = private unnamed_addr constant [128 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1147 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:354:30  in ArrayList$String.set\0A\00", align 1
...
@.contract.1150 = private unnamed_addr constant [128 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1151 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:358:21  in ArrayList$String.indexOf\0A\00", align 1
@.faila.1152 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1153 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1154 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:369:21  in ArrayList$String.removeAt\0A\00", align 1
...
@.contract.1157 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.removeAt\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1160 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.removeAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1161 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:373:34  in ArrayList$String.removeAt\0A\00", align 1
...
@.fail.1164 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:373:34  in ArrayList$String.removeAt\0A\00", align 1
...
@.contract.1167 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.removeAt\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1170 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.removeAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1171 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:379:51  in ArrayList$String.insertAt\0A\00", align 1
...
@.contract.1174 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1175 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1176 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1177 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1178 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:384:78  in ArrayList$String.insertAt\0A\00", align 1
@.faila.1179 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1180 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1181 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:384:78  in ArrayList$String.insertAt\0A\00", align 1
@.faila.1182 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1183 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1184 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:389:34  in ArrayList$String.insertAt\0A\00", align 1
...
@.fail.1187 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:389:34  in ArrayList$String.insertAt\0A\00", align 1
...
@.fail.1190 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:391:30  in ArrayList$String.insertAt\0A\00", align 1
...
@.contract.1193 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1194 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1195 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1196 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.1197 = private unnamed_addr constant [113 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.clear\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1198 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1199 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1200 = private unnamed_addr constant [130 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.clear\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1201 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:405:71  in ArrayList$String.toArray\0A\00", align 1
...
@.fail.1204 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:405:71  in ArrayList$String.toArray\0A\00", align 1
...
@.fail.1207 = private unnamed_addr constant [94 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:416:70  in ArrayList$String.forEach\0A\00", align 1
@.faila.1208 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1209 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1210 = private unnamed_addr constant [93 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:21  in ArrayList$String.filter\0A\00", align 1
@.faila.1211 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1212 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1213 = private unnamed_addr constant [93 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:54  in ArrayList$String.filter\0A\00", align 1
@.faila.1214 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1215 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1216 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:439:21  in ArrayList$String.any\0A\00", align 1
...
@.fail.1219 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:445:21  in ArrayList$String.all\0A\00", align 1
...
@.fail.1222 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:452:21  in ArrayList$String.count\0A\00", align 1
...
@.fail.1225 = private unnamed_addr constant [95 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:462:71  in ArrayList$String.sortedBy\0A\00", align 1
...
@.contract.1228 = private unnamed_addr constant [116 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$String.sortedBy\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.1231 = private unnamed_addr constant [133 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.sortedBy\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
...
@.fail.1233 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:478:25  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1236 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:480:25  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1239 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1242 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1245 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:484:42  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1249 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1252 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.contract.1255 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1256 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1259 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1262 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1265 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1268 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1271 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1274 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1277 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1280 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1283 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1286 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.fail.1289 = private unnamed_addr constant [101 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$String.mergeSortRange\0A\00", align 1
...
@.contract.1292 = private unnamed_addr constant [139 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$String.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1293 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:21  in ArrayList$String.find\0A\00", align 1
...
@.fail.1296 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:47  in ArrayList$String.find\0A\00", align 1
@.faila.1297 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1298 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1299 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:520:17  in ArrayList$String.min\0A\00", align 1
@.faila.1300 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1301 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1302 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:21  in ArrayList$String.min\0A\00", align 1
...
@.fail.1305 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:65  in ArrayList$String.min\0A\00", align 1
...
@.fail.1308 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:528:17  in ArrayList$String.max\0A\00", align 1
...
@.fail.1311 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:21  in ArrayList$String.max\0A\00", align 1
@.faila.1312 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1313 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1314 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:65  in ArrayList$String.max\0A\00", align 1
@.faila.1315 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1316 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.strdata.1327 = private constant [17 x i8] c"arithmetic error\00"
@.strobj.1328 = private global %String { i64 16, ptr @.strdata.1327, i64 0 }
@.strdata.1329 = private constant [17 x i8] c"division by zero\00"
@.strobj.1330 = private global %String { i64 16, ptr @.strdata.1329, i64 0 }
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @Strings.split(ptr @.strobj, ptr @.strobj.2)
  store ptr %16, ptr %parts, align 8
  %parts1 = load ptr, ptr %parts, align 8
  %17 = call i32 @"ArrayList$String.size"(ptr %parts1)
  %parts2 = load ptr, ptr %parts, align 8
  %18 = call ptr @"ArrayList$String.get"(ptr %parts2, i32 1)
  %str.data = getelementptr inbounds %String, ptr %18, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %19 = call i32 (ptr, ...) @printf(ptr @.str, i32 %17, ptr %data)
  call void @__polaron_str_free(ptr %18)
  %parts3 = load ptr, ptr %parts, align 8
  %20 = call ptr @Strings.join(ptr %parts3, ptr @.strobj.5)
  %str.data4 = getelementptr inbounds %String, ptr %20, i32 0, i32 1
  %data5 = load ptr, ptr %str.data4, align 8
  %21 = call i32 (ptr, ...) @printf(ptr @.str.3, ptr %data5)
  call void @__polaron_str_free(ptr %20)
  %22 = call ptr @Strings.replace(ptr @.strobj.8, ptr @.strobj.10, ptr @.strobj.12)
  %str.data6 = getelementptr inbounds %String, ptr %22, i32 0, i32 1
  %data7 = load ptr, ptr %str.data6, align 8
  %23 = call i32 (ptr, ...) @printf(ptr @.str.6, ptr %data7)
  call void @__polaron_str_free(ptr %22)
  %24 = call ptr @Strings.padLeft(ptr @.strobj.15, i32 5, ptr @.strobj.17)
  %str.data8 = getelementptr inbounds %String, ptr %24, i32 0, i32 1
  %data9 = load ptr, ptr %str.data8, align 8
  %25 = call ptr @Strings.padRight(ptr @.strobj.19, i32 5, ptr @.strobj.21)
  %str.data10 = getelementptr inbounds %String, ptr %25, i32 0, i32 1
  %data11 = load ptr, ptr %str.data10, align 8
  %26 = call i32 (ptr, ...) @printf(ptr @.str.13, ptr %data9, ptr %data11)
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.1109, ptr @.cl.1110, i64 %contract.l, ptr @.cr.1111, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1113, ptr @.faila.1114, i64 %19, ptr @.failb.1115, i64 %arr.len, i32 70)
  unreachable
...
idx.bad27:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1116, ptr @.faila.1117, i64 %22, ptr @.failb.1118, i64 %arr.len25, i32 70)
  unreachable
...
idx.bad42:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1119, ptr @.faila.1120, i64 %16, ptr @.failb.1121, i64 %arr.len40, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok43
  call void @__polaron_fail(ptr @.contract.1122, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
contract.fail57:                                  ; preds = %contract.cont
  ...
  call void @__polaron_fail(ptr @.contract.1123, ptr @.cl.1124, i64 %contract.l, ptr @.cr.1125, i64 0, i32 1)
  unreachable
...
contract.fail67:                                  ; preds = %contract.cont58
  call void @__polaron_fail(ptr @.contract.1126, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1127, ptr @.faila.1128, i64 %18, ptr @.failb.1129, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1130, ptr @.faila.1131, i64 %21, ptr @.failb.1132, i64 %arr.len20, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %if.end
  ...
  call void @__polaron_fail(ptr @.contract.1133, ptr @.cl.1134, i64 %contract.l, ptr @.cr.1135, i64 0, i32 1)
  unreachable
...
contract.fail41:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1136, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad20:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1140, ptr @.faila.1141, i64 %14, ptr @.failb.1142, i64 %arr.len18, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1143, ptr @.faila.1144, i64 %14, ptr @.failb.1145, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  call void @__polaron_fail(ptr @.contract.1146, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad26:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1147, ptr @.faila.1148, i64 %15, ptr @.failb.1149, i64 %arr.len24, i32 70)
  unreachable
...
contract.fail38:                                  ; preds = %idx.ok27
  call void @__polaron_fail(ptr @.contract.1150, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1151, ptr @.faila.1152, i64 %9, ptr @.failb.1153, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1154, ptr @.faila.1155, i64 %13, ptr @.failb.1156, i64 %arr.len, i32 70)
  unreachable
...
idx.bad36:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1161, ptr @.faila.1162, i64 %23, ptr @.failb.1163, i64 %arr.len34, i32 70)
  unreachable
...
idx.bad45:                                        ; preds = %idx.ok37
  call void @__polaron_fail(ptr @.fail.1164, ptr @.faila.1165, i64 %30, ptr @.failb.1166, i64 %arr.len43, i32 70)
  unreachable
...
contract.fail57:                                  ; preds = %for.end
  ...
  call void @__polaron_fail(ptr @.contract.1167, ptr @.cl.1168, i64 %contract.l61, ptr @.cr.1169, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1171, ptr @.faila.1172, i64 %14, ptr @.failb.1173, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.1174, ptr @.cl.1175, i64 %contract.l, ptr @.cr.1176, i64 0, i32 1)
  unreachable
...
contract.fail26:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1177, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad46:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1178, ptr @.faila.1179, i64 %32, ptr @.failb.1180, i64 %arr.len44, i32 70)
  unreachable
...
idx.bad55:                                        ; preds = %idx.ok47
  call void @__polaron_fail(ptr @.fail.1181, ptr @.faila.1182, i64 %35, ptr @.failb.1183, i64 %arr.len53, i32 70)
  unreachable
...
idx.bad78:                                        ; preds = %for.body68
  call void @__polaron_fail(ptr @.fail.1184, ptr @.faila.1185, i64 %42, ptr @.failb.1186, i64 %arr.len76, i32 70)
  unreachable
...
idx.bad87:                                        ; preds = %idx.ok79
  call void @__polaron_fail(ptr @.fail.1187, ptr @.faila.1188, i64 %47, ptr @.failb.1189, i64 %arr.len85, i32 70)
  unreachable
...
idx.bad98:                                        ; preds = %for.end70
  call void @__polaron_fail(ptr @.fail.1190, ptr @.faila.1191, i64 %45, ptr @.failb.1192, i64 %arr.len96, i32 70)
  unreachable
...
contract.fail110:                                 ; preds = %idx.ok99
  ...
  call void @__polaron_fail(ptr @.contract.1193, ptr @.cl.1194, i64 %contract.l114, ptr @.cr.1195, i64 0, i32 1)
  unreachable
...
contract.fail121:                                 ; preds = %contract.cont111
  call void @__polaron_fail(ptr @.contract.1196, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.1197, ptr @.cl.1198, i64 %contract.l, ptr @.cr.1199, i64 0, i32 1)
  unreachable
...
contract.fail17:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1200, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1201, ptr @.faila.1202, i64 %12, ptr @.failb.1203, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.1204, ptr @.faila.1205, i64 %15, ptr @.failb.1206, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1207, ptr @.faila.1208, i64 %10, ptr @.failb.1209, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1210, ptr @.faila.1211, i64 %10, ptr @.failb.1212, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1213, ptr @.faila.1214, i64 %15, ptr @.failb.1215, i64 %arr.len20, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1216, ptr @.faila.1217, i64 %10, ptr @.failb.1218, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1219, ptr @.faila.1220, i64 %10, ptr @.failb.1221, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1222, ptr @.faila.1223, i64 %10, ptr @.failb.1224, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1225, ptr @.faila.1226, i64 %9, ptr @.failb.1227, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %if.end
  ...
  call void @__polaron_fail(ptr @.contract.1228, ptr @.cl.1229, i64 %contract.l, ptr @.cr.1230, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1233, ptr @.faila.1234, i64 %25, ptr @.failb.1235, i64 %arr.len, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %sc.rhs
  call void @__polaron_fail(ptr @.fail.1236, ptr @.faila.1237, i64 %38, ptr @.failb.1238, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad43:                                        ; preds = %while.body
  call void @__polaron_fail(ptr @.fail.1239, ptr @.faila.1240, i64 %34, ptr @.failb.1241, i64 %arr.len41, i32 70)
  unreachable
...
idx.bad52:                                        ; preds = %idx.ok44
  call void @__polaron_fail(ptr @.fail.1242, ptr @.faila.1243, i64 %43, ptr @.failb.1244, i64 %arr.len50, i32 70)
  unreachable
...
idx.bad64:                                        ; preds = %while.end
  call void @__polaron_fail(ptr @.fail.1245, ptr @.faila.1246, i64 %36, ptr @.failb.1247, i64 %arr.len62, i32 70)
  unreachable
...
idx.bad97:                                        ; preds = %div.ok
  call void @__polaron_fail(ptr @.fail.1249, ptr @.faila.1250, i64 %51, ptr @.failb.1251, i64 %arr.len95, i32 70)
  unreachable
...
idx.bad107:                                       ; preds = %idx.ok98
  call void @__polaron_fail(ptr @.fail.1252, ptr @.faila.1253, i64 %53, ptr @.failb.1254, i64 %arr.len105, i32 70)
  unreachable
...
contract.fail120:                                 ; preds = %if.then112
  call void @__polaron_fail(ptr @.contract.1255, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad145:                                       ; preds = %while.body126
  call void @__polaron_fail(ptr @.fail.1256, ptr @.faila.1257, i64 %64, ptr @.failb.1258, i64 %arr.len143, i32 70)
  unreachable
...
idx.bad155:                                       ; preds = %idx.ok146
  call void @__polaron_fail(ptr @.fail.1259, ptr @.faila.1260, i64 %68, ptr @.failb.1261, i64 %arr.len153, i32 70)
  unreachable
...
idx.bad166:                                       ; preds = %if.then160
  call void @__polaron_fail(ptr @.fail.1262, ptr @.faila.1263, i64 %72, ptr @.failb.1264, i64 %arr.len164, i32 70)
  unreachable
...
idx.bad175:                                       ; preds = %idx.ok167
  call void @__polaron_fail(ptr @.fail.1265, ptr @.faila.1266, i64 %75, ptr @.failb.1267, i64 %arr.len173, i32 70)
  unreachable
...
idx.bad186:                                       ; preds = %if.else
  call void @__polaron_fail(ptr @.fail.1268, ptr @.faila.1269, i64 %73, ptr @.failb.1270, i64 %arr.len184, i32 70)
  unreachable
...
idx.bad195:                                       ; preds = %idx.ok187
  call void @__polaron_fail(ptr @.fail.1271, ptr @.faila.1272, i64 %78, ptr @.failb.1273, i64 %arr.len193, i32 70)
  unreachable
...
idx.bad212:                                       ; preds = %while.body204
  call void @__polaron_fail(ptr @.fail.1274, ptr @.faila.1275, i64 %83, ptr @.failb.1276, i64 %arr.len210, i32 70)
  unreachable
...
idx.bad221:                                       ; preds = %idx.ok213
  call void @__polaron_fail(ptr @.fail.1277, ptr @.faila.1278, i64 %84, ptr @.failb.1279, i64 %arr.len219, i32 70)
  unreachable
...
idx.bad238:                                       ; preds = %while.body230
  call void @__polaron_fail(ptr @.fail.1280, ptr @.faila.1281, i64 %90, ptr @.failb.1282, i64 %arr.len236, i32 70)
  unreachable
...
idx.bad247:                                       ; preds = %idx.ok239
  call void @__polaron_fail(ptr @.fail.1283, ptr @.faila.1284, i64 %91, ptr @.failb.1285, i64 %arr.len245, i32 70)
  unreachable
...
idx.bad267:                                       ; preds = %for.body257
  call void @__polaron_fail(ptr @.fail.1286, ptr @.faila.1287, i64 %97, ptr @.failb.1288, i64 %arr.len265, i32 70)
  unreachable
...
idx.bad275:                                       ; preds = %idx.ok268
  call void @__polaron_fail(ptr @.fail.1289, ptr @.faila.1290, i64 %102, ptr @.failb.1291, i64 %arr.len273, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1293, ptr @.faila.1294, i64 %10, ptr @.failb.1295, i64 %arr.len, i32 70)
  unreachable
...
idx.bad18:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1296, ptr @.faila.1297, i64 %15, ptr @.failb.1298, i64 %arr.len16, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1299, ptr @.faila.1300, i64 0, ptr @.failb.1301, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1302, ptr @.faila.1303, i64 %12, ptr @.failb.1304, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %if.then25
  call void @__polaron_fail(ptr @.fail.1305, ptr @.faila.1306, i64 %19, ptr @.failb.1307, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1308, ptr @.faila.1309, i64 0, ptr @.failb.1310, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1311, ptr @.faila.1312, i64 %12, ptr @.failb.1313, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %if.then25
  call void @__polaron_fail(ptr @.fail.1314, ptr @.faila.1315, i64 %19, ptr @.failb.1316, i64 %arr.len30, i32 70)
  unreachable
...
entry:
  %strcpy = call ptr @__polaron_str_copy(ptr @.strobj.1328)
  ret ptr %strcpy
}
...
entry:
  %strcpy = call ptr @__polaron_str_copy(ptr @.strobj.1330)
  ret ptr %strcpy
}
...
define internal ptr @Strings.join(ptr %0, ptr %1) {
entry:
  %i = alloca i32, align 4
  ...
  %"ArrayList$String.copy" = alloca %"class.ArrayList$String", align 8
  %parts = alloca ptr, align 8
  %2 = call ptr @memcpy(ptr %"ArrayList$String.copy", ptr %0, i64 ptrtoint (ptr getelementptr (%"class.ArrayList$String", ptr null, i64 1) to i64))
  %3 = getelementptr inbounds %"class.ArrayList$String", ptr %0, i32 0, i32 1
  %4 = load ptr, ptr %3, align 8, !tbaa !0
  %arr.len = load i64, ptr %4, align 8
  %5 = mul i64 %arr.len, 8
  %6 = add i64 8, %5
  ...
  %8 = getelementptr inbounds %"class.ArrayList$String", ptr %"ArrayList$String.copy", i32 0, i32 1
  store ptr %arr.copy, ptr %8, align 8, !tbaa !0
  store ptr %"ArrayList$String.copy", ptr %parts, align 8
  store ptr %1, ptr %separator, align 8
...
for.cond:                                         ; preds = %for.update, %entry
  ...
  %parts2 = load ptr, ptr %parts, align 8
  %9 = call i32 @"ArrayList$String.size"(ptr %parts2)
...
for.end:                                          ; preds = %for.cond
  ...
  %16 = call ptr @StringBuilder.toString(ptr %sb9)
...
if.then:                                          ; preds = %for.body
  ...
  %separator5 = load ptr, ptr %separator, align 8
  %17 = call ptr @StringBuilder.append(ptr %sb4, ptr %separator5)
  br label %if.end
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %i8 = load i32, ptr %i, align 4
  %18 = call ptr @"ArrayList$String.get"(ptr %parts7, i32 %i8)
  %19 = call ptr @StringBuilder.append(ptr %sb6, ptr %18)
  call void @__polaron_str_free(ptr %18)
  br label %for.update
}

define internal ptr @Strings.replace(ptr %0, ptr %1, ptr %2) {
entry:
  %j = alloca i32, align 4
  %hit = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %str.len = getelementptr inbounds %String, ptr %target1, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %3 = trunc i64 %len to i32
  store i32 %3, ptr %tlen, align 4
  %tlen2 = load i32, ptr %tlen, align 4
  %4 = icmp eq i32 %tlen2, 0
  %5 = zext i1 %4 to i32
  br i1 %4, label %if.then, label %if.end
...
if.end:                                           ; preds = %entry
  ...
  %str.len5 = getelementptr inbounds %String, ptr %text4, i32 0, i32 0
  %len6 = load i64, ptr %str.len5, align 8
  %6 = trunc i64 %len6 to i32
...
while.body:                                       ; preds = %while.cond
  %i9 = load i32, ptr %i, align 4
  %tlen10 = load i32, ptr %tlen, align 4
  %9 = add i32 %i9, %tlen10
  %n11 = load i32, ptr %n, align 4
  %10 = icmp sle i32 %9, %n11
  %11 = zext i1 %10 to i32
  store i32 %11, ptr %hit, align 4
  store i32 0, ptr %j, align 4
  br label %while.cond12

while.end:                                        ; preds = %while.cond
  %sb45 = load ptr, ptr %sb, align 8
  %12 = call ptr @StringBuilder.toString(ptr %sb45)
  %strcpy46 = call ptr @__polaron_str_copy(ptr %12)
  call void @__polaron_str_free(ptr %12)
  ret ptr %strcpy46

while.cond12:                                     ; preds = %if.end28, %while.body
  %hit15 = load i32, ptr %hit, align 4
  %sc.a = icmp ne i32 %hit15, 0
  br i1 %sc.a, label %sc.rhs, label %sc.end
...
while.body13:                                     ; preds = %sc.end
  ...
  %13 = add i32 %i19, %j20
  %14 = sext i32 %13 to i64
  %str.data = getelementptr inbounds %String, ptr %text18, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %ch.addr = getelementptr i8, ptr %data, i64 %14
  %ch = load i8, ptr %ch.addr, align 1
  %15 = zext i8 %ch to i32
  %target21 = load ptr, ptr %target, align 8
  %j22 = load i32, ptr %j, align 4
  %16 = sext i32 %j22 to i64
  %str.data23 = getelementptr inbounds %String, ptr %target21, i32 0, i32 1
  %data24 = load ptr, ptr %str.data23, align 8
  %ch.addr25 = getelementptr i8, ptr %data24, i64 %16
  %ch26 = load i8, ptr %ch.addr25, align 1
  %17 = zext i8 %ch26 to i32
  %18 = icmp ne i32 %15, %17
  %19 = zext i1 %18 to i32
  br i1 %18, label %if.then27, label %if.end28

while.end14:                                      ; preds = %sc.end
  %hit30 = load i32, ptr %hit, align 4
  %20 = icmp ne i32 %hit30, 0
  br i1 %20, label %if.then31, label %if.else

sc.rhs:                                           ; preds = %while.cond12
  %j16 = load i32, ptr %j, align 4
  %tlen17 = load i32, ptr %tlen, align 4
  %21 = icmp slt i32 %j16, %tlen17
  %22 = zext i1 %21 to i32
...
if.then27:                                        ; preds = %while.body13
  store i32 0, ptr %hit, align 4
  br label %if.end28

if.end28:                                         ; preds = %if.then27, %while.body13
  %j29 = load i32, ptr %j, align 4
  %24 = add i32 %j29, 1
  store i32 %24, ptr %j, align 4
  br label %while.cond12

if.then31:                                        ; preds = %while.end14
  %sb33 = load ptr, ptr %sb, align 8
  %replacement34 = load ptr, ptr %replacement, align 8
  %25 = call ptr @StringBuilder.append(ptr %sb33, ptr %replacement34)
  %i35 = load i32, ptr %i, align 4
  %tlen36 = load i32, ptr %tlen, align 4
  %26 = add i32 %i35, %tlen36
...
if.else:                                          ; preds = %while.end14
  ...
  %str.data40 = getelementptr inbounds %String, ptr %text38, i32 0, i32 1
  %data41 = load ptr, ptr %str.data40, align 8
  %ch.addr42 = getelementptr i8, ptr %data41, i64 %27
  %ch43 = load i8, ptr %ch.addr42, align 1
  %28 = zext i8 %ch43 to i32
  %29 = call ptr @StringBuilder.appendChar(ptr %sb37, i32 %28)
...
define internal ptr @Strings.padLeft(ptr %0, i32 %1, ptr %2) {
entry:
  ...
  store ptr %2, ptr %pad, align 8
  %text1 = load ptr, ptr %text, align 8
  %str.len = getelementptr inbounds %String, ptr %text1, i32 0, i32 0
  %len = load i64, ptr %str.len, align 8
  %3 = trunc i64 %len to i32
  %width2 = load i32, ptr %width, align 4
  %4 = icmp sge i32 %3, %width2
  %5 = zext i1 %4 to i32
  br i1 %4, label %if.then, label %if.end
...
if.end:                                           ; preds = %entry
  %pad4 = load ptr, ptr %pad, align 8
  %width5 = load i32, ptr %width, align 4
  ...
  %6 = trunc i64 %len8 to i32
  %7 = sub i32 %width5, %6
  %8 = sext i32 %7 to i64
  %rep.len = alloca i64, align 8
  %str.data = getelementptr inbounds %String, ptr %pad4, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %str.len9 = getelementptr inbounds %String, ptr %pad4, i32 0, i32 0
  %len10 = load i64, ptr %str.len9, align 8
  %9 = call ptr @__polaron_str_repeat(ptr %data, i64 %len10, i64 %8, ptr %rep.len)
  %10 = load i64, ptr %rep.len, align 8
  %newstr = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %11 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 0
  ...
  %str.len12 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 0
  %len13 = load i64, ptr %str.len12, align 8
  %str.len14 = getelementptr inbounds %String, ptr %text11, i32 0, i32 0
  %len15 = load i64, ptr %str.len14, align 8
  %14 = add i64 %len13, %len15
  %15 = add i64 %14, 1
  %cat.buf = call ptr @__polaron_malloc(i64 %15)
  %str.data16 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 1
  %data17 = load ptr, ptr %str.data16, align 8
  %16 = call ptr @memcpy(ptr %cat.buf, ptr %data17, i64 %len13)
  %str.data18 = getelementptr inbounds %String, ptr %text11, i32 0, i32 1
  %data19 = load ptr, ptr %str.data18, align 8
  %17 = getelementptr i8, ptr %cat.buf, i64 %len13
  %18 = call ptr @memcpy(ptr %17, ptr %data19, i64 %len15)
  %19 = getelementptr i8, ptr %cat.buf, i64 %14
  store i8 0, ptr %19, align 1
  %newstr20 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %20 = getelementptr inbounds %String, ptr %newstr20, i32 0, i32 0
  store i64 %14, ptr %20, align 8
  %21 = getelementptr inbounds %String, ptr %newstr20, i32 0, i32 1
  store ptr %cat.buf, ptr %21, align 8
  %22 = getelementptr inbounds %String, ptr %newstr20, i32 0, i32 2
  store i64 0, ptr %22, align 8
  %strcpy21 = call ptr @__polaron_str_copy(ptr %newstr20)
  call void @__polaron_str_free(ptr %newstr)
  call void @__polaron_str_free(ptr %newstr20)
  ret ptr %strcpy21
}

define internal ptr @Strings.padRight(ptr %0, i32 %1, ptr %2) {
entry:
  %pad = alloca ptr, align 8
  %width = alloca i32, align 4
  %text = alloca ptr, align 8
...
if.end:                                           ; preds = %entry
  %text4 = load ptr, ptr %text, align 8
  %pad5 = load ptr, ptr %pad, align 8
  %width6 = load i32, ptr %width, align 4
  %text7 = load ptr, ptr %text, align 8
  %str.len8 = getelementptr inbounds %String, ptr %text7, i32 0, i32 0
  %len9 = load i64, ptr %str.len8, align 8
  %6 = trunc i64 %len9 to i32
  %7 = sub i32 %width6, %6
  %8 = sext i32 %7 to i64
  %rep.len = alloca i64, align 8
  %str.data = getelementptr inbounds %String, ptr %pad5, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %str.len10 = getelementptr inbounds %String, ptr %pad5, i32 0, i32 0
  %len11 = load i64, ptr %str.len10, align 8
  %9 = call ptr @__polaron_str_repeat(ptr %data, i64 %len11, i64 %8, ptr %rep.len)
  %10 = load i64, ptr %rep.len, align 8
  %newstr = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %11 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 0
  store i64 %10, ptr %11, align 8
  ...
  %13 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 2
  store i64 0, ptr %13, align 8
  %str.len12 = getelementptr inbounds %String, ptr %text4, i32 0, i32 0
  %len13 = load i64, ptr %str.len12, align 8
  %str.len14 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 0
  %len15 = load i64, ptr %str.len14, align 8
  %14 = add i64 %len13, %len15
  %15 = add i64 %14, 1
  %cat.buf = call ptr @__polaron_malloc(i64 %15)
  %str.data16 = getelementptr inbounds %String, ptr %text4, i32 0, i32 1
  %data17 = load ptr, ptr %str.data16, align 8
  %16 = call ptr @memcpy(ptr %cat.buf, ptr %data17, i64 %len13)
  %str.data18 = getelementptr inbounds %String, ptr %newstr, i32 0, i32 1
  %data19 = load ptr, ptr %str.data18, align 8
  %17 = getelementptr i8, ptr %cat.buf, i64 %len13
  %18 = call ptr @memcpy(ptr %17, ptr %data19, i64 %len15)
  %19 = getelementptr i8, ptr %cat.buf, i64 %14
...
entry:
  %strcpy = call ptr @__polaron_str_copy(ptr @.strobj.5329)
  %0 = load ptr, ptr @Test.criterion, align 8
  call void @__polaron_str_free(ptr %0)
  store ptr %strcpy, ptr @Test.criterion, align 8
  %strcpy1 = call ptr @__polaron_str_copy(ptr @.strobj.5331)
