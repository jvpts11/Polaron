; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/regions.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/regions.pol"
...
@.str = private unnamed_addr constant [15 x i8] c"a = %d b = %d\0A\00", align 1
...
entry:
  ...
  %years1 = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 1
  %years2 = load i32, ptr %years, align 4
  store i32 %years2, ptr %years1, align 4, !tbaa !4
  ret void
}

define internal i32 @Dog.getAge(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %years = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 1
  %years1 = load i32, ptr %years, align 4, !tbaa !4
  ret i32 %years1
}
...
entry:
  ...
  %exc.cleanup33 = alloca ptr, align 8
  %exc.thrown29 = alloca ptr, align 8
  %exc.cleanup24 = alloca ptr, align 8
...
rgn.ok:                                           ; preds = %argv.end
  ...
  invoke void @Dog.Dog(ptr %rgn.obj, i32 3)
...
rgn.ok12:                                         ; preds = %invoke.cont
  ...
  invoke void @Dog.Dog(ptr %rgn.obj7, i32 7)
...
invoke.cont21:                                    ; preds = %rgn.ok12
  ...
  %24 = invoke i32 @Dog.getAge(ptr %a22)
          to label %invoke.cont30 unwind label %cleanup23

cleanup23:                                        ; preds = %invoke.cont21
  %25 = catchswitch within none [label %cleanup.dispatch25] unwind to caller

cleanup.dispatch25:                               ; preds = %cleanup23
  %26 = catchpad within %25 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.cleanup24]
  catchret from %26 to label %cleanup.run26

cleanup.run26:                                    ; preds = %cleanup.dispatch25
  %cleanup.obj27 = load ptr, ptr %exc.cleanup24, align 8
  %region28 = load ptr, ptr %pen, align 8
  call void @__polaron_region_release(ptr %region28)
  store ptr %cleanup.obj27, ptr %exc.thrown29, align 8
  call void @_CxxThrowException(ptr %exc.thrown29, ptr @_TI1PEAX)
  unreachable

invoke.cont30:                                    ; preds = %invoke.cont21
  %b31 = load ptr, ptr %b, align 8
  %27 = invoke i32 @Dog.getAge(ptr %b31)
          to label %invoke.cont39 unwind label %cleanup32

cleanup32:                                        ; preds = %invoke.cont30
  %28 = catchswitch within none [label %cleanup.dispatch34] unwind to caller

cleanup.dispatch34:                               ; preds = %cleanup32
  %29 = catchpad within %28 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.cleanup33]
  catchret from %29 to label %cleanup.run35

cleanup.run35:                                    ; preds = %cleanup.dispatch34
  %cleanup.obj36 = load ptr, ptr %exc.cleanup33, align 8
  %region37 = load ptr, ptr %pen, align 8
  call void @__polaron_region_release(ptr %region37)
  store ptr %cleanup.obj36, ptr %exc.thrown38, align 8
  call void @_CxxThrowException(ptr %exc.thrown38, ptr @_TI1PEAX)
  unreachable

invoke.cont39:                                    ; preds = %invoke.cont30
  %30 = call i32 (ptr, ...) @printf(ptr @.str, i32 %24, i32 %27)
  %31 = load ptr, ptr %pen, align 8
  call void @__polaron_region_release(ptr %31)
  store ptr null, ptr %pen, align 8
  %region40 = load ptr, ptr %pen, align 8
  call void @__polaron_region_release(ptr %region40)
  ret i32 0
}
