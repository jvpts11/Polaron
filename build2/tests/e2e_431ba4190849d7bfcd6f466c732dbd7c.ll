; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/cascade_graph.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/cascade_graph.pol"
...
entry:
  ...
  %owner = getelementptr inbounds %class.Node, ptr %0, i32 0, i32 3
  store ptr null, ptr %owner, align 8, !tbaa !0
  ret void
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %Node.obj5 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Node, ptr null, i64 1) to i64))
  call void @Node.Node(ptr %Node.obj5)
  store ptr %Node.obj5, ptr %c, align 8
  %c6 = load ptr, ptr %c, align 8
  %id7 = getelementptr inbounds %class.Node, ptr %c6, i32 0, i32 1
  store i32 3, ptr %id7, align 4, !tbaa !4
  %a8 = load ptr, ptr %a, align 8
  %next = getelementptr inbounds %class.Node, ptr %a8, i32 0, i32 2
  %b9 = load ptr, ptr %b, align 8
  store ptr %b9, ptr %next, align 8, !tbaa !0
  %b10 = load ptr, ptr %b, align 8
  %next11 = getelementptr inbounds %class.Node, ptr %b10, i32 0, i32 2
  %c12 = load ptr, ptr %c, align 8
  store ptr %c12, ptr %next11, align 8, !tbaa !0
  %c13 = load ptr, ptr %c, align 8
  %next14 = getelementptr inbounds %class.Node, ptr %c13, i32 0, i32 2
  %a15 = load ptr, ptr %a, align 8
  store ptr %a15, ptr %next14, align 8, !tbaa !0
  %b16 = load ptr, ptr %b, align 8
  %owner = getelementptr inbounds %class.Node, ptr %b16, i32 0, i32 3
  %a17 = load ptr, ptr %a, align 8
  store ptr %a17, ptr %owner, align 8, !tbaa !0
  %c18 = load ptr, ptr %c, align 8
  %owner19 = getelementptr inbounds %class.Node, ptr %c18, i32 0, i32 3
  %a20 = load ptr, ptr %a, align 8
  store ptr %a20, ptr %owner19, align 8, !tbaa !0
  %a21 = load ptr, ptr %a, align 8
  %16 = call ptr @__polaron_ptrset_new()
  call void @__cascade.0.0.Node(ptr %a21, ptr %16, i32 -1)
...
recurse:                                          ; preds = %dtor.free
  ...
  call void @__cascade.0.0.Node(ptr %next1, ptr %1, i32 %10)
  br label %after
