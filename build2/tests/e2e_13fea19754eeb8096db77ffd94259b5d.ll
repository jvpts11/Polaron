; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/money.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/money.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%class.Money = type { ptr, i64 }
...
@Money.vtable = private constant [349 x ptr] [ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @Object.equals, ptr @Object.hashCode, ptr @Object.equalsKey, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @Money.plus, ptr @Money.minus, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @Money.getCents, ptr @Money.times, ptr @Money.format, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null]
@.str = private unnamed_addr constant [28 x i8] c"a=%s sum=%s prod=%s neg=%s\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %Money.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Money, ptr null, i64 1) to i64))
  call void @Money.Money(ptr %Money.obj, i64 1234)
  store ptr %Money.obj, ptr %a, align 8
  %Money.obj1 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Money, ptr null, i64 1) to i64))
  call void @Money.Money(ptr %Money.obj1, i64 250)
  store ptr %Money.obj1, ptr %b, align 8
  %Money.obj2 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Money, ptr null, i64 1) to i64))
  call void @Money.Money(ptr %Money.obj2, i64 500)
  store ptr %Money.obj2, ptr %c, align 8
  %Money.obj3 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Money, ptr null, i64 1) to i64))
  call void @Money.Money(ptr %Money.obj3, i64 -75)
  store ptr %Money.obj3, ptr %neg, align 8
  %a4 = load ptr, ptr %a, align 8
  %16 = call ptr @Money.format(ptr %a4)
  %str.data = getelementptr inbounds %String, ptr %16, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %a5 = load ptr, ptr %a, align 8
  %b6 = load ptr, ptr %b, align 8
  %17 = call ptr @Money.plus(ptr %a5, ptr %b6)
  %18 = call ptr @Money.format(ptr %17)
  %str.data7 = getelementptr inbounds %String, ptr %18, i32 0, i32 1
  %data8 = load ptr, ptr %str.data7, align 8
  %c9 = load ptr, ptr %c, align 8
  %19 = call ptr @Money.times(ptr %c9, i32 3)
  %20 = call ptr @Money.format(ptr %19)
  %str.data10 = getelementptr inbounds %String, ptr %20, i32 0, i32 1
  %data11 = load ptr, ptr %str.data10, align 8
  %neg12 = load ptr, ptr %neg, align 8
  %21 = call ptr @Money.format(ptr %neg12)
  %str.data13 = getelementptr inbounds %String, ptr %21, i32 0, i32 1
  %data14 = load ptr, ptr %str.data13, align 8
  %22 = call i32 (ptr, ...) @printf(ptr @.str, ptr %data, ptr %data8, ptr %data11, ptr %data14)
...
define internal void @Money.Money(ptr %0, i64 %1) {
entry:
  %cents = alloca i64, align 8
  store i64 %1, ptr %cents, align 8
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.Money, ptr %0, i32 0, i32 0
  store ptr @Money.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %cents1 = getelementptr inbounds %class.Money, ptr %0, i32 0, i32 1
  %cents2 = load i64, ptr %cents, align 8
  store i64 %cents2, ptr %cents1, align 8, !tbaa !6
  ret void
}

define internal i64 @Money.getCents(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %cents = getelementptr inbounds %class.Money, ptr %0, i32 0, i32 1
  %cents1 = load i64, ptr %cents, align 8, !tbaa !6
  ret i64 %cents1
}

define internal ptr @Money.plus(ptr nonnull align 8 dereferenceable(16) %0, ptr %1) {
entry:
  %Money.copy = alloca %class.Money, align 8
  %o = alloca ptr, align 8
  %2 = call ptr @memcpy(ptr %Money.copy, ptr %1, i64 ptrtoint (ptr getelementptr (%class.Money, ptr null, i64 1) to i64))
  store ptr %Money.copy, ptr %o, align 8
  %Money.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Money, ptr null, i64 1) to i64))
  %cents = getelementptr inbounds %class.Money, ptr %0, i32 0, i32 1
  %cents1 = load i64, ptr %cents, align 8, !tbaa !6
  %o2 = load ptr, ptr %o, align 8
  %3 = call i64 @Money.getCents(ptr %o2)
  %4 = add i64 %cents1, %3
  call void @Money.Money(ptr %Money.obj, i64 %4)
  ret ptr %Money.obj
}

define internal ptr @Money.minus(ptr nonnull align 8 dereferenceable(16) %0, ptr %1) {
entry:
  %Money.copy = alloca %class.Money, align 8
  %o = alloca ptr, align 8
  %2 = call ptr @memcpy(ptr %Money.copy, ptr %1, i64 ptrtoint (ptr getelementptr (%class.Money, ptr null, i64 1) to i64))
...
define internal ptr @Money.times(ptr nonnull align 8 dereferenceable(16) %0, i32 %1) {
entry:
  ...
  %cents = getelementptr inbounds %class.Money, ptr %0, i32 0, i32 1
  %cents1 = load i64, ptr %cents, align 8, !tbaa !6
  %factor2 = load i32, ptr %factor, align 4
  %2 = sext i32 %factor2 to i64
  %3 = mul i64 %cents1, %2
  call void @Money.Money(ptr %Money.obj, i64 %3)
  ret ptr %Money.obj
}

define internal ptr @Money.format(ptr nonnull align 8 dereferenceable(16) %0) personality ptr @__CxxFrameHandler3 {
entry:
  %rem = alloca i64, align 8
  %exc.thrown11 = alloca ptr, align 8
  %dollars = alloca i64, align 8
  %exc.thrown = alloca ptr, align 8
  %sb = alloca ptr, align 8
  %c = alloca i64, align 8
  %cents = getelementptr inbounds %class.Money, ptr %0, i32 0, i32 1
  %cents1 = load i64, ptr %cents, align 8, !tbaa !6
  store i64 %cents1, ptr %c, align 8
...
if.then:                                          ; preds = %entry
  ...
  %3 = call ptr @StringBuilder.appendChar(ptr %sb3, i32 45)
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %5 = call ptr @StringBuilder.appendChar(ptr %sb5, i32 36)
  %c6 = load i64, ptr %c, align 8
  %6 = icmp eq i64 %c6, -9223372036854775808
  %7 = and i1 %6, false
  %8 = or i1 false, %7
...
div.ok:                                           ; preds = %if.end
  %9 = sdiv i64 %c6, 100
  store i64 %9, ptr %dollars, align 8
  %c7 = load i64, ptr %c, align 8
  %10 = icmp eq i64 %c7, -9223372036854775808
  %11 = and i1 %10, false
  %12 = or i1 false, %11
  br i1 %12, label %div.bad8, label %div.ok9
...
div.ok9:                                          ; preds = %div.ok
  %13 = srem i64 %c7, 100
  store i64 %13, ptr %rem, align 8
  %sb12 = load ptr, ptr %sb, align 8
  %dollars13 = load i64, ptr %dollars, align 8
  %14 = trunc i64 %dollars13 to i32
  %15 = call ptr @StringBuilder.appendInt(ptr %sb12, i32 %14)
  %sb14 = load ptr, ptr %sb, align 8
  %16 = call ptr @StringBuilder.appendChar(ptr %sb14, i32 46)
  %rem15 = load i64, ptr %rem, align 8
  %17 = icmp slt i64 %rem15, 10
  %18 = zext i1 %17 to i32
  br i1 %17, label %if.then16, label %if.end17

if.then16:                                        ; preds = %div.ok9
  %sb18 = load ptr, ptr %sb, align 8
  %19 = call ptr @StringBuilder.appendChar(ptr %sb18, i32 48)
  br label %if.end17

if.end17:                                         ; preds = %if.then16, %div.ok9
  %sb19 = load ptr, ptr %sb, align 8
  %rem20 = load i64, ptr %rem, align 8
  %20 = trunc i64 %rem20 to i32
  %21 = call ptr @StringBuilder.appendInt(ptr %sb19, i32 %20)
  %sb21 = load ptr, ptr %sb, align 8
  %22 = call ptr @StringBuilder.toString(ptr %sb21)
  %strcpy = call ptr @__polaron_str_copy(ptr %22)
