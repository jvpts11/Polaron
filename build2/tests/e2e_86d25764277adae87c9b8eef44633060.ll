; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/atomic_counter.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/atomic_counter.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %atomic.value = getelementptr inbounds %"class.atomic$int", ptr %counter8, i32 0, i32 1
  %atomic.get = load atomic i32, ptr %atomic.value seq_cst, align 4, !tbaa !0
  %19 = call i32 (ptr, ...) @printf(ptr @.str, i32 %atomic.get)
  ret i32 0
}
