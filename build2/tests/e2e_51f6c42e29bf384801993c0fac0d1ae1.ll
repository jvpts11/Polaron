; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/enum_java.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/enum_java.pol"
...
@.str = private unnamed_addr constant [22 x i8] c"earth = %d mars = %d\0A\00", align 1
...
enumc.done:                                       ; preds = %enumc.init, %argv.end
  %Planet1 = load ptr, ptr @Planet.EARTH.__inst, align 8
  %17 = call i32 @Planet.density(ptr %Planet1)
  %enum.cur2 = load ptr, ptr @Planet.MARS.__inst, align 8
  %18 = icmp eq ptr %enum.cur2, null
  br i1 %18, label %enumc.init3, label %enumc.done4

enumc.init3:                                      ; preds = %enumc.done
  %Planet5 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Planet, ptr null, i64 1) to i64))
  call void @Planet.Planet(ptr %Planet5, i32 30, i32 3)
  store ptr %Planet5, ptr @Planet.MARS.__inst, align 8
  br label %enumc.done4

enumc.done4:                                      ; preds = %enumc.init3, %enumc.done
  %Planet6 = load ptr, ptr @Planet.MARS.__inst, align 8
  %19 = call i32 @Planet.density(ptr %Planet6)
