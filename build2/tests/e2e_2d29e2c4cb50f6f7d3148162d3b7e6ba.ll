; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_capture.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/lambda_capture.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %addBase1 = load ptr, ptr %addBase, align 8
  %code = load ptr, ptr %addBase1, align 8
  %19 = getelementptr ptr, ptr %addBase1, i32 1
  %env2 = load ptr, ptr %19, align 8
  %20 = call i32 %code(ptr %env2, i32 5)
  %21 = call i32 (ptr, ...) @printf(ptr @.str, i32 %20)
  ret i32 0
}
