...
@.str = private unnamed_addr constant [18 x i8] c"moved value = %d\0A\00", align 1
...
define internal void @Handle.Handle(ptr %0, i32 %1) {
entry:
  %n = alloca i32, align 4
  store i32 %1, ptr %n, align 4
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.Handle, ptr %0, i32 0, i32 0
  store ptr @Handle.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %id = getelementptr inbounds %class.Handle, ptr %0, i32 0, i32 1
  %n1 = load i32, ptr %n, align 4
  store i32 %n1, ptr %id, align 4, !tbaa !4
  ret void
}

define internal i32 @Handle.value(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %id = getelementptr inbounds %class.Handle, ptr %0, i32 0, i32 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %Handle.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Handle, ptr null, i64 1) to i64))
  call void @Handle.Handle(ptr %Handle.obj, i32 7)
  store ptr %Handle.obj, ptr %a, align 8
  %a1 = load ptr, ptr %a, align 8
  store ptr %a1, ptr %b, align 8
  %b2 = load ptr, ptr %b, align 8
  %16 = call i32 @Handle.value(ptr %b2)
