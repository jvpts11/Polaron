; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/utf8_decode.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/utf8_decode.pol"
...
@.strdata = private constant [9 x i8] c"caf\C3\A9\E2\82\AC\00"
@.strobj = private global %String { i64 8, ptr @.strdata, i64 0 }
@.str = private unnamed_addr constant [57 x i8] c"bytes=%d chars=%d cp3=%d width3=%d cps_n=%d cps_last=%d\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @Utf8.codepoints(ptr %s1)
  store ptr %16, ptr %cps, align 8
  ...
  %18 = call i32 @Utf8.length(ptr %s3)
  %s4 = load ptr, ptr %s, align 8
  %19 = call i32 @Utf8.codepointAt(ptr %s4, i32 3)
  %s5 = load ptr, ptr %s, align 8
  %20 = call i32 @Utf8.widthAt(ptr %s5, i32 3)
  %cps6 = load ptr, ptr %cps, align 8
  %21 = call i32 @"ArrayList$int.size"(ptr %cps6)
  %cps7 = load ptr, ptr %cps, align 8
  %22 = call i32 @"ArrayList$int.get"(ptr %cps7, i32 4)
...
define internal i32 @Utf8.seqLen(i32 %0) {
entry:
  %lead = alloca i32, align 4
  store i32 %0, ptr %lead, align 4
  %lead1 = load i32, ptr %lead, align 4
  %1 = icmp slt i32 %lead1, 128
  %2 = zext i1 %1 to i32
...
if.end:                                           ; preds = %entry
  %lead2 = load i32, ptr %lead, align 4
  %3 = icmp sge i32 %lead2, 240
  %4 = zext i1 %3 to i32
...
if.end4:                                          ; preds = %if.end
  %lead5 = load i32, ptr %lead, align 4
  %5 = icmp sge i32 %lead5, 224
  %6 = zext i1 %5 to i32
...
if.end7:                                          ; preds = %if.end4
  %lead8 = load i32, ptr %lead, align 4
  %7 = icmp sge i32 %lead8, 192
  %8 = zext i1 %7 to i32
...
define internal i32 @Utf8.widthAt(ptr %0, i32 %1) {
entry:
  %i = alloca i32, align 4
  %s = alloca ptr, align 8
  ...
  %3 = zext i8 %ch to i32
  %4 = call i32 @Utf8.seqLen(i32 %3)
  ret i32 %4
}

define internal i32 @Utf8.codepointAt(ptr %0, i32 %1) {
entry:
  %k = alloca i32, align 4
  ...
  %ch = load i8, ptr %ch.addr, align 1
  %3 = zext i8 %ch to i32
  store i32 %3, ptr %lead, align 4
  %lead3 = load i32, ptr %lead, align 4
  %4 = call i32 @Utf8.seqLen(i32 %lead3)
...
if.then7:                                         ; preds = %if.end
  %lead9 = load i32, ptr %lead, align 4
  %9 = sub i32 %lead9, 192
...
if.end8:                                          ; preds = %if.then7, %if.end
  %n10 = load i32, ptr %n, align 4
  %10 = icmp eq i32 %n10, 3
  %11 = zext i1 %10 to i32
  br i1 %10, label %if.then11, label %if.end12

if.then11:                                        ; preds = %if.end8
  %lead13 = load i32, ptr %lead, align 4
  %12 = sub i32 %lead13, 224
  store i32 %12, ptr %cp, align 4
  br label %if.end12

if.end12:                                         ; preds = %if.then11, %if.end8
  %n14 = load i32, ptr %n, align 4
  %13 = icmp eq i32 %n14, 4
  %14 = zext i1 %13 to i32
  br i1 %13, label %if.then15, label %if.end16

if.then15:                                        ; preds = %if.end12
  %lead17 = load i32, ptr %lead, align 4
  %15 = sub i32 %lead17, 240
  store i32 %15, ptr %cp, align 4
  br label %if.end16
...
for.cond:                                         ; preds = %for.update, %if.end16
  %k18 = load i32, ptr %k, align 4
  %n19 = load i32, ptr %n, align 4
  %16 = icmp slt i32 %k18, %n19
  %17 = zext i1 %16 to i32
  br i1 %16, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %cp20 = load i32, ptr %cp, align 4
  %18 = mul i32 %cp20, 64
  ...
  %str.data24 = getelementptr inbounds %String, ptr %s21, i32 0, i32 1
...
for.end:                                          ; preds = %for.cond
  %cp28 = load i32, ptr %cp, align 4
  ret i32 %cp28
}

define internal i32 @Utf8.length(ptr %0) {
entry:
  %i = alloca i32, align 4
...
define internal ptr @Utf8.codepoints(ptr %0) {
entry:
  %i = alloca i32, align 4
  %out = alloca ptr, align 8
  %s = alloca ptr, align 8
...
while.body:                                       ; preds = %while.cond
  ...
  %s4 = load ptr, ptr %s, align 8
  %i5 = load i32, ptr %i, align 4
  %4 = call i32 @Utf8.codepointAt(ptr %s4, i32 %i5)
  call void @"ArrayList$int.add"(ptr %out3, i32 %4)
  %i6 = load i32, ptr %i, align 4
  %s7 = load ptr, ptr %s, align 8
  %i8 = load i32, ptr %i, align 4
  %5 = sext i32 %i8 to i64
  %str.data = getelementptr inbounds %String, ptr %s7, i32 0, i32 1
  %data = load ptr, ptr %str.data, align 8
  %ch.addr = getelementptr i8, ptr %data, i64 %5
  %ch = load i8, ptr %ch.addr, align 1
  %6 = zext i8 %ch to i32
  %7 = call i32 @Utf8.seqLen(i32 %6)
  %8 = add i32 %i6, %7
