; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/finally_uncaught.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/finally_uncaught.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%class.MyError = type { ptr }
...
@.str.1 = private unnamed_addr constant [10 x i8] c"throwing\0A\00", align 1
...
@.str.3 = private unnamed_addr constant [15 x i8] c"inner finally\0A\00", align 1
@.str.4 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.5 = private unnamed_addr constant [15 x i8] c"inner finally\0A\00", align 1
@.str.6 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.7 = private unnamed_addr constant [14 x i8] c"outer caught\0A\00", align 1
...
entry:
  ...
  %exc.caught6 = alloca ptr, align 8
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 (ptr, ...) @printf(ptr @.str, ptr @.str.1)
  ...
  invoke void @MyError.MyError(ptr %MyError.obj)
          to label %invoke.cont unwind label %ehpad1

ehpad:                                            ; preds = %rethrow, %ehpad1
  %17 = catchswitch within none [label %catch.dispatch7] unwind to caller

try.cont:                                         ; preds = %catch.body, %try.cont2
  %18 = call i32 (ptr, ...) @printf(ptr @.str.8, ptr @.str.9)
  ret i32 0

ehpad1:                                           ; preds = %invoke.cont, %argv.end
  %19 = catchswitch within none [label %catch.dispatch] unwind label %ehpad

try.cont2:                                        ; No predecessors!
  %20 = call i32 (ptr, ...) @printf(ptr @.str.4, ptr @.str.5)
  br label %try.cont

invoke.cont:                                      ; preds = %argv.end
  store ptr %MyError.obj, ptr %e, align 8
  %e3 = load ptr, ptr %e, align 8
  store ptr %e3, ptr %exc.thrown, align 8
  invoke void @_CxxThrowException(ptr %exc.thrown, ptr @_TI1PEAX)
          to label %throw.cont unwind label %ehpad1

throw.cont:                                       ; preds = %invoke.cont
  unreachable

catch.dispatch:                                   ; preds = %ehpad1
  %21 = catchpad within %19 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught]
  %caught = load ptr, ptr %exc.caught, align 8
  %exc.vtbl = load ptr, ptr %caught, align 8
  catchret from %21 to label %rethrow
...
rethrow:                                          ; preds = %catch.dispatch
  ...
  invoke void @_CxxThrowException(ptr %exc.thrown4, ptr @_TI1PEAX)
          to label %throw.cont5 unwind label %ehpad

throw.cont5:                                      ; preds = %rethrow
  unreachable

catch.dispatch7:                                  ; preds = %ehpad
  %23 = catchpad within %17 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught6]
  %caught8 = load ptr, ptr %exc.caught6, align 8
  %exc.vtbl9 = load ptr, ptr %caught8, align 8
  %is = icmp eq ptr %exc.vtbl9, @MyError.vtable
  br i1 %is, label %catch.match, label %catch.next

catch.match:                                      ; preds = %catch.dispatch7
  store ptr %caught8, ptr %ex, align 8
  catchret from %23 to label %catch.body

catch.next:                                       ; preds = %catch.dispatch7
  catchret from %23 to label %rethrow10

catch.body:                                       ; preds = %catch.match
  %24 = call i32 (ptr, ...) @printf(ptr @.str.6, ptr @.str.7)
  br label %try.cont

rethrow10:                                        ; preds = %catch.next
  %rethrow.obj11 = load ptr, ptr %exc.caught6, align 8
  store ptr %rethrow.obj11, ptr %exc.thrown12, align 8
