; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_constraints.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_constraints.pol"
...
entry:
  ...
  %n1 = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 1
  %n2 = load i32, ptr %n, align 4
  store i32 %n2, ptr %n1, align 4, !tbaa !4
  ret void
}

define internal i32 @Dog.get(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %n = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 1
...
rgn.ok:                                           ; preds = %argv.end
  ...
  invoke void @Dog.Dog(ptr %rgn.obj, i32 42)
...
invoke.cont:                                      ; preds = %rgn.ok
  store ptr %rgn.obj, ptr %d, align 8
  %d4 = load ptr, ptr %d, align 8
  %21 = invoke i32 @Dog.get(ptr %d4)
