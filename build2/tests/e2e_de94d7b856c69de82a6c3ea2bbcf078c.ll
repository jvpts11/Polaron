; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_pool_parse.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/region_pool_parse.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  invoke void @Dog.Dog(ptr %rgn.slot, i32 3)
...
invoke.cont:                                      ; preds = %argv.end
  store ptr %rgn.slot, ptr %rex, align 8
  %rex3 = load ptr, ptr %rex, align 8
  %age = getelementptr inbounds %class.Dog, ptr %rex3, i32 0, i32 1
  %age4 = load i32, ptr %age, align 4, !tbaa !4
  %20 = call i32 (ptr, ...) @printf(ptr @.str, i32 %age4)
  %21 = load ptr, ptr %kennel, align 8
  call void @__polaron_region_release(ptr %21)
  store ptr null, ptr %kennel, align 8
  %region5 = load ptr, ptr %kennel, align 8
