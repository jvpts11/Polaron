; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/dowhile.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/dowhile.pol"
...
@.str.1 = private unnamed_addr constant [11 x i8] c"runs = %d\0A\00", align 1
...
do.body:                                          ; preds = %do.cond, %argv.end
...
do.cond:                                          ; preds = %do.body
  ...
  %18 = icmp slt i32 %n3, 10
  %19 = zext i1 %18 to i32
  br i1 %18, label %do.body, label %do.end

do.end:                                           ; preds = %do.cond
  %count4 = load i32, ptr %count, align 4
  %20 = call i32 (ptr, ...) @printf(ptr @.str, i32 %count4)
  store i32 0, ptr %runs, align 4
  br label %do.body5

do.body5:                                         ; preds = %do.cond6, %do.end
  %runs8 = load i32, ptr %runs, align 4
  %21 = add i32 %runs8, 1
  store i32 %21, ptr %runs, align 4
  br label %do.cond6

do.cond6:                                         ; preds = %do.body5
  %runs9 = load i32, ptr %runs, align 4
  %22 = icmp slt i32 %runs9, 0
  %23 = zext i1 %22 to i32
  br i1 %22, label %do.body5, label %do.end7

do.end7:                                          ; preds = %do.cond6
  %runs10 = load i32, ptr %runs, align 4
  %24 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 %runs10)
  ret i32 0
}
