; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/collection_sorted.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/collection_sorted.pol"
...
@__polaron_closure.1 = private unnamed_addr constant [2 x ptr] [ptr @__polaron_lambda_1, ptr null]
@.str = private unnamed_addr constant [20 x i8] c"asc=%d,%d,%d,%d,%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [19 x i8] c"desc0=%d orig0=%d\0A\00", align 1
...
@.contract.882 = private unnamed_addr constant [118 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.ArrayList$int\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.883 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.884 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.885 = private unnamed_addr constant [135 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.ArrayList$int\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.886 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:320:35  in ArrayList$int.add\0A\00", align 1
@.faila.887 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.888 = private unnamed_addr constant [7 x i8] c"length\00", align 1
...
@.fail.892 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:325:39  in ArrayList$int.add\0A\00", align 1
...
@.contract.895 = private unnamed_addr constant [121 x i8] c"contract violated: ensures\0A  --> <prelude>:315:36  in ArrayList$int.add\0A   |  ensures this.count == old(this.count) + 1\0A\00", align 1
@.contract.896 = private unnamed_addr constant [108 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.add\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.897 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.898 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.899 = private unnamed_addr constant [125 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.add\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.900 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:334:78  in ArrayList$int.ensureCapacity\0A\00", align 1
@.faila.901 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.902 = private unnamed_addr constant [7 x i8] c"length\00", align 1
...
@.contract.906 = private unnamed_addr constant [119 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.ensureCapacity\0A   |  invariant this.count >= 0;\0A\00", align 1
...
@.contract.909 = private unnamed_addr constant [136 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.ensureCapacity\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.910 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:345:21  in ArrayList$int.get\0A\00", align 1
...
@.fail.913 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:347:17  in ArrayList$int.get\0A\00", align 1
...
@.fail.916 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:351:51  in ArrayList$int.set\0A\00", align 1
...
@.contract.919 = private unnamed_addr constant [125 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.920 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:354:30  in ArrayList$int.set\0A\00", align 1
...
@.contract.923 = private unnamed_addr constant [125 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.set\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.924 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:358:21  in ArrayList$int.indexOf\0A\00", align 1
@.faila.925 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.926 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.927 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:369:21  in ArrayList$int.removeAt\0A\00", align 1
...
@.contract.930 = private unnamed_addr constant [113 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.removeAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.931 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.932 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.933 = private unnamed_addr constant [130 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.removeAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.934 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:373:34  in ArrayList$int.removeAt\0A\00", align 1
...
@.fail.944 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:379:51  in ArrayList$int.insertAt\0A\00", align 1
...
@.contract.947 = private unnamed_addr constant [113 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.948 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.949 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.950 = private unnamed_addr constant [130 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.951 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:384:78  in ArrayList$int.insertAt\0A\00", align 1
@.faila.952 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.953 = private unnamed_addr constant [7 x i8] c"length\00", align 1
...
@.fail.957 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:389:34  in ArrayList$int.insertAt\0A\00", align 1
...
@.fail.963 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:391:30  in ArrayList$int.insertAt\0A\00", align 1
...
@.contract.966 = private unnamed_addr constant [113 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.insertAt\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.967 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.968 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.969 = private unnamed_addr constant [130 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.insertAt\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.970 = private unnamed_addr constant [110 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.clear\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.971 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.972 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.973 = private unnamed_addr constant [127 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.clear\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.974 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:405:71  in ArrayList$int.toArray\0A\00", align 1
...
@.fail.980 = private unnamed_addr constant [91 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:416:70  in ArrayList$int.forEach\0A\00", align 1
...
@.fail.983 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:21  in ArrayList$int.filter\0A\00", align 1
...
@.fail.986 = private unnamed_addr constant [90 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:422:54  in ArrayList$int.filter\0A\00", align 1
...
@.fail.989 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:439:21  in ArrayList$int.any\0A\00", align 1
...
@.fail.992 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:445:21  in ArrayList$int.all\0A\00", align 1
...
@.fail.995 = private unnamed_addr constant [89 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:452:21  in ArrayList$int.count\0A\00", align 1
...
@.fail.998 = private unnamed_addr constant [92 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:462:71  in ArrayList$int.sortedBy\0A\00", align 1
...
@.contract.1001 = private unnamed_addr constant [113 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.sortedBy\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.1002 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.1003 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1004 = private unnamed_addr constant [130 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.sortedBy\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.1005 = private unnamed_addr constant [136 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1006 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:478:25  in ArrayList$int.mergeSortRange\0A\00", align 1
@.faila.1007 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1008 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.1009 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:480:25  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.fail.1012 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.fail.1018 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:484:42  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.contract.1021 = private unnamed_addr constant [136 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1022 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.contract.1028 = private unnamed_addr constant [136 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1029 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$int.mergeSortRange\0A\00", align 1
@.faila.1030 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.1031 = private unnamed_addr constant [7 x i8] c"length\00", align 1
...
@.fail.1035 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.fail.1041 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.fail.1047 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.fail.1053 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.fail.1059 = private unnamed_addr constant [98 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$int.mergeSortRange\0A\00", align 1
...
@.contract.1065 = private unnamed_addr constant [136 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.1066 = private unnamed_addr constant [88 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:21  in ArrayList$int.find\0A\00", align 1
...
@.fail.1069 = private unnamed_addr constant [88 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:514:47  in ArrayList$int.find\0A\00", align 1
...
@.fail.1072 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:520:17  in ArrayList$int.min\0A\00", align 1
...
@.fail.1075 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:21  in ArrayList$int.min\0A\00", align 1
...
@.fail.1078 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:522:65  in ArrayList$int.min\0A\00", align 1
...
@.fail.1081 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:528:17  in ArrayList$int.max\0A\00", align 1
...
@.fail.1084 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:21  in ArrayList$int.max\0A\00", align 1
...
@.fail.1087 = private unnamed_addr constant [87 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:530:65  in ArrayList$int.max\0A\00", align 1
...
@.fail.5315 = private unnamed_addr constant [116 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:462:71  in ArrayList$int.sortedBy#0=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5316 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5317 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.5318 = private unnamed_addr constant [137 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.sortedBy#0=__polaron_lambda_1$fs\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.5319 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.5320 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.5321 = private unnamed_addr constant [154 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.sortedBy#0=__polaron_lambda_1$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.5322 = private unnamed_addr constant [160 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.5323 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:478:25  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5324 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5325 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5326 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:480:25  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5327 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5328 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5329 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5330 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5331 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5332 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5333 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5334 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5335 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:484:42  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5336 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5337 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.5338 = private unnamed_addr constant [160 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.5339 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
...
@.fail.5342 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
...
@.contract.5345 = private unnamed_addr constant [160 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.5346 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
...
@.fail.5349 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
...
@.fail.5352 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5353 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5354 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5355 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5356 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5357 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5358 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5359 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5360 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5361 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5362 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5363 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5364 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5365 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5366 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5367 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
...
@.fail.5370 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
...
@.fail.5373 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5374 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5375 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5376 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5377 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5378 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5379 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A\00", align 1
@.faila.5380 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5381 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.5382 = private unnamed_addr constant [160 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.5383 = private unnamed_addr constant [116 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:462:71  in ArrayList$int.sortedBy#0=__polaron_lambda_0$fs\0A\00", align 1
...
@.contract.5386 = private unnamed_addr constant [137 x i8] c"contract violated: invariant\0A  --> <prelude>:300:34  in ArrayList$int.sortedBy#0=__polaron_lambda_0$fs\0A   |  invariant this.count >= 0;\0A\00", align 1
@.cl.5387 = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr.5388 = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.5389 = private unnamed_addr constant [154 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.sortedBy#0=__polaron_lambda_0$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.contract.5390 = private unnamed_addr constant [160 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.5391 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:478:25  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5392 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5393 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5394 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:480:25  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5395 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5396 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5397 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5398 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5399 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5400 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:481:46  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5401 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5402 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5403 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:484:42  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5404 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5405 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.5406 = private unnamed_addr constant [160 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.5407 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5408 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5409 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5410 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:491:17  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5411 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5412 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.5413 = private unnamed_addr constant [160 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1
@.fail.5414 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5415 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5416 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5417 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:496:21  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5418 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5419 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5420 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5421 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5422 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5423 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:497:32  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5424 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5425 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5426 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5427 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5428 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5429 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:500:32  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5430 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5431 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5432 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5433 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5434 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5435 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:505:43  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5436 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5437 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5438 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5439 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5440 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5441 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:506:42  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5442 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5443 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5444 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5445 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5446 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.fail.5447 = private unnamed_addr constant [122 x i8] c"Polaron panic: array index out of bounds\0A  --> <prelude>:507:77  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A\00", align 1
@.faila.5448 = private unnamed_addr constant [6 x i8] c"index\00", align 1
@.failb.5449 = private unnamed_addr constant [7 x i8] c"length\00", align 1
@.contract.5450 = private unnamed_addr constant [160 x i8] c"contract violated: invariant\0A  --> <prelude>:301:34  in ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs\0A   |  invariant this.count <= this.data.length();\0A\00", align 1

define i32 @main(i32 %0, ptr %1) {
entry:
  %desc = alloca ptr, align 8
  %asc = alloca ptr, align 8
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @"ArrayList$int.add"(ptr %nums1, i32 30)
  %nums2 = load ptr, ptr %nums, align 8
  call void @"ArrayList$int.add"(ptr %nums2, i32 10)
  %nums3 = load ptr, ptr %nums, align 8
  call void @"ArrayList$int.add"(ptr %nums3, i32 50)
  %nums4 = load ptr, ptr %nums, align 8
  call void @"ArrayList$int.add"(ptr %nums4, i32 20)
  %nums5 = load ptr, ptr %nums, align 8
  call void @"ArrayList$int.add"(ptr %nums5, i32 40)
  %nums6 = load ptr, ptr %nums, align 8
  %16 = call ptr @"ArrayList$int.sortedBy#0=__polaron_lambda_0$fs"(ptr %nums6, ptr @__polaron_closure)
  store ptr %16, ptr %asc, align 8
  %nums7 = load ptr, ptr %nums, align 8
  %17 = call ptr @"ArrayList$int.sortedBy#0=__polaron_lambda_1$fs"(ptr %nums7, ptr @__polaron_closure.1)
  store ptr %17, ptr %desc, align 8
  %asc8 = load ptr, ptr %asc, align 8
  %18 = call i32 @"ArrayList$int.get"(ptr %asc8, i32 0)
  %asc9 = load ptr, ptr %asc, align 8
  %19 = call i32 @"ArrayList$int.get"(ptr %asc9, i32 1)
  %asc10 = load ptr, ptr %asc, align 8
  %20 = call i32 @"ArrayList$int.get"(ptr %asc10, i32 2)
  %asc11 = load ptr, ptr %asc, align 8
  %21 = call i32 @"ArrayList$int.get"(ptr %asc11, i32 3)
  %asc12 = load ptr, ptr %asc, align 8
  %22 = call i32 @"ArrayList$int.get"(ptr %asc12, i32 4)
  %23 = call i32 (ptr, ...) @printf(ptr @.str, i32 %18, i32 %19, i32 %20, i32 %21, i32 %22)
  %desc13 = load ptr, ptr %desc, align 8
  %24 = call i32 @"ArrayList$int.get"(ptr %desc13, i32 0)
  %nums14 = load ptr, ptr %nums, align 8
  %25 = call i32 @"ArrayList$int.get"(ptr %nums14, i32 0)
  %26 = call i32 (ptr, ...) @printf(ptr @.str.2, i32 %24, i32 %25)
  ret i32 0
}
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.882, ptr @.cl.883, i64 %contract.l, ptr @.cr.884, i64 0, i32 1)
  unreachable
...
contract.fail11:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.885, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.886, ptr @.faila.887, i64 %19, ptr @.failb.888, i64 %arr.len, i32 70)
  unreachable
...
idx.bad27:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.889, ptr @.faila.890, i64 %22, ptr @.failb.891, i64 %arr.len25, i32 70)
  unreachable
...
idx.bad41:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.892, ptr @.faila.893, i64 %16, ptr @.failb.894, i64 %arr.len39, i32 70)
  unreachable
...
contract.fail55:                                  ; preds = %contract.cont
  ...
  call void @__polaron_fail(ptr @.contract.896, ptr @.cl.897, i64 %contract.l, ptr @.cr.898, i64 0, i32 1)
  unreachable
...
contract.fail65:                                  ; preds = %contract.cont56
  call void @__polaron_fail(ptr @.contract.899, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.900, ptr @.faila.901, i64 %18, ptr @.failb.902, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.903, ptr @.faila.904, i64 %21, ptr @.failb.905, i64 %arr.len20, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.910, ptr @.faila.911, i64 %13, ptr @.failb.912, i64 %arr.len, i32 70)
  unreachable
...
idx.bad20:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.913, ptr @.faila.914, i64 %14, ptr @.failb.915, i64 %arr.len18, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.916, ptr @.faila.917, i64 %14, ptr @.failb.918, i64 %arr.len, i32 70)
  unreachable
...
idx.bad26:                                        ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.920, ptr @.faila.921, i64 %15, ptr @.failb.922, i64 %arr.len24, i32 70)
  unreachable
...
contract.fail37:                                  ; preds = %idx.ok27
  call void @__polaron_fail(ptr @.contract.923, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.924, ptr @.faila.925, i64 %9, ptr @.failb.926, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.927, ptr @.faila.928, i64 %13, ptr @.failb.929, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.930, ptr @.cl.931, i64 %contract.l, ptr @.cr.932, i64 0, i32 1)
  unreachable
...
idx.bad36:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.934, ptr @.faila.935, i64 %22, ptr @.failb.936, i64 %arr.len34, i32 70)
  unreachable
...
idx.bad45:                                        ; preds = %idx.ok37
  call void @__polaron_fail(ptr @.fail.937, ptr @.faila.938, i64 %29, ptr @.failb.939, i64 %arr.len43, i32 70)
  unreachable
...
contract.fail56:                                  ; preds = %for.end
  ...
  call void @__polaron_fail(ptr @.contract.940, ptr @.cl.941, i64 %contract.l60, ptr @.cr.942, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.944, ptr @.faila.945, i64 %14, ptr @.failb.946, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %idx.ok
  ...
  call void @__polaron_fail(ptr @.contract.947, ptr @.cl.948, i64 %contract.l, ptr @.cr.949, i64 0, i32 1)
  unreachable
...
contract.fail26:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.950, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad46:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.951, ptr @.faila.952, i64 %31, ptr @.failb.953, i64 %arr.len44, i32 70)
  unreachable
...
idx.bad55:                                        ; preds = %idx.ok47
  call void @__polaron_fail(ptr @.fail.954, ptr @.faila.955, i64 %34, ptr @.failb.956, i64 %arr.len53, i32 70)
  unreachable
...
idx.bad76:                                        ; preds = %for.body66
  call void @__polaron_fail(ptr @.fail.957, ptr @.faila.958, i64 %37, ptr @.failb.959, i64 %arr.len74, i32 70)
  unreachable
...
idx.bad85:                                        ; preds = %idx.ok77
  call void @__polaron_fail(ptr @.fail.960, ptr @.faila.961, i64 %42, ptr @.failb.962, i64 %arr.len83, i32 70)
  unreachable
...
idx.bad95:                                        ; preds = %for.end68
  call void @__polaron_fail(ptr @.fail.963, ptr @.faila.964, i64 %40, ptr @.failb.965, i64 %arr.len93, i32 70)
  unreachable
...
contract.fail106:                                 ; preds = %idx.ok96
  ...
  call void @__polaron_fail(ptr @.contract.966, ptr @.cl.967, i64 %contract.l110, ptr @.cr.968, i64 0, i32 1)
  unreachable
...
contract.fail:                                    ; preds = %entry
  ...
  call void @__polaron_fail(ptr @.contract.970, ptr @.cl.971, i64 %contract.l, ptr @.cr.972, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.974, ptr @.faila.975, i64 %12, ptr @.failb.976, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %idx.ok
  call void @__polaron_fail(ptr @.fail.977, ptr @.faila.978, i64 %15, ptr @.failb.979, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.980, ptr @.faila.981, i64 %10, ptr @.failb.982, i64 %arr.len, i32 70)
  unreachable
...
idx.bad22:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.986, ptr @.faila.987, i64 %15, ptr @.failb.988, i64 %arr.len20, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.989, ptr @.faila.990, i64 %10, ptr @.failb.991, i64 %arr.len, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.998, ptr @.faila.999, i64 %9, ptr @.failb.1000, i64 %arr.len, i32 70)
  unreachable
...
contract.fail:                                    ; preds = %if.end
  ...
  call void @__polaron_fail(ptr @.contract.1001, ptr @.cl.1002, i64 %contract.l, ptr @.cr.1003, i64 0, i32 1)
  unreachable
...
contract.fail35:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.1004, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
contract.fail:                                    ; preds = %if.then
  call void @__polaron_fail(ptr @.contract.1005, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1006, ptr @.faila.1007, i64 %25, ptr @.failb.1008, i64 %arr.len, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %sc.rhs
  call void @__polaron_fail(ptr @.fail.1009, ptr @.faila.1010, i64 %38, ptr @.failb.1011, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad43:                                        ; preds = %while.body
  call void @__polaron_fail(ptr @.fail.1012, ptr @.faila.1013, i64 %34, ptr @.failb.1014, i64 %arr.len41, i32 70)
  unreachable
...
idx.bad52:                                        ; preds = %idx.ok44
  call void @__polaron_fail(ptr @.fail.1015, ptr @.faila.1016, i64 %43, ptr @.failb.1017, i64 %arr.len50, i32 70)
  unreachable
...
idx.bad63:                                        ; preds = %while.end
  call void @__polaron_fail(ptr @.fail.1018, ptr @.faila.1019, i64 %36, ptr @.failb.1020, i64 %arr.len61, i32 70)
  unreachable
...
contract.fail75:                                  ; preds = %for.end
  call void @__polaron_fail(ptr @.contract.1021, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad95:                                        ; preds = %div.ok
  call void @__polaron_fail(ptr @.fail.1022, ptr @.faila.1023, i64 %48, ptr @.failb.1024, i64 %arr.len93, i32 70)
  unreachable
...
idx.bad105:                                       ; preds = %idx.ok96
  call void @__polaron_fail(ptr @.fail.1025, ptr @.faila.1026, i64 %50, ptr @.failb.1027, i64 %arr.len103, i32 70)
  unreachable
...
contract.fail118:                                 ; preds = %if.then110
  call void @__polaron_fail(ptr @.contract.1028, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad143:                                       ; preds = %while.body124
  call void @__polaron_fail(ptr @.fail.1029, ptr @.faila.1030, i64 %61, ptr @.failb.1031, i64 %arr.len141, i32 70)
  unreachable
...
idx.bad153:                                       ; preds = %idx.ok144
  call void @__polaron_fail(ptr @.fail.1032, ptr @.faila.1033, i64 %65, ptr @.failb.1034, i64 %arr.len151, i32 70)
  unreachable
...
idx.bad164:                                       ; preds = %if.then158
  call void @__polaron_fail(ptr @.fail.1035, ptr @.faila.1036, i64 %69, ptr @.failb.1037, i64 %arr.len162, i32 70)
  unreachable
...
idx.bad173:                                       ; preds = %idx.ok165
  call void @__polaron_fail(ptr @.fail.1038, ptr @.faila.1039, i64 %72, ptr @.failb.1040, i64 %arr.len171, i32 70)
  unreachable
...
idx.bad183:                                       ; preds = %if.else
  call void @__polaron_fail(ptr @.fail.1041, ptr @.faila.1042, i64 %70, ptr @.failb.1043, i64 %arr.len181, i32 70)
  unreachable
...
idx.bad192:                                       ; preds = %idx.ok184
  call void @__polaron_fail(ptr @.fail.1044, ptr @.faila.1045, i64 %74, ptr @.failb.1046, i64 %arr.len190, i32 70)
  unreachable
...
idx.bad208:                                       ; preds = %while.body200
  call void @__polaron_fail(ptr @.fail.1047, ptr @.faila.1048, i64 %78, ptr @.failb.1049, i64 %arr.len206, i32 70)
  unreachable
...
idx.bad217:                                       ; preds = %idx.ok209
  call void @__polaron_fail(ptr @.fail.1050, ptr @.faila.1051, i64 %79, ptr @.failb.1052, i64 %arr.len215, i32 70)
  unreachable
...
idx.bad233:                                       ; preds = %while.body225
  call void @__polaron_fail(ptr @.fail.1053, ptr @.faila.1054, i64 %84, ptr @.failb.1055, i64 %arr.len231, i32 70)
  unreachable
...
idx.bad242:                                       ; preds = %idx.ok234
  call void @__polaron_fail(ptr @.fail.1056, ptr @.faila.1057, i64 %85, ptr @.failb.1058, i64 %arr.len240, i32 70)
  unreachable
...
idx.bad261:                                       ; preds = %for.body251
  call void @__polaron_fail(ptr @.fail.1059, ptr @.faila.1060, i64 %90, ptr @.failb.1061, i64 %arr.len259, i32 70)
  unreachable
...
idx.bad269:                                       ; preds = %idx.ok262
  call void @__polaron_fail(ptr @.fail.1062, ptr @.faila.1063, i64 %95, ptr @.failb.1064, i64 %arr.len267, i32 70)
  unreachable
...
contract.fail281:                                 ; preds = %for.end253
  call void @__polaron_fail(ptr @.contract.1065, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1066, ptr @.faila.1067, i64 %10, ptr @.failb.1068, i64 %arr.len, i32 70)
  unreachable
...
idx.bad18:                                        ; preds = %if.then
  call void @__polaron_fail(ptr @.fail.1069, ptr @.faila.1070, i64 %15, ptr @.failb.1071, i64 %arr.len16, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1072, ptr @.faila.1073, i64 0, ptr @.failb.1074, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1075, ptr @.faila.1076, i64 %12, ptr @.failb.1077, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %if.then25
  call void @__polaron_fail(ptr @.fail.1078, ptr @.faila.1079, i64 %18, ptr @.failb.1080, i64 %arr.len30, i32 70)
  unreachable
...
idx.bad:                                          ; preds = %if.end
  call void @__polaron_fail(ptr @.fail.1081, ptr @.faila.1082, i64 0, ptr @.failb.1083, i64 %arr.len, i32 70)
  unreachable
...
idx.bad19:                                        ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.1084, ptr @.faila.1085, i64 %12, ptr @.failb.1086, i64 %arr.len17, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %if.then25
  call void @__polaron_fail(ptr @.fail.1087, ptr @.faila.1088, i64 %18, ptr @.failb.1089, i64 %arr.len30, i32 70)
  unreachable
...
define internal i32 @__polaron_lambda_0(ptr %0, i32 %1, i32 %2) {
entry:
...
define internal ptr @"ArrayList$int.sortedBy#0=__polaron_lambda_0$fs"(ptr %0, ptr %1) {
entry:
  %scratch = alloca ptr, align 8
  %i = alloca i32, align 4
  %out = alloca ptr, align 8
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.5383, ptr @.faila.5384, i64 %9, ptr @.failb.5385, i64 %arr.len, i32 70)
  unreachable
...
if.then:                                          ; preds = %for.end
  ...
  %21 = sub i32 %20, 1
  %compare22 = load ptr, ptr %compare, align 8
  call void @"ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs"(ptr %out19, ptr %scratch20, i32 0, i32 %21, ptr %compare22)
  %scratch23 = load ptr, ptr %scratch, align 8
  call void @__polaron_free(ptr %scratch23)
  br label %if.end
...
contract.fail:                                    ; preds = %if.end
  ...
  %count28 = load i32, ptr %count27, align 4, !tbaa !4
  %contract.l = sext i32 %count28 to i64
  call void @__polaron_fail(ptr @.contract.5386, ptr @.cl.5387, i64 %contract.l, ptr @.cr.5388, i64 0, i32 1)
  unreachable
...
contract.fail35:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.5389, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
define internal i32 @__polaron_lambda_1(ptr %0, i32 %1, i32 %2) {
entry:
  %b = alloca i32, align 4
  %a = alloca i32, align 4
  store i32 %1, ptr %a, align 4
...
define internal ptr @"ArrayList$int.sortedBy#0=__polaron_lambda_1$fs"(ptr %0, ptr %1) {
entry:
  %scratch = alloca ptr, align 8
  %i = alloca i32, align 4
  %out = alloca ptr, align 8
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.5315, ptr @.faila.5316, i64 %9, ptr @.failb.5317, i64 %arr.len, i32 70)
  unreachable
...
if.then:                                          ; preds = %for.end
  ...
  %21 = sub i32 %20, 1
  %compare22 = load ptr, ptr %compare, align 8
  call void @"ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs"(ptr %out19, ptr %scratch20, i32 0, i32 %21, ptr %compare22)
  %scratch23 = load ptr, ptr %scratch, align 8
  call void @__polaron_free(ptr %scratch23)
  br label %if.end
...
contract.fail:                                    ; preds = %if.end
  ...
  %count28 = load i32, ptr %count27, align 4, !tbaa !4
  %contract.l = sext i32 %count28 to i64
  call void @__polaron_fail(ptr @.contract.5318, ptr @.cl.5319, i64 %contract.l, ptr @.cr.5320, i64 0, i32 1)
  unreachable
...
contract.fail35:                                  ; preds = %contract.cont
  call void @__polaron_fail(ptr @.contract.5321, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
define internal void @"ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs"(ptr %0, ptr %1, i32 %2, i32 %3, ptr %4) personality ptr @__CxxFrameHandler3 {
entry:
  %t = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
...
contract.fail:                                    ; preds = %if.then
  call void @__polaron_fail(ptr @.contract.5322, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.5323, ptr @.faila.5324, i64 %25, ptr @.failb.5325, i64 %arr.len, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %sc.rhs
  call void @__polaron_fail(ptr @.fail.5326, ptr @.faila.5327, i64 %38, ptr @.failb.5328, i64 %arr.len30, i32 70)
  unreachable
...
idx.ok33:                                         ; preds = %sc.rhs
  ...
  %elem36 = load i32, ptr %arr.elem35, align 4
  %key37 = load i32, ptr %key, align 4
  %40 = call i32 @__polaron_lambda_1(ptr %env, i32 %elem36, i32 %key37)
  %41 = icmp sgt i32 %40, 0
  %42 = zext i1 %41 to i32
  %sc.b = icmp ne i32 %42, 0
  br label %sc.end
...
idx.bad43:                                        ; preds = %while.body
  call void @__polaron_fail(ptr @.fail.5329, ptr @.faila.5330, i64 %34, ptr @.failb.5331, i64 %arr.len41, i32 70)
  unreachable
...
idx.bad52:                                        ; preds = %idx.ok44
  call void @__polaron_fail(ptr @.fail.5332, ptr @.faila.5333, i64 %43, ptr @.failb.5334, i64 %arr.len50, i32 70)
  unreachable
...
idx.bad63:                                        ; preds = %while.end
  call void @__polaron_fail(ptr @.fail.5335, ptr @.faila.5336, i64 %36, ptr @.failb.5337, i64 %arr.len61, i32 70)
  unreachable
...
contract.fail75:                                  ; preds = %for.end
  call void @__polaron_fail(ptr @.contract.5338, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
div.ok:                                           ; preds = %if.end16
  ...
  %mid81 = load i32, ptr %mid, align 4
  %compare82 = load ptr, ptr %compare, align 8
  call void @"ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs"(ptr %0, ptr %tmp79, i32 %lo80, i32 %mid81, ptr %compare82)
  %tmp83 = load ptr, ptr %tmp, align 8
  %mid84 = load i32, ptr %mid, align 4
  %46 = add i32 %mid84, 1
  %hi85 = load i32, ptr %hi, align 4
  %compare86 = load ptr, ptr %compare, align 8
  call void @"ArrayList$int.mergeSortRange#3=__polaron_lambda_1$fs"(ptr %0, ptr %tmp83, i32 %46, i32 %hi85, ptr %compare86)
  %compare87 = load ptr, ptr %compare, align 8
  %47 = getelementptr ptr, ptr %compare87, i32 1
  %env88 = load ptr, ptr %47, align 8
  %data89 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data90 = load ptr, ptr %data89, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %mid91 = load i32, ptr %mid, align 4
  %48 = sext i32 %mid91 to i64
  %arr.len92 = load i64, ptr %data90, align 8
  %arr.oob93 = icmp uge i64 %48, %arr.len92
  br i1 %arr.oob93, label %idx.bad94, label %idx.ok95, !prof !8

idx.bad94:                                        ; preds = %div.ok
  call void @__polaron_fail(ptr @.fail.5339, ptr @.faila.5340, i64 %48, ptr @.failb.5341, i64 %arr.len92, i32 70)
  unreachable

idx.ok95:                                         ; preds = %div.ok
  %arr.data96 = getelementptr i8, ptr %data90, i64 8
  %arr.elem97 = getelementptr inbounds i32, ptr %arr.data96, i64 %48
  %elem98 = load i32, ptr %arr.elem97, align 4
  %data99 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data100 = load ptr, ptr %data99, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %mid101 = load i32, ptr %mid, align 4
  %49 = add i32 %mid101, 1
  %50 = sext i32 %49 to i64
  %arr.len102 = load i64, ptr %data100, align 8
  %arr.oob103 = icmp uge i64 %50, %arr.len102
  br i1 %arr.oob103, label %idx.bad104, label %idx.ok105, !prof !8

idx.bad104:                                       ; preds = %idx.ok95
  call void @__polaron_fail(ptr @.fail.5342, ptr @.faila.5343, i64 %50, ptr @.failb.5344, i64 %arr.len102, i32 70)
  unreachable

idx.ok105:                                        ; preds = %idx.ok95
  %arr.data106 = getelementptr i8, ptr %data100, i64 8
  %arr.elem107 = getelementptr inbounds i32, ptr %arr.data106, i64 %50
  %elem108 = load i32, ptr %arr.elem107, align 4
  %51 = call i32 @__polaron_lambda_1(ptr %env88, i32 %elem98, i32 %elem108)
  %52 = icmp sle i32 %51, 0
  %53 = zext i1 %52 to i32
  br i1 %52, label %if.then109, label %if.end110

if.then109:                                       ; preds = %idx.ok105
  %count111 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 2
  %count112 = load i32, ptr %count111, align 4, !tbaa !4
  %data113 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data114 = load ptr, ptr %data113, align 8, !tbaa !0
  %len115 = load i64, ptr %data114, align 8
  %54 = trunc i64 %len115 to i32
  %55 = icmp sle i32 %count112, %54
  %56 = zext i1 %55 to i32
  %contract.ok116 = icmp ne i32 %56, 0
  br i1 %contract.ok116, label %contract.cont118, label %contract.fail117

if.end110:                                        ; preds = %idx.ok105
  %lo119 = load i32, ptr %lo, align 4
  store i32 %lo119, ptr %i, align 4
  %mid120 = load i32, ptr %mid, align 4
  %57 = add i32 %mid120, 1
  store i32 %57, ptr %j, align 4
  %lo121 = load i32, ptr %lo, align 4
  store i32 %lo121, ptr %k, align 4
  br label %while.cond122

contract.fail117:                                 ; preds = %if.then109
  call void @__polaron_fail(ptr @.contract.5345, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable

contract.cont118:                                 ; preds = %if.then109
  ret void

while.cond122:                                    ; preds = %if.end157, %if.end110
  %i125 = load i32, ptr %i, align 4
  %mid126 = load i32, ptr %mid, align 4
  %58 = icmp sle i32 %i125, %mid126
  %59 = zext i1 %58 to i32
  %sc.a127 = icmp ne i32 %59, 0
  br i1 %sc.a127, label %sc.rhs128, label %sc.end129

while.body123:                                    ; preds = %sc.end129
  %compare134 = load ptr, ptr %compare, align 8
  %60 = getelementptr ptr, ptr %compare134, i32 1
  %env135 = load ptr, ptr %60, align 8
  %data136 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data137 = load ptr, ptr %data136, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %i138 = load i32, ptr %i, align 4
  %61 = sext i32 %i138 to i64
  %arr.len139 = load i64, ptr %data137, align 8
  %arr.oob140 = icmp uge i64 %61, %arr.len139
  br i1 %arr.oob140, label %idx.bad141, label %idx.ok142, !prof !8

while.end124:                                     ; preds = %sc.end129
  br label %while.cond197

sc.rhs128:                                        ; preds = %while.cond122
  %j130 = load i32, ptr %j, align 4
  %hi131 = load i32, ptr %hi, align 4
  %62 = icmp sle i32 %j130, %hi131
  %63 = zext i1 %62 to i32
  %sc.b132 = icmp ne i32 %63, 0
  br label %sc.end129

sc.end129:                                        ; preds = %sc.rhs128, %while.cond122
  %sc133 = phi i1 [ false, %while.cond122 ], [ %sc.b132, %sc.rhs128 ]
  %64 = zext i1 %sc133 to i32
  br i1 %sc133, label %while.body123, label %while.end124

idx.bad141:                                       ; preds = %while.body123
  call void @__polaron_fail(ptr @.fail.5346, ptr @.faila.5347, i64 %61, ptr @.failb.5348, i64 %arr.len139, i32 70)
  unreachable

idx.ok142:                                        ; preds = %while.body123
  %arr.data143 = getelementptr i8, ptr %data137, i64 8
  %arr.elem144 = getelementptr inbounds i32, ptr %arr.data143, i64 %61
  %elem145 = load i32, ptr %arr.elem144, align 4
  %data146 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data147 = load ptr, ptr %data146, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %j148 = load i32, ptr %j, align 4
  %65 = sext i32 %j148 to i64
  %arr.len149 = load i64, ptr %data147, align 8
  %arr.oob150 = icmp uge i64 %65, %arr.len149
  br i1 %arr.oob150, label %idx.bad151, label %idx.ok152, !prof !8

idx.bad151:                                       ; preds = %idx.ok142
  call void @__polaron_fail(ptr @.fail.5349, ptr @.faila.5350, i64 %65, ptr @.failb.5351, i64 %arr.len149, i32 70)
  unreachable

idx.ok152:                                        ; preds = %idx.ok142
  %arr.data153 = getelementptr i8, ptr %data147, i64 8
  %arr.elem154 = getelementptr inbounds i32, ptr %arr.data153, i64 %65
  %elem155 = load i32, ptr %arr.elem154, align 4
  %66 = call i32 @__polaron_lambda_1(ptr %env135, i32 %elem145, i32 %elem155)
  %67 = icmp sle i32 %66, 0
  %68 = zext i1 %67 to i32
  br i1 %67, label %if.then156, label %if.else

if.then156:                                       ; preds = %idx.ok152
  %tmp158 = load ptr, ptr %tmp, align 8, !nonnull !6, !dereferenceable !7
  %k159 = load i32, ptr %k, align 4
  %69 = sext i32 %k159 to i64
  %arr.len160 = load i64, ptr %tmp158, align 8
  %arr.oob161 = icmp uge i64 %69, %arr.len160
  br i1 %arr.oob161, label %idx.bad162, label %idx.ok163, !prof !8

if.else:                                          ; preds = %idx.ok152
  %tmp177 = load ptr, ptr %tmp, align 8, !nonnull !6, !dereferenceable !7
  %k178 = load i32, ptr %k, align 4
  %70 = sext i32 %k178 to i64
  %arr.len179 = load i64, ptr %tmp177, align 8
  %arr.oob180 = icmp uge i64 %70, %arr.len179
  br i1 %arr.oob180, label %idx.bad181, label %idx.ok182, !prof !8

if.end157:                                        ; preds = %idx.ok191, %idx.ok172
  %k196 = load i32, ptr %k, align 4
  %71 = add i32 %k196, 1
  store i32 %71, ptr %k, align 4
  br label %while.cond122

idx.bad162:                                       ; preds = %if.then156
  call void @__polaron_fail(ptr @.fail.5352, ptr @.faila.5353, i64 %69, ptr @.failb.5354, i64 %arr.len160, i32 70)
  unreachable

idx.ok163:                                        ; preds = %if.then156
  %arr.data164 = getelementptr i8, ptr %tmp158, i64 8
  %arr.elem165 = getelementptr inbounds i32, ptr %arr.data164, i64 %69
  %data166 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data167 = load ptr, ptr %data166, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %i168 = load i32, ptr %i, align 4
  %72 = sext i32 %i168 to i64
  %arr.len169 = load i64, ptr %data167, align 8
  %arr.oob170 = icmp uge i64 %72, %arr.len169
  br i1 %arr.oob170, label %idx.bad171, label %idx.ok172, !prof !8

idx.bad171:                                       ; preds = %idx.ok163
  call void @__polaron_fail(ptr @.fail.5355, ptr @.faila.5356, i64 %72, ptr @.failb.5357, i64 %arr.len169, i32 70)
  unreachable

idx.ok172:                                        ; preds = %idx.ok163
  %arr.data173 = getelementptr i8, ptr %data167, i64 8
  %arr.elem174 = getelementptr inbounds i32, ptr %arr.data173, i64 %72
  %elem175 = load i32, ptr %arr.elem174, align 4
  store i32 %elem175, ptr %arr.elem165, align 4
  %i176 = load i32, ptr %i, align 4
  %73 = add i32 %i176, 1
  store i32 %73, ptr %i, align 4
  br label %if.end157

idx.bad181:                                       ; preds = %if.else
  call void @__polaron_fail(ptr @.fail.5358, ptr @.faila.5359, i64 %70, ptr @.failb.5360, i64 %arr.len179, i32 70)
  unreachable

idx.ok182:                                        ; preds = %if.else
  %arr.data183 = getelementptr i8, ptr %tmp177, i64 8
  %arr.elem184 = getelementptr inbounds i32, ptr %arr.data183, i64 %70
  %data185 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data186 = load ptr, ptr %data185, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %j187 = load i32, ptr %j, align 4
  %74 = sext i32 %j187 to i64
  %arr.len188 = load i64, ptr %data186, align 8
  %arr.oob189 = icmp uge i64 %74, %arr.len188
  br i1 %arr.oob189, label %idx.bad190, label %idx.ok191, !prof !8

idx.bad190:                                       ; preds = %idx.ok182
  call void @__polaron_fail(ptr @.fail.5361, ptr @.faila.5362, i64 %74, ptr @.failb.5363, i64 %arr.len188, i32 70)
  unreachable

idx.ok191:                                        ; preds = %idx.ok182
  %arr.data192 = getelementptr i8, ptr %data186, i64 8
  %arr.elem193 = getelementptr inbounds i32, ptr %arr.data192, i64 %74
  %elem194 = load i32, ptr %arr.elem193, align 4
  store i32 %elem194, ptr %arr.elem184, align 4
  %j195 = load i32, ptr %j, align 4
  %75 = add i32 %j195, 1
  store i32 %75, ptr %j, align 4
  br label %if.end157

while.cond197:                                    ; preds = %idx.ok216, %while.end124
  %i200 = load i32, ptr %i, align 4
  %mid201 = load i32, ptr %mid, align 4
  %76 = icmp sle i32 %i200, %mid201
  %77 = zext i1 %76 to i32
  br i1 %76, label %while.body198, label %while.end199

while.body198:                                    ; preds = %while.cond197
  %tmp202 = load ptr, ptr %tmp, align 8, !nonnull !6, !dereferenceable !7
  %k203 = load i32, ptr %k, align 4
  %78 = sext i32 %k203 to i64
  %arr.len204 = load i64, ptr %tmp202, align 8
  %arr.oob205 = icmp uge i64 %78, %arr.len204
  br i1 %arr.oob205, label %idx.bad206, label %idx.ok207, !prof !8

while.end199:                                     ; preds = %while.cond197
  br label %while.cond222

idx.bad206:                                       ; preds = %while.body198
  call void @__polaron_fail(ptr @.fail.5364, ptr @.faila.5365, i64 %78, ptr @.failb.5366, i64 %arr.len204, i32 70)
  unreachable

idx.ok207:                                        ; preds = %while.body198
  %arr.data208 = getelementptr i8, ptr %tmp202, i64 8
  %arr.elem209 = getelementptr inbounds i32, ptr %arr.data208, i64 %78
  %data210 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data211 = load ptr, ptr %data210, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %i212 = load i32, ptr %i, align 4
  %79 = sext i32 %i212 to i64
  %arr.len213 = load i64, ptr %data211, align 8
  %arr.oob214 = icmp uge i64 %79, %arr.len213
  br i1 %arr.oob214, label %idx.bad215, label %idx.ok216, !prof !8

idx.bad215:                                       ; preds = %idx.ok207
  call void @__polaron_fail(ptr @.fail.5367, ptr @.faila.5368, i64 %79, ptr @.failb.5369, i64 %arr.len213, i32 70)
  unreachable

idx.ok216:                                        ; preds = %idx.ok207
  %arr.data217 = getelementptr i8, ptr %data211, i64 8
  %arr.elem218 = getelementptr inbounds i32, ptr %arr.data217, i64 %79
  %elem219 = load i32, ptr %arr.elem218, align 4
  store i32 %elem219, ptr %arr.elem209, align 4
  %i220 = load i32, ptr %i, align 4
  %80 = add i32 %i220, 1
  store i32 %80, ptr %i, align 4
  %k221 = load i32, ptr %k, align 4
  %81 = add i32 %k221, 1
  store i32 %81, ptr %k, align 4
  br label %while.cond197

while.cond222:                                    ; preds = %idx.ok241, %while.end199
  %j225 = load i32, ptr %j, align 4
  %hi226 = load i32, ptr %hi, align 4
  %82 = icmp sle i32 %j225, %hi226
  %83 = zext i1 %82 to i32
  br i1 %82, label %while.body223, label %while.end224

while.body223:                                    ; preds = %while.cond222
  %tmp227 = load ptr, ptr %tmp, align 8, !nonnull !6, !dereferenceable !7
  %k228 = load i32, ptr %k, align 4
  %84 = sext i32 %k228 to i64
  %arr.len229 = load i64, ptr %tmp227, align 8
  %arr.oob230 = icmp uge i64 %84, %arr.len229
  br i1 %arr.oob230, label %idx.bad231, label %idx.ok232, !prof !8

while.end224:                                     ; preds = %while.cond222
  %lo247 = load i32, ptr %lo, align 4
  store i32 %lo247, ptr %t, align 4
  br label %for.cond248

idx.bad231:                                       ; preds = %while.body223
  call void @__polaron_fail(ptr @.fail.5370, ptr @.faila.5371, i64 %84, ptr @.failb.5372, i64 %arr.len229, i32 70)
  unreachable

idx.ok232:                                        ; preds = %while.body223
  %arr.data233 = getelementptr i8, ptr %tmp227, i64 8
  %arr.elem234 = getelementptr inbounds i32, ptr %arr.data233, i64 %84
  %data235 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data236 = load ptr, ptr %data235, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %j237 = load i32, ptr %j, align 4
  %85 = sext i32 %j237 to i64
  %arr.len238 = load i64, ptr %data236, align 8
  %arr.oob239 = icmp uge i64 %85, %arr.len238
  br i1 %arr.oob239, label %idx.bad240, label %idx.ok241, !prof !8

idx.bad240:                                       ; preds = %idx.ok232
  call void @__polaron_fail(ptr @.fail.5373, ptr @.faila.5374, i64 %85, ptr @.failb.5375, i64 %arr.len238, i32 70)
  unreachable

idx.ok241:                                        ; preds = %idx.ok232
  %arr.data242 = getelementptr i8, ptr %data236, i64 8
  %arr.elem243 = getelementptr inbounds i32, ptr %arr.data242, i64 %85
  %elem244 = load i32, ptr %arr.elem243, align 4
  store i32 %elem244, ptr %arr.elem234, align 4
  %j245 = load i32, ptr %j, align 4
  %86 = add i32 %j245, 1
  store i32 %86, ptr %j, align 4
  %k246 = load i32, ptr %k, align 4
  %87 = add i32 %k246, 1
  store i32 %87, ptr %k, align 4
  br label %while.cond222

for.cond248:                                      ; preds = %for.update250, %while.end224
  %t252 = load i32, ptr %t, align 4
  %hi253 = load i32, ptr %hi, align 4
  %88 = icmp sle i32 %t252, %hi253
  %89 = zext i1 %88 to i32
  br i1 %88, label %for.body249, label %for.end251

for.body249:                                      ; preds = %for.cond248
  %data254 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data255 = load ptr, ptr %data254, align 8, !tbaa !0, !nonnull !6, !dereferenceable !7
  %t256 = load i32, ptr %t, align 4
  %90 = sext i32 %t256 to i64
  %arr.len257 = load i64, ptr %data255, align 8
  %arr.oob258 = icmp uge i64 %90, %arr.len257
  br i1 %arr.oob258, label %idx.bad259, label %idx.ok260, !prof !8

for.update250:                                    ; preds = %idx.ok268
  %t272 = load i32, ptr %t, align 4
  %91 = add i32 %t272, 1
  store i32 %91, ptr %t, align 4
  br label %for.cond248

for.end251:                                       ; preds = %for.cond248
  %count273 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 2
  %count274 = load i32, ptr %count273, align 4, !tbaa !4
  %data275 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
  %data276 = load ptr, ptr %data275, align 8, !tbaa !0
  %len277 = load i64, ptr %data276, align 8
  %92 = trunc i64 %len277 to i32
  %93 = icmp sle i32 %count274, %92
  %94 = zext i1 %93 to i32
  %contract.ok278 = icmp ne i32 %94, 0
  br i1 %contract.ok278, label %contract.cont280, label %contract.fail279

idx.bad259:                                       ; preds = %for.body249
  call void @__polaron_fail(ptr @.fail.5376, ptr @.faila.5377, i64 %90, ptr @.failb.5378, i64 %arr.len257, i32 70)
  unreachable

idx.ok260:                                        ; preds = %for.body249
  %arr.data261 = getelementptr i8, ptr %data255, i64 8
  %arr.elem262 = getelementptr inbounds i32, ptr %arr.data261, i64 %90
  %tmp263 = load ptr, ptr %tmp, align 8, !nonnull !6, !dereferenceable !7
  %t264 = load i32, ptr %t, align 4
  %95 = sext i32 %t264 to i64
  %arr.len265 = load i64, ptr %tmp263, align 8
  %arr.oob266 = icmp uge i64 %95, %arr.len265
  br i1 %arr.oob266, label %idx.bad267, label %idx.ok268, !prof !8

idx.bad267:                                       ; preds = %idx.ok260
  call void @__polaron_fail(ptr @.fail.5379, ptr @.faila.5380, i64 %95, ptr @.failb.5381, i64 %arr.len265, i32 70)
  unreachable

idx.ok268:                                        ; preds = %idx.ok260
  %arr.data269 = getelementptr i8, ptr %tmp263, i64 8
  %arr.elem270 = getelementptr inbounds i32, ptr %arr.data269, i64 %95
  %elem271 = load i32, ptr %arr.elem270, align 4
  store i32 %elem271, ptr %arr.elem262, align 4
  br label %for.update250

contract.fail279:                                 ; preds = %for.end251
  call void @__polaron_fail(ptr @.contract.5382, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable

contract.cont280:                                 ; preds = %for.end251
  ret void
}

define internal void @"ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs"(ptr %0, ptr %1, i32 %2, i32 %3, ptr %4) personality ptr @__CxxFrameHandler3 {
entry:
  %t = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
...
contract.fail:                                    ; preds = %if.then
  call void @__polaron_fail(ptr @.contract.5390, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad:                                          ; preds = %for.body
  call void @__polaron_fail(ptr @.fail.5391, ptr @.faila.5392, i64 %25, ptr @.failb.5393, i64 %arr.len, i32 70)
  unreachable
...
idx.bad32:                                        ; preds = %sc.rhs
  call void @__polaron_fail(ptr @.fail.5394, ptr @.faila.5395, i64 %38, ptr @.failb.5396, i64 %arr.len30, i32 70)
  unreachable
...
idx.ok33:                                         ; preds = %sc.rhs
  ...
  %elem36 = load i32, ptr %arr.elem35, align 4
  %key37 = load i32, ptr %key, align 4
  %40 = call i32 @__polaron_lambda_0(ptr %env, i32 %elem36, i32 %key37)
  %41 = icmp sgt i32 %40, 0
  %42 = zext i1 %41 to i32
  %sc.b = icmp ne i32 %42, 0
  br label %sc.end
...
idx.bad43:                                        ; preds = %while.body
  call void @__polaron_fail(ptr @.fail.5397, ptr @.faila.5398, i64 %34, ptr @.failb.5399, i64 %arr.len41, i32 70)
  unreachable
...
idx.bad52:                                        ; preds = %idx.ok44
  call void @__polaron_fail(ptr @.fail.5400, ptr @.faila.5401, i64 %43, ptr @.failb.5402, i64 %arr.len50, i32 70)
  unreachable
...
idx.bad63:                                        ; preds = %while.end
  call void @__polaron_fail(ptr @.fail.5403, ptr @.faila.5404, i64 %36, ptr @.failb.5405, i64 %arr.len61, i32 70)
  unreachable
...
contract.fail75:                                  ; preds = %for.end
  call void @__polaron_fail(ptr @.contract.5406, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
div.ok:                                           ; preds = %if.end16
  ...
  %mid81 = load i32, ptr %mid, align 4
  %compare82 = load ptr, ptr %compare, align 8
  call void @"ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs"(ptr %0, ptr %tmp79, i32 %lo80, i32 %mid81, ptr %compare82)
  %tmp83 = load ptr, ptr %tmp, align 8
  %mid84 = load i32, ptr %mid, align 4
  %46 = add i32 %mid84, 1
  %hi85 = load i32, ptr %hi, align 4
  %compare86 = load ptr, ptr %compare, align 8
  call void @"ArrayList$int.mergeSortRange#3=__polaron_lambda_0$fs"(ptr %0, ptr %tmp83, i32 %46, i32 %hi85, ptr %compare86)
  %compare87 = load ptr, ptr %compare, align 8
  %47 = getelementptr ptr, ptr %compare87, i32 1
  %env88 = load ptr, ptr %47, align 8
  %data89 = getelementptr inbounds %"class.ArrayList$int", ptr %0, i32 0, i32 1
...
idx.bad94:                                        ; preds = %div.ok
  call void @__polaron_fail(ptr @.fail.5407, ptr @.faila.5408, i64 %48, ptr @.failb.5409, i64 %arr.len92, i32 70)
  unreachable
...
idx.bad104:                                       ; preds = %idx.ok95
  call void @__polaron_fail(ptr @.fail.5410, ptr @.faila.5411, i64 %50, ptr @.failb.5412, i64 %arr.len102, i32 70)
  unreachable
...
idx.ok105:                                        ; preds = %idx.ok95
  ...
  %arr.elem107 = getelementptr inbounds i32, ptr %arr.data106, i64 %50
  %elem108 = load i32, ptr %arr.elem107, align 4
  %51 = call i32 @__polaron_lambda_0(ptr %env88, i32 %elem98, i32 %elem108)
  %52 = icmp sle i32 %51, 0
  %53 = zext i1 %52 to i32
  br i1 %52, label %if.then109, label %if.end110
...
contract.fail117:                                 ; preds = %if.then109
  call void @__polaron_fail(ptr @.contract.5413, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
...
idx.bad141:                                       ; preds = %while.body123
  call void @__polaron_fail(ptr @.fail.5414, ptr @.faila.5415, i64 %61, ptr @.failb.5416, i64 %arr.len139, i32 70)
  unreachable
...
idx.bad151:                                       ; preds = %idx.ok142
  call void @__polaron_fail(ptr @.fail.5417, ptr @.faila.5418, i64 %65, ptr @.failb.5419, i64 %arr.len149, i32 70)
  unreachable
...
idx.ok152:                                        ; preds = %idx.ok142
  ...
  %arr.elem154 = getelementptr inbounds i32, ptr %arr.data153, i64 %65
  %elem155 = load i32, ptr %arr.elem154, align 4
  %66 = call i32 @__polaron_lambda_0(ptr %env135, i32 %elem145, i32 %elem155)
  %67 = icmp sle i32 %66, 0
  %68 = zext i1 %67 to i32
  br i1 %67, label %if.then156, label %if.else
...
idx.bad162:                                       ; preds = %if.then156
  call void @__polaron_fail(ptr @.fail.5420, ptr @.faila.5421, i64 %69, ptr @.failb.5422, i64 %arr.len160, i32 70)
  unreachable
...
idx.bad171:                                       ; preds = %idx.ok163
  call void @__polaron_fail(ptr @.fail.5423, ptr @.faila.5424, i64 %72, ptr @.failb.5425, i64 %arr.len169, i32 70)
  unreachable
...
idx.bad181:                                       ; preds = %if.else
  call void @__polaron_fail(ptr @.fail.5426, ptr @.faila.5427, i64 %70, ptr @.failb.5428, i64 %arr.len179, i32 70)
  unreachable
...
idx.bad190:                                       ; preds = %idx.ok182
  call void @__polaron_fail(ptr @.fail.5429, ptr @.faila.5430, i64 %74, ptr @.failb.5431, i64 %arr.len188, i32 70)
  unreachable
...
idx.bad206:                                       ; preds = %while.body198
  call void @__polaron_fail(ptr @.fail.5432, ptr @.faila.5433, i64 %78, ptr @.failb.5434, i64 %arr.len204, i32 70)
  unreachable
...
idx.bad215:                                       ; preds = %idx.ok207
  call void @__polaron_fail(ptr @.fail.5435, ptr @.faila.5436, i64 %79, ptr @.failb.5437, i64 %arr.len213, i32 70)
  unreachable
...
idx.bad231:                                       ; preds = %while.body223
  call void @__polaron_fail(ptr @.fail.5438, ptr @.faila.5439, i64 %84, ptr @.failb.5440, i64 %arr.len229, i32 70)
  unreachable
...
idx.bad240:                                       ; preds = %idx.ok232
  call void @__polaron_fail(ptr @.fail.5441, ptr @.faila.5442, i64 %85, ptr @.failb.5443, i64 %arr.len238, i32 70)
  unreachable
...
idx.bad259:                                       ; preds = %for.body249
  call void @__polaron_fail(ptr @.fail.5444, ptr @.faila.5445, i64 %90, ptr @.failb.5446, i64 %arr.len257, i32 70)
  unreachable
...
idx.bad267:                                       ; preds = %idx.ok260
  call void @__polaron_fail(ptr @.fail.5447, ptr @.faila.5448, i64 %95, ptr @.failb.5449, i64 %arr.len265, i32 70)
  unreachable
...
contract.fail279:                                 ; preds = %for.end251
  call void @__polaron_fail(ptr @.contract.5450, ptr null, i64 0, ptr null, i64 0, i32 1)
  unreachable
