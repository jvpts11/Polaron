; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/unimport_timeout.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/unimport_timeout.pol"
...
@.str.5 = private unnamed_addr constant [17 x i8] c"should not reach\00", align 1
@.str.6 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@.str.7 = private unnamed_addr constant [11 x i8] c"new caught\00", align 1
...
alive.ok:                                         ; preds = %argv.end
  ...
  %17 = call i32 (ptr, ...) @printf(ptr @.str.2, ptr @.str.3)
  %a1 = load ptr, ptr %a, align 8
  call void @__polaron_check_live(ptr %a1)
  %vtbl.addr = getelementptr inbounds %class.Dog, ptr %a1, i32 0, i32 0
...
dtor.call:                                        ; preds = %alive.ok
  call void %dtor.fn(ptr %a1)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %alive.ok
  call void @__polaron_free(ptr %a1)
...
unimport.live:                                    ; preds = %dtor.free
  %unimp.exc2 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.UnimportedTypeException, ptr null, i64 1) to i64))
  call void @UnimportedTypeException.UnimportedTypeException(ptr %unimp.exc2)
  store ptr %unimp.exc2, ptr %exc.thrown3, align 8
...
unimport.ok:                                      ; preds = %dtor.free
  ...
  call void @__polaron_unload_fn(ptr @Dog.Dog, ptr %code.base4, i64 %code.n5)
  %code.base6 = load ptr, ptr @__polaron_code_base, align 8
  %code.n7 = load i64, ptr @__polaron_code_count, align 8
  call void @__polaron_unload_fn(ptr @"Dog.~Dog", ptr %code.base6, i64 %code.n7)
  %alive8 = load i32, ptr @alive.Dog, align 4
  %20 = icmp eq i32 %alive8, 0
  br i1 %20, label %unimported9, label %alive.ok10

ehpad:                                            ; preds = %alive.ok10, %unimported9
  %21 = catchswitch within none [label %catch.dispatch] unwind to caller

try.cont:                                         ; preds = %catch.body, %invoke.cont
  ret i32 0

unimported9:                                      ; preds = %unimport.ok
  %unimp.exc11 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.UnimportedTypeException, ptr null, i64 1) to i64))
  call void @UnimportedTypeException.UnimportedTypeException(ptr %unimp.exc11)
  store ptr %unimp.exc11, ptr %exc.thrown12, align 8
  invoke void @_CxxThrowException(ptr %exc.thrown12, ptr @_TI1PEAX)
          to label %throw.cont unwind label %ehpad

alive.ok10:                                       ; preds = %unimport.ok
  %Dog.obj13 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Dog, ptr null, i64 1) to i64))
  invoke void @Dog.Dog(ptr %Dog.obj13)
          to label %invoke.cont unwind label %ehpad

throw.cont:                                       ; preds = %unimported9
  unreachable

invoke.cont:                                      ; preds = %alive.ok10
  store ptr %Dog.obj13, ptr %b, align 8
  %22 = call i32 (ptr, ...) @printf(ptr @.str.4, ptr @.str.5)
  br label %try.cont

catch.dispatch:                                   ; preds = %ehpad
  %23 = catchpad within %21 [ptr @"??_R0PEAX@8", i32 0, ptr %exc.caught]
...
rethrow:                                          ; preds = %catch.next
  ...
  store ptr %rethrow.obj, ptr %exc.thrown14, align 8
