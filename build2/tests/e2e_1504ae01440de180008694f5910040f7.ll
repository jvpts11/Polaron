; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/flow_states.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/flow_states.pol"
...
@.str = private unnamed_addr constant [43 x i8] c"branch=%d guard=%d pos=%d init=%d test=%d\0A\00", align 1
...
entry:
  ...
  store i32 5, ptr %age, align 4, !tbaa !4
  ret void
}
...
define internal i32 @Main.takes(ptr %0) {
entry:
  %d = alloca ptr, align 8
  store ptr %0, ptr %d, align 8
  %d1 = load ptr, ptr %d, align 8
  %1 = call i32 @Dog.bark(ptr %d1)
  ret i32 %1
}

define internal i32 @Main.chooseInBranch(i32 %0) {
entry:
  %chosen = alloca i32, align 4
...
if.then:                                          ; preds = %entry
  store i32 10, ptr %chosen, align 4
  br label %if.end

if.else:                                          ; preds = %entry
  store i32 20, ptr %chosen, align 4
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %chosen2 = load i32, ptr %chosen, align 4
  ret i32 %chosen2
}

define internal i32 @Main.guard(ptr %0) {
entry:
  %d = alloca ptr, align 8
  store ptr %0, ptr %d, align 8
  %d1 = load ptr, ptr %d, align 8
  %1 = icmp eq ptr %d1, null
  %2 = zext i1 %1 to i32
...
if.end:                                           ; preds = %entry
  ...
  %3 = call i32 @Main.takes(ptr %d2)
  ret i32 %3
}

define internal i32 @Main.positive(ptr %0) {
entry:
  %d = alloca ptr, align 8
  store ptr %0, ptr %d, align 8
  %d1 = load ptr, ptr %d, align 8
  %1 = icmp ne ptr %d1, null
  %2 = zext i1 %1 to i32
  br i1 %1, label %if.then, label %if.end
...
define internal i32 @Main.fromInitializer() {
entry:
  %d = alloca ptr, align 8
  %dog = alloca ptr, align 8
  %Dog.obj = alloca %class.Dog, align 8
  call void @Dog.Dog(ptr %Dog.obj)
  store ptr %Dog.obj, ptr %dog, align 8
  %dog1 = load ptr, ptr %dog, align 8
  store ptr %dog1, ptr %d, align 8
  %d2 = load ptr, ptr %d, align 8
  %0 = call i32 @Main.takes(ptr %d2)
  ret i32 %0
}

define internal i32 @Main.testAfterProof() {
entry:
  %n = alloca ptr, align 8
  %nbox = call ptr @__polaron_malloc(i64 8)
  store i32 7, ptr %nbox, align 4
  store ptr %nbox, ptr %n, align 8
  %n1 = load ptr, ptr %n, align 8
  %0 = icmp eq ptr %n1, null
  %1 = zext i1 %0 to i32
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i32 @Main.chooseInBranch(i32 1)
  %17 = call i32 @Main.guard(ptr null)
  %18 = call i32 @Main.positive(ptr null)
  %19 = call i32 @Main.fromInitializer()
  %20 = call i32 @Main.testAfterProof()
  %21 = call i32 (ptr, ...) @printf(ptr @.str, i32 %16, i32 %17, i32 %18, i32 %19, i32 %20)
  ret i32 0
}
