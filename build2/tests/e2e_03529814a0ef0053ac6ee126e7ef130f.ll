; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/field_in_region.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/field_in_region.pol"
...
entry:
  ...
  store i32 5, ptr %value, align 4, !tbaa !4
  ret void
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %value = getelementptr inbounds %class.Box, ptr %b1, i32 0, i32 1
  %value2 = load i32, ptr %value, align 4, !tbaa !4
  %16 = call i32 (ptr, ...) @printf(ptr @.str, i32 %value2)
  ret i32 0
}
