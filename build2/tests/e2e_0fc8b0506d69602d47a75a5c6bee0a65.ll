; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/interpolation.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/interpolation.pol"
...
@.str = private unnamed_addr constant [27 x i8] c"score: %d x %d turn of %c\0A\00", align 1
...
argv.end:                                         ; preds = %argv.cond
  ...
  store i32 88, ptr %player, align 4
  %a1 = load i32, ptr %a, align 4
  %b2 = load i32, ptr %b, align 4
  %player3 = load i32, ptr %player, align 4
  %16 = call i32 (ptr, ...) @printf(ptr @.str, i32 %a1, i32 %b2, i32 %player3)
