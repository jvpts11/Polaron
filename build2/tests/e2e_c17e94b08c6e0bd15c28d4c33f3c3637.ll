; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/result_try.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/result_try.pol"
...
if.then:                                          ; preds = %entry
  ...
  %3 = sub i32 0, %n2
  call void @"Err$int$int.Err$int$int"(ptr %"Err$int$int.obj", i32 %3)
...
if.end:                                           ; preds = %entry
  ...
  call void @"Ok$int$int.Ok$int$int"(ptr %"Ok$int$int.obj", i32 %n3)
  ret ptr %"Ok$int$int.obj"
}

define internal ptr @Main.doubleIt(i32 %0) {
entry:
  %v = alloca i32, align 4
  %n = alloca i32, align 4
  store i32 %0, ptr %n, align 4
  %n1 = load i32, ptr %n, align 4
  %1 = call ptr @Main.parse(i32 %n1)
  %try.vtbl = load ptr, ptr %1, align 8
  %"try.ok?" = icmp eq ptr %try.vtbl, @"Ok$int$int.vtable"
  br i1 %"try.ok?", label %try.ok, label %try.err

try.ok:                                           ; preds = %entry
  %try.vp = getelementptr inbounds %"class.Ok$int$int", ptr %1, i32 0, i32 1
  %try.value = load i32, ptr %try.vp, align 4, !tbaa !0
  store i32 %try.value, ptr %v, align 4
  %"Ok$int$int.obj" = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%"class.Ok$int$int", ptr null, i64 1) to i64))
  %v2 = load i32, ptr %v, align 4
  %v3 = load i32, ptr %v, align 4
  %2 = add i32 %v2, %v3
  call void @"Ok$int$int.Ok$int$int"(ptr %"Ok$int$int.obj", i32 %2)
  ret ptr %"Ok$int$int.obj"
...
match.case:                                       ; preds = %entry
  ...
  %value = load i32, ptr %1, align 4, !tbaa !0
...
match.case3:                                      ; preds = %match.next
  ...
  %error = load i32, ptr %2, align 4, !tbaa !0
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call ptr @Main.doubleIt(i32 5)
  store ptr %16, ptr %a, align 8
  %17 = call ptr @Main.doubleIt(i32 -3)
  store ptr %17, ptr %b, align 8
  %a1 = load ptr, ptr %a, align 8
  %18 = call i32 @Main.grade(ptr %a1)
  %b2 = load ptr, ptr %b, align 8
  %19 = call i32 @Main.grade(ptr %b2)
  %20 = call i32 (ptr, ...) @printf(ptr @.str, i32 %18, i32 %19)
  ret i32 0
}
...
entry:
  ...
  store ptr @"Err$int$int.vtable", ptr %vtbl.addr, align 8, !tbaa !4
  %error1 = getelementptr inbounds %"class.Err$int$int", ptr %0, i32 0, i32 1
  %error2 = load i32, ptr %error, align 4
  store i32 %error2, ptr %error1, align 4, !tbaa !0
  ret void
}
...
entry:
  ...
  store ptr @"Ok$int$int.vtable", ptr %vtbl.addr, align 8, !tbaa !4
  %value1 = getelementptr inbounds %"class.Ok$int$int", ptr %0, i32 0, i32 1
  %value2 = load i32, ptr %value, align 4
  store i32 %value2, ptr %value1, align 4, !tbaa !0
  ret void
}
