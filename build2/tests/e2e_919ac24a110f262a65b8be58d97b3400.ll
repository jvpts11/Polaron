; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/adler32.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/adler32.pol"
...
@.str = private unnamed_addr constant [25 x i8] c"abc=%d wiki=%d empty=%d\0A\00", align 1
@.strdata = private constant [4 x i8] c"abc\00"
@.strobj = private global %String { i64 3, ptr @.strdata, i64 0 }
@.strdata.1 = private constant [10 x i8] c"Wikipedia\00"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %16 = call i64 @Adler32.checksum(ptr @.strobj)
  %17 = trunc i64 %16 to i32
  %18 = call i64 @Adler32.checksum(ptr @.strobj.2)
  %19 = trunc i64 %18 to i32
  %20 = call i64 @Adler32.checksum(ptr @.strobj.4)
  %21 = trunc i64 %20 to i32
  %22 = call i32 (ptr, ...) @printf(ptr @.str, i32 %17, i32 %19, i32 %21)
  ret i32 0
}
...
define internal i64 @Adler32.checksum(ptr %0) personality ptr @__CxxFrameHandler3 {
entry:
  ...
  store i64 65521, ptr %mod, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %7 = sext i32 %6 to i64
  %8 = add i64 %a3, %7
  %mod7 = load i64, ptr %mod, align 8
  %9 = icmp eq i64 %mod7, 0
  %10 = icmp eq i64 %8, -9223372036854775808
  %11 = icmp eq i64 %mod7, -1
  %12 = and i1 %10, %11
  %13 = or i1 %9, %12
...
div.ok:                                           ; preds = %for.body
  ...
  %19 = add i64 %b8, %a9
  %mod10 = load i64, ptr %mod, align 8
  %20 = icmp eq i64 %mod10, 0
  %21 = icmp eq i64 %19, -9223372036854775808
  %22 = icmp eq i64 %mod10, -1
  %23 = and i1 %21, %22
  %24 = or i1 %20, %23
  br i1 %24, label %div.bad11, label %div.ok12
...
div.ok12:                                         ; preds = %div.ok
  %25 = srem i64 %19, %mod10
  store i64 %25, ptr %b, align 8
  br label %for.update
}
