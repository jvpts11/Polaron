; ModuleID = 'C:\Users\jvpts\Documents\GitHub\LDP3\build2\tests\trans_app\src/main.pol'
source_filename = "C:\\Users\\jvpts\\Documents\\GitHub\\LDP3\\build2\\tests\\trans_app\\src/main.pol"
...
argv.end:                                         ; preds = %argv.body, %entry
  ...
  %15 = tail call i32 @XCalc.combine(i32 6)
  %16 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str, i32 %15)
  ret i32 0
}

declare i32 @XCalc.combine(i32) local_unnamed_addr
