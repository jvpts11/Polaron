; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/java_enum_ordinal_cast.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/java_enum_ordinal_cast.pol"
...
@.str = private unnamed_addr constant [11 x i8] c"e=%d m=%d\0A\00", align 1
...
enumc.done:                                       ; preds = %enumc.init, %argv.end
  ...
  store ptr %Planet1, ptr %m, align 8
  %enum.cur2 = load ptr, ptr @Planet.EARTH.__inst, align 8
...
enumc.init3:                                      ; preds = %enumc.done
  ...
  call void @Planet.Planet(ptr %Planet5, i32 10)
  store ptr %Planet5, ptr @Planet.EARTH.__inst, align 8
  br label %enumc.done4

enumc.done4:                                      ; preds = %enumc.init3, %enumc.done
  %Planet6 = load ptr, ptr @Planet.EARTH.__inst, align 8
  %enum.ord.cur = load ptr, ptr @Planet.EARTH.__inst, align 8
  %18 = icmp eq ptr %Planet6, %enum.ord.cur
  %enum.ord = select i1 %18, i32 0, i32 -1
  %enum.ord.cur7 = load ptr, ptr @Planet.MARS.__inst, align 8
  %19 = icmp eq ptr %Planet6, %enum.ord.cur7
  %enum.ord8 = select i1 %19, i32 1, i32 %enum.ord
  store i32 %enum.ord8, ptr %e, align 4
  %m9 = load ptr, ptr %m, align 8
  %enum.ord.cur10 = load ptr, ptr @Planet.EARTH.__inst, align 8
  %20 = icmp eq ptr %m9, %enum.ord.cur10
  %enum.ord11 = select i1 %20, i32 0, i32 -1
  %enum.ord.cur12 = load ptr, ptr @Planet.MARS.__inst, align 8
  %21 = icmp eq ptr %m9, %enum.ord.cur12
  %enum.ord13 = select i1 %21, i32 1, i32 %enum.ord11
  store i32 %enum.ord13, ptr %i, align 4
  %e14 = load i32, ptr %e, align 4
  %i15 = load i32, ptr %i, align 4
  %22 = call i32 (ptr, ...) @printf(ptr @.str, i32 %e14, i32 %i15)
  ret i32 0
}
