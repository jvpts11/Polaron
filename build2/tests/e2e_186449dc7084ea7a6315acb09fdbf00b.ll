; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/bank.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/bank.pol"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

%String = type { i64, ptr, i64 }
%class.Account = type { ptr, i32 }
%class.Savings = type { ptr, i32, i32 }
...
@.contract = private unnamed_addr constant [191 x i8] c"contract violated: requires\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/bank.pol:10:70  in Account.Account\0A   |  public constructor Account(int initial) requires initial >= 0 {\0A\00", align 1
@.cl = private unnamed_addr constant [5 x i8] c"left\00", align 1
@.cr = private unnamed_addr constant [6 x i8] c"right\00", align 1
@.contract.1 = private unnamed_addr constant [196 x i8] c"contract violated: requires\0A  --> C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/bank.pol:13:76  in Account.deposit\0A   |  public method deposit(int amount) returns void requires amount > 0 {\0A\00", align 1
...
contract.cont:                                    ; preds = %entry
  ...
  %initial3 = load i32, ptr %initial, align 4
  store i32 %initial3, ptr %balance, align 4, !tbaa !4
  ret void
}
...
contract.cont:                                    ; preds = %entry
  %balance = getelementptr inbounds %class.Account, ptr %0, i32 0, i32 1
  %balance3 = getelementptr inbounds %class.Account, ptr %0, i32 0, i32 1
  %balance4 = load i32, ptr %balance3, align 4, !tbaa !4
  %amount5 = load i32, ptr %amount, align 4
  %4 = add i32 %balance4, %amount5
  store i32 %4, ptr %balance, align 4, !tbaa !4
  ret void
}

define internal void @Account.addInterest(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  ret void
}
...
define internal void @Savings.Savings(ptr %0, i32 %1, i32 %2) {
entry:
  ...
  %initial1 = load i32, ptr %initial, align 4
  call void @Account.Account(ptr %0, i32 %initial1)
  %vtbl.addr = getelementptr inbounds %class.Savings, ptr %0, i32 0, i32 0
  store ptr @Savings.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %rate2 = getelementptr inbounds %class.Savings, ptr %0, i32 0, i32 2
  %rate3 = load i32, ptr %rate, align 4
  store i32 %rate3, ptr %rate2, align 4, !tbaa !4
  ret void
}

define internal void @Savings.addInterest(ptr nonnull align 8 dereferenceable(16) %0) personality ptr @__CxxFrameHandler3 {
entry:
  %exc.thrown = alloca ptr, align 8
  %balance = getelementptr inbounds %class.Savings, ptr %0, i32 0, i32 1
  %balance1 = getelementptr inbounds %class.Savings, ptr %0, i32 0, i32 1
  %balance2 = load i32, ptr %balance1, align 4, !tbaa !4
  %balance3 = getelementptr inbounds %class.Savings, ptr %0, i32 0, i32 1
  %balance4 = load i32, ptr %balance3, align 4, !tbaa !4
  %rate = getelementptr inbounds %class.Savings, ptr %0, i32 0, i32 2
  %rate5 = load i32, ptr %rate, align 4, !tbaa !4
  %1 = mul i32 %balance4, %rate5
...
div.ok:                                           ; preds = %entry
  %5 = sdiv i32 %1, 100
  %6 = add i32 %balance2, %5
  store i32 %6, ptr %balance, align 4, !tbaa !4
  ret void
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %Savings.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Savings, ptr null, i64 1) to i64))
  call void @Savings.Savings(ptr %Savings.obj, i32 1000, i32 10)
  store ptr %Savings.obj, ptr %acc, align 8
  %acc1 = load ptr, ptr %acc, align 8
  %vtbl.addr = getelementptr inbounds %class.Account, ptr %acc1, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %slot = getelementptr [351 x ptr], ptr %vtbl, i64 0, i64 0
  %fn = load ptr, ptr %slot, align 8
  %dv.is = icmp eq ptr %fn, @Account.deposit
  br i1 %dv.is, label %dv.hit, label %dv.miss

dv.join:                                          ; preds = %dv.miss, %dv.hit
  %acc2 = load ptr, ptr %acc, align 8
  %vtbl.addr3 = getelementptr inbounds %class.Account, ptr %acc2, i32 0, i32 0
  %vtbl4 = load ptr, ptr %vtbl.addr3, align 8, !tbaa !0
  %slot5 = getelementptr [351 x ptr], ptr %vtbl4, i64 0, i64 1
  %fn6 = load ptr, ptr %slot5, align 8
  %dv.is10 = icmp eq ptr %fn6, @Account.addInterest
  br i1 %dv.is10, label %dv.hit8, label %dv.miss9

dv.hit:                                           ; preds = %argv.end
  call void @Account.deposit(ptr %acc1, i32 500)
  br label %dv.join

dv.miss:                                          ; preds = %argv.end
  call void %fn(ptr %acc1, i32 500)
  br label %dv.join

dv.join7:                                         ; preds = %dv.miss12, %dv.hit11, %dv.hit8
  %acc14 = load ptr, ptr %acc, align 8
  %vtbl.addr15 = getelementptr inbounds %class.Account, ptr %acc14, i32 0, i32 0
  %vtbl16 = load ptr, ptr %vtbl.addr15, align 8, !tbaa !0
  %slot17 = getelementptr [351 x ptr], ptr %vtbl16, i64 0, i64 2
  %fn18 = load ptr, ptr %slot17, align 8
  %dv.is22 = icmp eq ptr %fn18, @Account.getBalance
  br i1 %dv.is22, label %dv.hit20, label %dv.miss21

dv.hit8:                                          ; preds = %dv.join
  call void @Account.addInterest(ptr %acc2)
  br label %dv.join7

dv.miss9:                                         ; preds = %dv.join
  %dv.is13 = icmp eq ptr %fn6, @Savings.addInterest
  br i1 %dv.is13, label %dv.hit11, label %dv.miss12

dv.hit11:                                         ; preds = %dv.miss9
  call void @Savings.addInterest(ptr %acc2)
  br label %dv.join7

dv.miss12:                                        ; preds = %dv.miss9
  call void %fn6(ptr %acc2)
  br label %dv.join7

dv.join19:                                        ; preds = %dv.miss21, %dv.hit20
  %dv.r = phi i32 [ %18, %dv.hit20 ], [ %19, %dv.miss21 ]
  %16 = call i32 (ptr, ...) @printf(ptr @.str, i32 %dv.r)
  %acc23 = load ptr, ptr %acc, align 8
  call void @__polaron_check_live(ptr %acc23)
  %vtbl.addr24 = getelementptr inbounds %class.Account, ptr %acc23, i32 0, i32 0
  %vtbl25 = load ptr, ptr %vtbl.addr24, align 8, !tbaa !0
  %dtor.slot = getelementptr [352 x ptr], ptr %vtbl25, i64 0, i64 351
  %dtor.fn = load ptr, ptr %dtor.slot, align 8
  %17 = icmp ne ptr %dtor.fn, null
  br i1 %17, label %dtor.call, label %dtor.free

dv.hit20:                                         ; preds = %dv.join7
  %18 = call i32 @Account.getBalance(ptr %acc14)
  br label %dv.join19

dv.miss21:                                        ; preds = %dv.join7
  %19 = call i32 %fn18(ptr %acc14)
  br label %dv.join19

dtor.call:                                        ; preds = %dv.join19
  call void %dtor.fn(ptr %acc23)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %dv.join19
  call void @__polaron_free(ptr %acc23)
  ret i32 0
}
