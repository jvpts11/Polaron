; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/null_literal.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/null_literal.pol"
...
@.str = private unnamed_addr constant [9 x i8] c"null=%d \00", align 1
@.str.1 = private unnamed_addr constant [8 x i8] c"set=%d\0A\00", align 1
...
if.end:                                           ; preds = %if.then, %argv.end
  ...
  store ptr %Node.obj, ptr %p, align 8
  %p2 = load ptr, ptr %p, align 8
  %19 = icmp ne ptr %p2, null
  %20 = zext i1 %19 to i32
  br i1 %19, label %if.then3, label %if.end4

if.then3:                                         ; preds = %if.end
  %21 = call i32 (ptr, ...) @printf(ptr @.str.1, i32 1)
  br label %if.end4
