; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/partial_class.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/partial_class.pol"
...
@.strdata = private constant [7 x i8] c"barks=\00"
...
entry:
  ...
  %barks = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 1
  store i32 0, ptr %barks, align 4, !tbaa !4
  ret void
}
...
entry:
  %barks = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 1
  %barks1 = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 1
  %barks2 = load i32, ptr %barks1, align 4, !tbaa !4
  %1 = add i32 %barks2, 1
  store i32 %1, ptr %barks, align 4, !tbaa !4
  ret void
}

define internal i32 @Dog.count(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %barks = getelementptr inbounds %class.Dog, ptr %0, i32 0, i32 1
  %barks1 = load i32, ptr %barks, align 4, !tbaa !4
  ret i32 %barks1
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Dog.bark(ptr %d1)
  %d2 = load ptr, ptr %d, align 8
  call void @Dog.bark(ptr %d2)
  %d3 = load ptr, ptr %d, align 8
  call void @Dog.bark(ptr %d3)
  %d4 = load ptr, ptr %d, align 8
  %16 = call i32 @Dog.count(ptr %d4)
  %itoa.buf = call ptr @__polaron_malloc(i64 24)
  %17 = sext i32 %16 to i64
  %18 = call i64 @__polaron_itoa(i64 %17, ptr %itoa.buf)
  %newstr5 = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%String, ptr null, i64 1) to i64))
  %19 = getelementptr inbounds %String, ptr %newstr5, i32 0, i32 0
  store i64 %18, ptr %19, align 8
  %20 = getelementptr inbounds %String, ptr %newstr5, i32 0, i32 1
  store ptr %itoa.buf, ptr %20, align 8
  %21 = getelementptr inbounds %String, ptr %newstr5, i32 0, i32 2
  store i64 0, ptr %21, align 8
  %len = load i64, ptr @.strobj, align 8
  %str.len = getelementptr inbounds %String, ptr %newstr5, i32 0, i32 0
  %len6 = load i64, ptr %str.len, align 8
  %22 = add i64 %len, %len6
  %23 = add i64 %22, 1
  %cat.buf = call ptr @__polaron_malloc(i64 %23)
  ...
  %str.data = getelementptr inbounds %String, ptr %newstr5, i32 0, i32 1
  %data7 = load ptr, ptr %str.data, align 8
  %25 = getelementptr i8, ptr %cat.buf, i64 %len
  %26 = call ptr @memcpy(ptr %25, ptr %data7, i64 %len6)
  ...
  %28 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 0
  store i64 %22, ptr %28, align 8
  %29 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 1
  store ptr %cat.buf, ptr %29, align 8
  %30 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 2
  store i64 0, ptr %30, align 8
  %str.data9 = getelementptr inbounds %String, ptr %newstr8, i32 0, i32 1
  %data10 = load ptr, ptr %str.data9, align 8
  %31 = call i32 (ptr, ...) @printf(ptr @.str, ptr %data10)
  call void @__polaron_str_free(ptr %newstr5)
  call void @__polaron_str_free(ptr %newstr8)
  %d11 = load ptr, ptr %d, align 8
  call void @__polaron_check_live(ptr %d11)
  %vtbl.addr = getelementptr inbounds %class.Dog, ptr %d11, i32 0, i32 0
...
dtor.call:                                        ; preds = %argv.end
  call void %dtor.fn(ptr %d11)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %argv.end
  call void @__polaron_free(ptr %d11)
  ret i32 0
}
