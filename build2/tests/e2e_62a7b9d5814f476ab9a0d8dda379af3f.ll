...
@.str = private unnamed_addr constant [15 x i8] c"app=%d lib=%d\0A\00", align 1

define internal void @app__Box.app__Box(ptr %0) {
entry:
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.app__Box, ptr %0, i32 0, i32 0
  store ptr @app__Box.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  ret void
}

define internal i32 @app__Box.value(ptr nonnull align 8 dereferenceable(8) %0) {
entry:
  ret i32 1
}
...
argv.end:                                         ; preds = %argv.cond
  ...
  %app__Box.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.app__Box, ptr null, i64 1) to i64))
  call void @app__Box.app__Box(ptr %app__Box.obj)
  store ptr %app__Box.obj, ptr %b, align 8
  %Helper.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.Helper, ptr null, i64 1) to i64))
  call void @Helper.Helper(ptr %Helper.obj)
  store ptr %Helper.obj, ptr %h, align 8
  %b1 = load ptr, ptr %b, align 8
  %16 = call i32 @app__Box.value(ptr %b1)
  %h2 = load ptr, ptr %h, align 8
  %17 = call i32 @Helper.libValue(ptr %h2)
  %18 = call i32 (ptr, ...) @printf(ptr @.str, i32 %16, i32 %17)
  %b3 = load ptr, ptr %b, align 8
  call void @__polaron_check_live(ptr %b3)
  %vtbl.addr = getelementptr inbounds %class.app__Box, ptr %b3, i32 0, i32 0
...
dtor.call:                                        ; preds = %argv.end
  call void %dtor.fn(ptr %b3)
  br label %dtor.free

dtor.free:                                        ; preds = %dtor.call, %argv.end
  call void @__polaron_free(ptr %b3)
  %h4 = load ptr, ptr %h, align 8
  call void @__polaron_check_live(ptr %h4)
  %vtbl.addr5 = getelementptr inbounds %class.Helper, ptr %h4, i32 0, i32 0
  %vtbl6 = load ptr, ptr %vtbl.addr5, align 8, !tbaa !0
  %dtor.slot7 = getelementptr [350 x ptr], ptr %vtbl6, i64 0, i64 349
  %dtor.fn8 = load ptr, ptr %dtor.slot7, align 8
  %20 = icmp ne ptr %dtor.fn8, null
  br i1 %20, label %dtor.call9, label %dtor.free10

dtor.call9:                                       ; preds = %dtor.free
  call void %dtor.fn8(ptr %h4)
  br label %dtor.free10

dtor.free10:                                      ; preds = %dtor.call9, %dtor.free
  call void @__polaron_free(ptr %h4)
  ret i32 0
}

define internal void @lib__Box.lib__Box(ptr %0) {
entry:
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.lib__Box, ptr %0, i32 0, i32 0
  store ptr @lib__Box.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  ret void
}

define internal i32 @lib__Box.value(ptr nonnull align 8 dereferenceable(8) %0) {
entry:
  ret i32 2
}

define internal void @Helper.Helper(ptr %0) {
entry:
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.Helper, ptr %0, i32 0, i32 0
  store ptr @Helper.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  ret void
}

define internal i32 @Helper.libValue(ptr nonnull align 8 dereferenceable(8) %0) {
entry:
  %v = alloca i32, align 4
  %b = alloca ptr, align 8
  %lib__Box.obj = call ptr @__polaron_malloc(i64 ptrtoint (ptr getelementptr (%class.lib__Box, ptr null, i64 1) to i64))
  call void @lib__Box.lib__Box(ptr %lib__Box.obj)
  store ptr %lib__Box.obj, ptr %b, align 8
  %b1 = load ptr, ptr %b, align 8
  %1 = call i32 @lib__Box.value(ptr %b1)
  store i32 %1, ptr %v, align 4
  %b2 = load ptr, ptr %b, align 8
  call void @__polaron_check_live(ptr %b2)
  %vtbl.addr = getelementptr inbounds %class.lib__Box, ptr %b2, i32 0, i32 0
  %vtbl = load ptr, ptr %vtbl.addr, align 8, !tbaa !0
  %dtor.slot = getelementptr [350 x ptr], ptr %vtbl, i64 0, i64 349
  %dtor.fn = load ptr, ptr %dtor.slot, align 8
