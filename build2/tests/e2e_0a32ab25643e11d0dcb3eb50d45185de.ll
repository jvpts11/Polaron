...
define internal void @Holder.Holder(ptr %0) {
entry:
  call void @Object.Object(ptr %0)
  %vtbl.addr = getelementptr inbounds %class.Holder, ptr %0, i32 0, i32 0
  store ptr @Holder.vtable, ptr %vtbl.addr, align 8, !tbaa !0
  %n = getelementptr inbounds %class.Holder, ptr %0, i32 0, i32 1
  store i32 4, ptr %n, align 4, !tbaa !4
  ret void
}

define internal ptr @Holder.table(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  ret ptr %0
}

define internal i32 @Holder.twice(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %n = getelementptr inbounds %class.Holder, ptr %0, i32 0, i32 1
  %n1 = load i32, ptr %n, align 4, !tbaa !4
  %n2 = getelementptr inbounds %class.Holder, ptr %0, i32 0, i32 1
  %n3 = load i32, ptr %n2, align 4, !tbaa !4
  %1 = add i32 %n1, %n3
  ret i32 %1
}

define internal i32 @Holder.fieldOffCall(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %1 = call ptr @Holder.table(ptr %0)
  %n = getelementptr inbounds %class.Holder, ptr %1, i32 0, i32 1
  %n1 = load i32, ptr %n, align 4, !tbaa !4
  ret i32 %n1
}

define internal i32 @Holder.methodOffCall(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %1 = call ptr @Holder.table(ptr %0)
  %2 = call i32 @Holder.twice(ptr %1)
  ret i32 %2
}

define internal i32 @Holder.viaLocal(ptr nonnull align 8 dereferenceable(16) %0) {
entry:
  %t = alloca ptr, align 8
  %1 = call ptr @Holder.table(ptr %0)
  store ptr %1, ptr %t, align 8
  %t1 = load ptr, ptr %t, align 8
  %n = getelementptr inbounds %class.Holder, ptr %t1, i32 0, i32 1
...
entry:
  ...
  %Holder.obj = alloca %class.Holder, align 8
...
argv.end:                                         ; preds = %argv.cond
  ...
  call void @Holder.Holder(ptr %Holder.obj)
  store ptr %Holder.obj, ptr %h, align 8
  %h1 = load ptr, ptr %h, align 8
  %16 = call i32 @Holder.fieldOffCall(ptr %h1)
  %h2 = load ptr, ptr %h, align 8
  %17 = call i32 @Holder.methodOffCall(ptr %h2)
  %h3 = load ptr, ptr %h, align 8
  %18 = call i32 @Holder.viaLocal(ptr %h3)
