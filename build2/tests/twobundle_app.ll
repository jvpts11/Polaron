; ModuleID = 'C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/twobundle_app.pol'
source_filename = "C:/Users/jvpts/Documents/GitHub/LDP3/tests/samples/twobundle_app.pol"
...
argv.end:                                         ; preds = %argv.cond
  ...
  %Square.new = call ptr @Square.__new()
  store ptr %Square.new, ptr %s, align 8
  %Dog.new = call ptr @Dog.__new()
  store ptr %Dog.new, ptr %d, align 8
  %s1 = load ptr, ptr %s, align 8
  %vtbl.addr = getelementptr inbounds %class.Square, ptr %s1, i32 0, i32 0
  ...
  %vtbl.addr3 = getelementptr inbounds %class.Dog, ptr %d2, i32 0, i32 0
  %vtbl4 = load ptr, ptr %vtbl.addr3, align 8, !tbaa !0
  %slot5 = getelementptr [350 x ptr], ptr %vtbl4, i64 0, i64 349
  %fn6 = load ptr, ptr %slot5, align 8
  %17 = call i32 %fn6(ptr %d2)
  %18 = call i32 (ptr, ...) @printf(ptr @.str, i32 %16, i32 %17)
  ret i32 0
}

declare ptr @Square.__new()

declare ptr @Dog.__new()
