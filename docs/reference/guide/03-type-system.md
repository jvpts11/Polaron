...
## 3.2 Literals and literal suffixes
...
§3.12). The compiler will not quietly widen a `short` to an `int` for you, nor
...
## 3.6 `var`: type inference for locals
