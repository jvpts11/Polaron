...
function(git_repo dir)
    ...
    execute_process(COMMAND git -c user.name=ci -c user.email=ci@ldp3 add -A WORKING_DIRECTORY "${dir}")
    execute_process(COMMAND git -c user.name=ci -c user.email=ci@ldp3 commit -q -m init WORKING_DIRECTORY "${dir}" RESULT_VARIABLE rc)
    if(NOT rc EQUAL 0)
...
file(WRITE "${yrepo}/ldp3.toml"
"[ldp3_project]\n[program]\nname = \"ylib\"\nlanguage_version = \"1.0\"\nentry = \"src/lib.ldp3\"\n")
file(WRITE "${yrepo}/src/lib.ldp3"
...
if(NOT EXISTS "${app}/packages/xlib/xlib.ldb")
    message(FATAL_ERROR "xlib was not installed")
endif()
if(NOT EXISTS "${app}/packages/ylib/ylib.ldb")
