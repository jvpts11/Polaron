define internal void @Snap.Snap(ptr nonnull align 8 dereferenceable(24) %_, ptr nonnull align 8 %_, i32 %_) #0 {
entry:
 ...
 call void @Object.Object(ptr %_)
 %_ = load ptr, ptr %this, align 8
 %_ = getelementptr i8, ptr %_, i64 0
 store ptr @Snap.vtable, ptr %_, align 8
 %_ = load ptr, ptr %this, align 8
 %text = getelementptr inbounds %class.Snap, ptr %_, i32 0, i32 1
 store ptr null, ptr %text, align 8, !tbaa !0
 %_ = load ptr, ptr %t, align 8
 %_ = load ptr, ptr %this, align 8
 %text1 = getelementptr inbounds %class.Snap, ptr %_, i32 0, i32 1
 ...
 %_ = load ptr, ptr %this, align 8
 %row = getelementptr inbounds %class.Snap, ptr %_, i32 0, i32 2
