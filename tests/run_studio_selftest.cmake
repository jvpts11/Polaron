# polaron-studio shell smoke test, invoked via `cmake -P`.
#
...
if(NOT rc EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest exited ${rc}")
endif()
foreach(needle "polaron studio" "Projects" "MANAGE" "SYSTEM" "navigate" "ALL PROJECTS" "tic_tac_toe")
...
if(NOT drc EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest-detail exited ${drc}")
endif()
foreach(needle "ACTIONS" "CONSOLE" "polaron test" "PASS" "tests: 7 passed" "run action")
...
if(NOT erc EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest-env exited ${erc}")
endif()
...
if(NOT mrc EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest-new exited ${mrc}")
endif()
foreach(needle "New Polaron project" "NAME" "pool_balls_3d" "ENVIRONMENT" "gamedev" "create")
...
if(NOT src EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest-scan exited ${src}")
endif()
...
if(NOT nerc EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest-newenv exited ${nerc}")
endif()
...
if(NOT lrc EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest-lib exited ${lrc}")
endif()
...
if(NOT trc EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest-tool exited ${trc}")
endif()
foreach(needle "TOOLCHAIN" "COMPILER" "polc" "clang" "x86_64-windows")
...
if(NOT prc EQUAL 0)
    message(FATAL_ERROR "polaron-studio --selftest-plug exited ${prc}")
endif()
foreach(needle "Plug a library" "SOURCE" "polaron/json" "plug")
    if(NOT plug MATCHES "${needle}")
        message(FATAL_ERROR "plug modal is missing '${needle}'")
    endif()
endforeach()

message(STATUS "OK: polaron-studio all screens")
