...
#
# Builds a local git repo holding a minimal LDP3 library (Calc.square), plugs it into a consumer whose code
# imports and calls it, then `ldp3 run` builds (compiling with --use, linking the extracted bitcode) and
...
if(NOT rc EQUAL 0)
    message(FATAL_ERROR "ldp3 run failed (exit ${rc}): ${err}")
endif()
