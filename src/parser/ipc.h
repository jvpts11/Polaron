...
// Cross-program IPC (spec 2.8). Turns the two halves of an IPC program into ordinary Polaron, before
...
//    .polh, but its code lives in another process) becomes a PROXY -- a { connection, remote id } pair
...
//
// The pass generates Polaron source and parses it, rather than hand-building AST nodes: the generated
